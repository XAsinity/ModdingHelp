...
public abstract class X448Field {
    ...
    public static void decode(byte[] byArray, int n, int[] nArray, int n2) {
        X448Field.decode56(byArray, n, nArray, n2);
        X448Field.decode56(byArray, n + 7, nArray, n2 + 2);
        X448Field.decode56(byArray, n + 14, nArray, n2 + 4);
        X448Field.decode56(byArray, n + 21, nArray, n2 + 6);
        X448Field.decode56(byArray, n + 28, nArray, n2 + 8);
        X448Field.decode56(byArray, n + 35, nArray, n2 + 10);
        X448Field.decode56(byArray, n + 42, nArray, n2 + 12);
        X448Field.decode56(byArray, n + 49, nArray, n2 + 14);
    }
    ...
    public static void encode(int[] nArray, int n, byte[] byArray, int n2) {
        X448Field.encode56(nArray, n, byArray, n2);
        X448Field.encode56(nArray, n + 2, byArray, n2 + 7);
        X448Field.encode56(nArray, n + 4, byArray, n2 + 14);
        X448Field.encode56(nArray, n + 6, byArray, n2 + 21);
        X448Field.encode56(nArray, n + 8, byArray, n2 + 28);
        X448Field.encode56(nArray, n + 10, byArray, n2 + 35);
        X448Field.encode56(nArray, n + 12, byArray, n2 + 42);
        X448Field.encode56(nArray, n + 14, byArray, n2 + 49);
    }
