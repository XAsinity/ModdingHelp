...
public abstract class X25519Field {
    ...
    public static void decode(byte[] byArray, int n, int[] nArray, int n2) {
        X25519Field.decode128(byArray, n, nArray, n2);
        X25519Field.decode128(byArray, n + 16, nArray, n2 + 5);
        int n3 = n2 + 9;
    ...
    public static void encode(int[] nArray, int n, byte[] byArray, int n2) {
        X25519Field.encode128(nArray, n, byArray, n2);
        X25519Field.encode128(nArray, n + 5, byArray, n2 + 16);
    }
