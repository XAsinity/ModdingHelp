...
extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArray, int n, int n2) {
        ...
        return new AbstractECLookupTable(this){
            final /* synthetic */ SecT571R1Curve this$0;
            {
            ...
            private ECPoint createPoint(long[] lArray3, long[] lArray2) {
                return this.this$0.createRawPoint(new SecT571FieldElement(lArray3), new SecT571FieldElement(lArray2), SECT571R1_AFFINE_ZS);
            }
        };
    }
}
