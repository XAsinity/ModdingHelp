...
class Tnaf {
    ...
    public static ZTauElement partModReduction(ECCurve.AbstractF2m abstractF2m, BigInteger bigInteger, byte by, byte by2, byte by3) {
        ...
        if (abstractF2m.isKoblitz()) {
            bigInteger2 = ECConstants.ONE.shiftLeft(n).add(ECConstants.ONE).subtract(abstractF2m.getOrder().multiply(abstractF2m.getCofactor()));
        } else {
            object = Tnaf.getLucas(by2, n, true);
            bigInteger2 = object[1];
        }
        object = Tnaf.approximateDivisionByN(bigInteger, bigIntegerArray[0], bigInteger2, by, n, by3);
        SimpleBigDecimal simpleBigDecimal = Tnaf.approximateDivisionByN(bigInteger, bigIntegerArray[1], bigInteger2, by, n, by3);
    ...
    public static ECPoint.AbstractF2m multiplyRTnaf(ECPoint.AbstractF2m abstractF2m, BigInteger bigInteger) {
        ...
        int n = abstractF2m2.getA().toBigInteger().intValue();
        byte by = Tnaf.getMu(n);
        ZTauElement zTauElement = Tnaf.partModReduction(abstractF2m2, bigInteger, (byte)n, by, (byte)10);
    ...
    public static byte[] tauAdicWNaf(byte by, ZTauElement zTauElement, int n, int n2, ZTauElement[] zTauElementArray) {
        if (by != 1 && by != -1) {
            throw new IllegalArgumentException("mu must be 1 or -1");
        }
        BigInteger bigInteger = Tnaf.norm(by, zTauElement);
        int n3 = bigInteger.bitLength();
        int n4 = n3 > 30 ? n3 + 4 + n : 34 + n;
        ...
        while (bigInteger2.bitLength() > 62 || bigInteger3.bitLength() > 62) {
            if (bigInteger2.testBit(0)) {
                int n9 = bigInteger2.intValue() + bigInteger3.intValue() * n2;
                int n10 = n9 & n6;
                byArray[n8] = (byte)(n9 << n7 >> n7);
                bigInteger2 = bigInteger2.subtract(zTauElementArray[n10].u);
                bigInteger3 = bigInteger3.subtract(zTauElementArray[n10].v);
            }
            ++n8;
            BigInteger bigInteger4 = bigInteger2.shiftRight(1);
            bigInteger2 = by == 1 ? bigInteger3.add(bigInteger4) : bigInteger3.subtract(bigInteger4);
        ...
        long l = BigIntegers.longValueExact(bigInteger2);
        long l2 = BigIntegers.longValueExact(bigInteger3);
        while ((l | l2) != 0L) {
            if ((l & 1L) != 0L) {
                int n11 = (int)l + (int)l2 * n2;
                int n12 = n11 & n6;
                byArray[n8] = (byte)(n11 << n7 >> n7);
                l -= (long)zTauElementArray[n12].u.intValue();
                l2 -= (long)zTauElementArray[n12].v.intValue();
            }
            ++n8;
            long l3 = l >> 1;
            l = by == 1 ? l2 + l3 : l2 - l3;
    ...
    public static ECPoint.AbstractF2m[] getPreComp(ECPoint.AbstractF2m abstractF2m, byte by) {
        ...
        for (int i = 3; i < n; i += 2) {
            eCPointArray[i >>> 1] = Tnaf.multiplyFromTnaf(abstractF2m, abstractF2m2, byArray[i]);
        }
