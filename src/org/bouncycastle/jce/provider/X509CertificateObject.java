...
implements PKCS12BagAttributeCarrier {
    ...
    public X509CertificateObject(Certificate certificate) throws CertificateParsingException {
        ...
        this.c = certificate;
        try {
            byArray = X509CertificateObject.getExtensionOctets(certificate, Extension.basicConstraints);
            if (byArray != null) {
        ...
        try {
            byArray = X509CertificateObject.getExtensionOctets(certificate, Extension.keyUsage);
            if (byArray != null) {
                ASN1BitString aSN1BitString = ASN1BitString.getInstance(ASN1Primitive.fromByteArray(byArray));
                int n = (byArray = aSN1BitString.getBytes()).length * 8 - aSN1BitString.getPadBits();
    ...
    public List getExtendedKeyUsage() throws CertificateParsingException {
        byte[] byArray = X509CertificateObject.getExtensionOctets(this.c, Extension.extendedKeyUsage);
        if (null == byArray) {
            return null;
        }
        try {
    ...
    public Collection getSubjectAlternativeNames() throws CertificateParsingException {
        return X509CertificateObject.getAlternativeNames(this.c, Extension.subjectAlternativeName);
    }

    public Collection getIssuerAlternativeNames() throws CertificateParsingException {
        return X509CertificateObject.getAlternativeNames(this.c, Extension.issuerAlternativeName);
    }
                ...
                if (extension.getExtnValue() != null) {
                    ...
                    try {
                        ...
                        if (aSN1ObjectIdentifier.equals(MiscObjectIdentifiers.netscapeCertType)) {
                            stringBuilder.append(new NetscapeCertType((ASN1BitString)aSN1InputStream.readObject())).append(string);
                            continue;
                        }
                        if (aSN1ObjectIdentifier.equals(MiscObjectIdentifiers.netscapeRevocationURL)) {
                            stringBuilder.append(new NetscapeRevocationURL((ASN1IA5String)aSN1InputStream.readObject())).append(string);
                            continue;
                        }
                        if (aSN1ObjectIdentifier.equals(MiscObjectIdentifiers.verisignCzagExtension)) {
                            stringBuilder.append(new VerisignCzagExtension((ASN1IA5String)aSN1InputStream.readObject())).append(string);
                            continue;
                        }
    ...
    private static Collection getAlternativeNames(Certificate certificate, ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CertificateParsingException {
        byte[] byArray = X509CertificateObject.getExtensionOctets(certificate, aSN1ObjectIdentifier);
        if (byArray == null) {
            return null;
        }
        try {
