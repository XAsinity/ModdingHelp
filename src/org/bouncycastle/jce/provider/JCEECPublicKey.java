...
ECPointEncoder {
    ...
    public String toString() {
        ...
        stringBuilder.append("EC Public Key").append(string);
        stringBuilder.append("            X: ").append(this.q.getAffineXCoord().toBigInteger().toString(16)).append(string);
        stringBuilder.append("            Y: ").append(this.q.getAffineYCoord().toBigInteger().toString(16)).append(string);
