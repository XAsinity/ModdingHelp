...
public abstract class BcContentVerifierProviderBuilder {
    ...
    public ContentVerifierProvider build(final X509CertificateHolder x509CertificateHolder) throws OperatorCreationException {
        return new ContentVerifierProvider(){
            final /* synthetic */ BcContentVerifierProviderBuilder this$0;
            {
            ...
            public ContentVerifier get(AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
                try {
                    AsymmetricKeyParameter asymmetricKeyParameter = this.this$0.extractKeyParameters(x509CertificateHolder.getSubjectPublicKeyInfo());
                    BcSignerOutputStream bcSignerOutputStream = this.this$0.createSignatureStream(algorithmIdentifier, asymmetricKeyParameter);
