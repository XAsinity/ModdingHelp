...
extends CertPathValidatorUtilities {
            ...
            for (int i = this.certs.size() - 1; i > 0; --i) {
                ...
                if (!PKIXCertPathReviewer.isSelfIssued(x509Certificate)) {
                    ...
                    try {
                        ...
                        ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.ncSubjectNameError", new Object[]{new UntrustedInput(object3)});
                    ...
                    try {
                        ...
                        ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.notPermittedDN", new Object[]{new UntrustedInput(((X500Principal)object3).getName())});
                    ...
                    try {
                        ...
                        ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.excludedDN", new Object[]{new UntrustedInput(((X500Principal)object3).getName())});
                        throw new CertPathReviewerException(errorBundle, (Throwable)pKIXNameConstraintValidatorException, this.certPath, i);
                    }
                    try {
                        ...
                        object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.subjAltNameExtError");
                    ...
                    if (object != null) {
                        if (((ASN1Sequence)object).size() > 1024) {
                            ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.subjAltNameExtError");
                        ...
                        for (n = 0; n < ((ASN1Sequence)object).size(); ++n) {
                            ...
                            try {
                                ...
                                ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.notPermittedEmail", new Object[]{new UntrustedInput(object4)});
                                throw new CertPathReviewerException(errorBundle, (Throwable)pKIXNameConstraintValidatorException, this.certPath, i);
                            }
                        }
                    }
                ...
                try {
                    ...
                    generalSubtreeArray = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.ncExtError");
    ...
    private void checkPathLength() {
        ...
        for (int i = this.certs.size() - 1; i > 0; --i) {
            ...
            if (!PKIXCertPathReviewer.isSelfIssued(x509Certificate)) {
                if (n <= 0) {
                    object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.pathLengthExtended");
            ...
            try {
                ...
                ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.processLengthConstError");
        ...
        ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.totalPathLength", new Object[]{Integers.valueOf(n2)});
    ...
    private void checkSignatures() {
        ...
        try {
            ...
            if (object3.size() > 1) {
                object2 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.conflictingTrustAnchors", new Object[]{Integers.valueOf(object3.size()), new UntrustedInput(((X509Certificate)object5).getIssuerX500Principal())});
                this.addError((ErrorBundle)object2);
            } else if (object3.isEmpty()) {
                object2 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noTrustAnchorFound", new Object[]{new UntrustedInput(((X509Certificate)object5).getIssuerX500Principal()), Integers.valueOf(this.pkixParams.getTrustAnchors().size())});
                this.addError((ErrorBundle)object2);
            } else {
        ...
        for (int i = this.certs.size() - 1; i >= 0; --i) {
            ...
            if (object5 != null) {
                ...
                try {
                    ...
                    object9 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.rootKeyIsValidButNotATrustAnchor");
                ...
                object9 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.NoIssuerPublicKey");
                object10 = x509Certificate.getExtensionValue(Extension.authorityKeyIdentifier.getId());
                if (object10 != null && (object8 = ((AuthorityKeyIdentifier)(object7 = AuthorityKeyIdentifier.getInstance(ASN1OctetString.getInstance(object10).getOctets()))).getAuthorityCertIssuer()) != null) {
            ...
            if (this.pkixParams.isRevocationEnabled()) {
                ...
                try {
                    ...
                    object7 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlDistPtExtError");
                ...
                try {
                    ...
                    object8 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlAuthInfoAccError");
                ...
                while (iterator.hasNext()) {
                    object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlDistPoint", new Object[]{new UntrustedUrlInput(iterator.next())});
                    this.addNotification((ErrorBundle)object6, i);
                }
                iterator = ((Vector)object8).iterator();
                while (iterator.hasNext()) {
                    object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.ocspLocation", new Object[]{new UntrustedUrlInput(iterator.next())});
                    this.addNotification((ErrorBundle)object6, i);
                }
                try {
            ...
            if (object3 != null && !x509Certificate.getIssuerX500Principal().equals(object3)) {
                object9 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.certWrongIssuer", new Object[]{((X500Principal)object3).getName(), x509Certificate.getIssuerX500Principal().getName()});
                this.addError((ErrorBundle)object9, i);
            }
            if (n != this.n) {
                if (x509Certificate != null && x509Certificate.getVersion() == 1) {
                    object9 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noCACert");
                    this.addError((ErrorBundle)object9, i);
                }
                try {
                    ...
                    object7 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.errorProcesingBC");
                    this.addError((ErrorBundle)object7, i);
                }
                object10 = x509Certificate.getKeyUsage();
                if (object10 != null && (((byte[])object10).length <= 5 || object10[5] == 0)) {
                    object7 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noCertSign");
                    this.addError((ErrorBundle)object7, i);
                }
            }
        ...
        try {
            ...
            for (n4 = this.certs.size() - 1; n4 >= 0; --n4) {
                ...
                try {
                    ...
                    object5 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.policyExtError");
                ...
                if (n <= 0 && object == null) {
                    object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noValidPolicyTree");
            ...
            try {
                ...
                object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.policyConstExtError");
                throw new CertPathReviewerException((ErrorBundle)object4, this.certPath, n4);
            }
            if (object == null) {
                if (this.pkixParams.isExplicitPolicyRequired()) {
                    object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.explicitPolicy");
                    throw new CertPathReviewerException((ErrorBundle)object4, this.certPath, n4);
                }
                object6 = null;
            ...
            if (n <= 0 && object6 == null) {
                object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.invalidPolicy");
                throw new CertPathReviewerException((ErrorBundle)object4);
            }
            object = object6;
        }
        ...
        try {
            ...
            for (int i = 0; i < aSN1Sequence.size(); ++i) {
                ...
                if (QCStatement.id_etsi_qcs_QcCompliance.equals(qCStatement.getStatementId())) {
                    object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.QcEuCompliance");
                ...
                if (QCStatement.id_etsi_qcs_QcSSCD.equals(qCStatement.getStatementId())) {
                    object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.QcSSCD");
                    this.addNotification((ErrorBundle)object, n);
                    continue;
                }
                if (QCStatement.id_etsi_qcs_LimiteValue.equals(qCStatement.getStatementId())) {
                    ...
                    ErrorBundle errorBundle = ((MonetaryValue)object).getCurrency().isAlphabetic() ? PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.QcLimitValueAlpha", new Object[]{((MonetaryValue)object).getCurrency().getAlphabetic(), new TrustedInput(new Double(d)), object}) : PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.QcLimitValueNum", new Object[]{Integers.valueOf(((MonetaryValue)object).getCurrency().getNumeric()), new TrustedInput(new Double(d)), object});
                    this.addNotification(errorBundle, n);
                    continue;
                }
                object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.QcUnknownStatement", new Object[]{qCStatement.getStatementId(), new UntrustedInput(qCStatement)});
                this.addNotification((ErrorBundle)object, n);
                bl = true;
            }
            return !bl;
    ...
    protected void checkCRLs(PKIXParameters pKIXParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, Vector vector, int n) throws CertPathReviewerException {
        ...
        try {
            ...
            ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlIssuerException");
        ...
        try {
            ...
            if (set.isEmpty()) {
                ...
                int n2 = object7.size();
                object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noCrlInCertstore", new Object[]{new UntrustedInput(x509CRLStoreSelector.getIssuerNames()), new UntrustedInput(object7), Integers.valueOf(n2)});
                this.addNotification((ErrorBundle)object6, n);
            }
        }
        catch (AnnotatedException annotatedException) {
            object8 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlExtractionError", new Object[]{annotatedException.getCause().getMessage(), annotatedException.getCause(), annotatedException.getCause().getClass().getName()});
        ...
        while (iterator2.hasNext()) {
            ...
            if (date2 == null || date.before(date2)) {
                bl = true;
                object5 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.localValidCRL", object6);
                this.addNotification((ErrorBundle)object5, n);
                break;
            }
            object5 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.localInvalidCRL", object6);
            this.addNotification((ErrorBundle)object5, n);
        }
        if (!bl) {
            ...
            while (object6.hasNext()) {
                try {
                    ...
                    if (!((X500Principal)object7).equals(object4)) {
                        object3 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.onlineCRLWrongCA", new Object[]{new UntrustedInput(((X500Principal)object4).getName()), new UntrustedInput(((X500Principal)object7).getName()), new UntrustedUrlInput(object5)});
                    ...
                    if (iterator == null || date.before((Date)((Object)iterator))) {
                        bl = true;
                        object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.onlineValidCRL", object2);
                        this.addNotification((ErrorBundle)object, n);
                        object8 = x509CRL;
                        break;
                    }
                    object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.onlineInvalidCRL", object2);
                    this.addNotification((ErrorBundle)object, n);
                }
                catch (CertPathReviewerException certPathReviewerException) {
        ...
        if (object8 != null) {
            ...
            if (!(x509Certificate2 == null || (blArray = x509Certificate2.getKeyUsage()) == null || blArray.length > 6 && blArray[6])) {
                object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noCrlSigningPermited");
            ...
            if (publicKey != null) {
                try {
                    ...
                    object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlVerifyFailed");
                    throw new CertPathReviewerException((ErrorBundle)object6, (Throwable)exception);
                }
            } else {
                ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlNoIssuerPublicKey");
            ...
            if (object7 != null) {
                ...
                if (((X509CRLEntry)object7).hasExtensions()) {
                    try {
                        ...
                        object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlReasonExtError");
                ...
                if (!date.before(((X509CRLEntry)object7).getRevocationDate())) {
                    object5 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.certRevoked", new Object[]{new TrustedInput(((X509CRLEntry)object7).getRevocationDate()), object6});
                    throw new CertPathReviewerException((ErrorBundle)object5);
                }
                object5 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.revokedAfterValidation", new Object[]{new TrustedInput(((X509CRLEntry)object7).getRevocationDate()), object6});
                this.addNotification((ErrorBundle)object5, n);
            } else {
                object9 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.notRevoked");
                this.addNotification((ErrorBundle)object9, n);
            }
            object9 = ((X509CRL)object8).getNextUpdate();
            if (object9 != null && !date.before((Date)object9)) {
                object6 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlUpdateAvailable", new Object[]{new TrustedInput(object9)});
                this.addNotification((ErrorBundle)object6, n);
            }
            try {
                ...
                object4 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.distrPtExtError");
                throw new CertPathReviewerException((ErrorBundle)object4);
            }
            try {
                ...
                object3 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.deltaCrlExtError");
            ...
            if (object5 != null) {
                ...
                try {
                    ...
                    object = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlExtractionError");
                ...
                while (iterator.hasNext()) {
                    ...
                    try {
                        ...
                        ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.distrPtExtError");
                ...
                if (!bl2) {
                    object2 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noBaseCRL");
            ...
            if (object6 != null) {
                ...
                try {
                    ...
                    object2 = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.crlBCExtError");
        ...
        if (!bl) {
            ErrorBundle errorBundle = PKIXCertPathReviewer.createErrorBundle("CertPathReviewer.noValidCrlFound");
            throw new CertPathReviewerException(errorBundle);
        }
    }
    ...
    protected Collection getTrustAnchors(X509Certificate x509Certificate, Set set) throws CertPathReviewerException {
        ...
        try {
            ...
            if (object2 != null) {
                object = AuthorityKeyIdentifier.getInstance(JcaX509ExtensionUtils.parseExtensionValue((byte[])object2));
                serializable = ((AuthorityKeyIdentifier)object).getAuthorityCertSerialNumber();
                if (serializable != null) {
                    x509CertSelector.setSerialNumber(((AuthorityKeyIdentifier)object).getAuthorityCertSerialNumber());
                } else {
                    ASN1OctetString aSN1OctetString = ((AuthorityKeyIdentifier)object).getKeyIdentifierObject();
