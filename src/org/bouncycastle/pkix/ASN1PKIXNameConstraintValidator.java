...
implements NameConstraintValidator {
    ...
    public void checkPermitted(GeneralName generalName) throws NameConstraintValidatorException {
        switch (generalName.getTagNo()) {
            ...
            case 2: {
                this.checkPermittedDNS(this.permittedSubtreesDNS, ASN1IA5String.getInstance(generalName.getName()).getString());
                break;
            }
            case 4: {
            ...
            case 6: {
                this.checkPermittedURI(this.permittedSubtreesURI, ASN1IA5String.getInstance(generalName.getName()).getString());
                break;
            }
            case 7: {
    ...
    public void checkExcluded(GeneralName generalName) throws NameConstraintValidatorException {
        switch (generalName.getTagNo()) {
            ...
            case 2: {
                this.checkExcludedDNS(this.excludedSubtreesDNS, ASN1IA5String.getInstance(generalName.getName()).getString());
                break;
            }
            case 4: {
            ...
            case 6: {
                this.checkExcludedURI(this.excludedSubtreesURI, ASN1IA5String.getInstance(generalName.getName()).getString());
                break;
            }
            case 7: {
                byte[] byArray = ASN1OctetString.getInstance(generalName.getName()).getOctets();
    ...
    public boolean equals(Object object) {
        if (!(object instanceof ASN1PKIXNameConstraintValidator)) {
            return false;
        }
        ASN1PKIXNameConstraintValidator aSN1PKIXNameConstraintValidator = (ASN1PKIXNameConstraintValidator)object;
        return this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesDN, this.excludedSubtreesDN) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesDNS, this.excludedSubtreesDNS) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesEmail, this.excludedSubtreesEmail) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesIP, this.excludedSubtreesIP) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesURI, this.excludedSubtreesURI) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.excludedSubtreesOtherName, this.excludedSubtreesOtherName) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesDN, this.permittedSubtreesDN) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesDNS, this.permittedSubtreesDNS) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesEmail, this.permittedSubtreesEmail) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesIP, this.permittedSubtreesIP) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesURI, this.permittedSubtreesURI) && this.collectionsAreEqual(aSN1PKIXNameConstraintValidator.permittedSubtreesOtherName, this.permittedSubtreesOtherName);
    }
    ...
    private void checkPermittedDN(Set set, ASN1Sequence aSN1Sequence) throws NameConstraintValidatorException {
        ...
        for (ASN1Sequence aSN1Sequence2 : set) {
            if (!ASN1PKIXNameConstraintValidator.withinDNSubtree(aSN1Sequence, aSN1Sequence2)) continue;
            return;
        }
    ...
    private Set intersectDN(Set set, Set set2) {
        ...
        while (iterator.hasNext()) {
            ...
            for (ASN1Sequence aSN1Sequence2 : set) {
                if (ASN1PKIXNameConstraintValidator.withinDNSubtree(aSN1Sequence, aSN1Sequence2)) {
                    hashSet.add(aSN1Sequence);
                    continue;
                }
                if (!ASN1PKIXNameConstraintValidator.withinDNSubtree(aSN1Sequence2, aSN1Sequence)) continue;
    ...
    private Set unionDN(Set set, ASN1Sequence aSN1Sequence) {
        ...
        for (ASN1Sequence aSN1Sequence2 : set) {
            ...
            if (ASN1PKIXNameConstraintValidator.withinDNSubtree(aSN1Sequence2, aSN1Sequence)) {
                hashSet.add(aSN1Sequence);
                continue;
            }
            hashSet.add(aSN1Sequence2);
    ...
    private Set unionOtherName(Set set, OtherName otherName) {
        HashSet<OtherName> hashSet = new HashSet<OtherName>(set);
    ...
    private Set intersectIPRange(byte[] byArray, byte[] byArray2) {
        ...
        byte[] byArray9 = ASN1PKIXNameConstraintValidator.min(byArray8[1], byArray8[3]);
        byte[] byArray10 = ASN1PKIXNameConstraintValidator.max(byArray8[0], byArray8[2]);
        if (ASN1PKIXNameConstraintValidator.compareTo(byArray10, byArray9) == 1) {
            return Collections.EMPTY_SET;
        }
        byte[] byArray11 = ASN1PKIXNameConstraintValidator.or(byArray8[0], byArray8[2]);
        byte[] byArray12 = ASN1PKIXNameConstraintValidator.or(byArray5, byArray7);
    ...
    private boolean isUriConstrained(String string, String string2) {
        String string3 = ASN1PKIXNameConstraintValidator.extractHostFromURL(string);
    ...
    private static int compareTo(byte[] byArray, byte[] byArray2) {
        ...
        if (Arrays.areEqual(ASN1PKIXNameConstraintValidator.max(byArray, byArray2), byArray)) {
            return 1;
        }
        return -1;
    }
