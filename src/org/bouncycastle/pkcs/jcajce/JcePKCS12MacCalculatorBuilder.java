    ...
    public MacCalculator build(char[] cArray) throws OperatorCreationException {
        ...
        try {
            ...
            return new MacCalculator(){
                final /* synthetic */ JcePKCS12MacCalculatorBuilder this$0;
                {
                    this.this$0 = jcePKCS12MacCalculatorBuilder;
                }

                @Override
                public AlgorithmIdentifier getAlgorithmIdentifier() {
                    return new AlgorithmIdentifier(this.this$0.algorithm, new PKCS12PBEParams(byArray, this.this$0.iterationCount));
                }
