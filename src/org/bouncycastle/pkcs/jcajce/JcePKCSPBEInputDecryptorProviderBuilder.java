...
public class JcePKCSPBEInputDecryptorProviderBuilder {
    ...
    public InputDecryptorProvider build(final char[] cArray) {
        return new InputDecryptorProvider(){
            ...
            final /* synthetic */ JcePKCSPBEInputDecryptorProviderBuilder this$0;
            {
                ...
                block13: {
                    ...
                    try {
                        if (aSN1ObjectIdentifier.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                            ...
                            this.cipher = this.this$0.helper.createCipher(aSN1ObjectIdentifier.getId());
                            this.cipher.init(2, new PKCS12KeyWithParameters(cArray, this.this$0.wrongPKCS12Zero, pKCS12PBEParams.getIV(), pKCS12PBEParams.getIterations().intValue()));
                        ...
                        if (aSN1ObjectIdentifier.equals(PKCSObjectIdentifiers.id_PBES2)) {
                            ...
                            if (MiscObjectIdentifiers.id_scrypt.equals(pBES2Parameters.getKeyDerivationFunc().getAlgorithm())) {
                                ...
                                SecretKeyFactory secretKeyFactory = this.this$0.helper.createSecretKeyFactory("SCRYPT");
                                secretKey = secretKeyFactory.generateSecret(new ScryptKeySpec(cArray, ((ScryptParams)object2).getSalt(), ((ScryptParams)object2).getCostParameter().intValue(), ((ScryptParams)object2).getBlockSize().intValue(), ((ScryptParams)object2).getParallelizationParameter().intValue(), this.this$0.keySizeProvider.getKeySize((AlgorithmIdentifier)object)));
                            } else {
                                object2 = this.this$0.helper.createSecretKeyFactory(pBES2Parameters.getKeyDerivationFunc().getAlgorithm().getId());
                                ...
                                secretKey = ((PBKDF2Params)object).isDefaultPrf() ? ((SecretKeyFactory)object2).generateSecret(new PBEKeySpec(cArray, ((PBKDF2Params)object).getSalt(), ((PBKDF2Params)object).getIterationCount().intValue(), this.this$0.keySizeProvider.getKeySize(algorithmIdentifier2))) : ((SecretKeyFactory)object2).generateSecret(new PBKDF2KeySpec(cArray, ((PBKDF2Params)object).getSalt(), ((PBKDF2Params)object).getIterationCount().intValue(), this.this$0.keySizeProvider.getKeySize(algorithmIdentifier2), ((PBKDF2Params)object).getPrf()));
                            }
                            ...
                            } else if (object2 instanceof ASN1Sequence && this.this$0.isCCMorGCM(pBES2Parameters.getEncryptionScheme())) {
