...
public class JcePBMac1CalculatorBuilder {
    ...
    public JcePBMac1CalculatorBuilder(String string, int n) {
        this(string, n, defaultFinder);
    }

    public JcePBMac1CalculatorBuilder(String string, int n, MacAlgorithmIdentifierFinder macAlgorithmIdentifierFinder) {
        this.macAlgorithm = macAlgorithmIdentifierFinder.find(string);
        this.keySize = n;
    }
    ...
    public JcePBMac1CalculatorBuilder setProvider(String string) {
    ...
    public JcePBMac1CalculatorBuilder setIterationCount(int n) {
        this.iterationCount = n;
        return this;
    }

    public JcePBMac1CalculatorBuilder setSaltLength(int n) {
        this.saltLength = n;
        return this;
    }

    public JcePBMac1CalculatorBuilder setSalt(byte[] byArray) {
        this.salt = byArray;
        return this;
    }
    ...
    public MacCalculator build(char[] cArray) throws OperatorCreationException {
        ...
        try {
            ...
            final SecretKey secretKey = secretKeyFactory.generateSecret(new PBKDF2KeySpec(cArray, this.salt, this.iterationCount, this.keySize, this.prf));
            mac.init(secretKey);
            return new MacCalculator(){
                final /* synthetic */ JcePBMac1CalculatorBuilder this$0;
                {
                    this.this$0 = jcePBMac1CalculatorBuilder;
                }

                @Override
                public AlgorithmIdentifier getAlgorithmIdentifier() {
                    return new AlgorithmIdentifier(PKCSObjectIdentifiers.id_PBMAC1, new PBMAC1Params(new AlgorithmIdentifier(PKCSObjectIdentifiers.id_PBES2, new PBKDF2Params(this.this$0.salt, this.this$0.iterationCount, (this.this$0.keySize + 7) / 8, this.this$0.prf)), this.this$0.macAlgorithm));
                }
                ...
                public GenericKey getKey() {
                    return new GenericKey(this.getAlgorithmIdentifier(), secretKey.getEncoded());
                }
            };
        }
