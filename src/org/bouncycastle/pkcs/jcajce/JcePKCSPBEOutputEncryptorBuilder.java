        ...
        try {
            ...
            if (this.isPKCS12(this.algorithm)) {
                ...
                if (MiscObjectIdentifiers.id_scrypt.equals(pBKDFConfig.getAlgorithm())) {
                    ...
                    PBES2Parameters pBES2Parameters = algorithmParameters != null ? new PBES2Parameters(new KeyDerivationFunc(MiscObjectIdentifiers.id_scrypt, scryptParams), new EncryptionScheme(this.keyEncAlgorithm, ASN1Primitive.fromByteArray(cipher.getParameters().getEncoded()))) : new PBES2Parameters(new KeyDerivationFunc(MiscObjectIdentifiers.id_scrypt, scryptParams), new EncryptionScheme(this.keyEncAlgorithm));
            ...
            return new OutputEncryptor(){
                final /* synthetic */ JcePKCSPBEOutputEncryptorBuilder this$0;
                {
                    this.this$0 = jcePKCSPBEOutputEncryptorBuilder;
                }
                ...
                public GenericKey getKey() {
                    if (this.this$0.isPKCS12(algorithmIdentifier.getAlgorithm())) {
