...
public class BcPKCS12PBEOutputEncryptorBuilder {
    ...
    public OutputEncryptor build(final char[] cArray) {
        ...
        return new OutputEncryptor(){
            final /* synthetic */ BcPKCS12PBEOutputEncryptorBuilder this$0;
            {
                this.this$0 = bcPKCS12PBEOutputEncryptorBuilder;
            }

            @Override
            public AlgorithmIdentifier getAlgorithmIdentifier() {
                return new AlgorithmIdentifier(this.this$0.algorithm, pKCS12PBEParams);
            }
            ...
            public GenericKey getKey() {
                return new GenericKey(new AlgorithmIdentifier(this.this$0.algorithm, pKCS12PBEParams), PKCS12ParametersGenerator.PKCS12PasswordToBytes(cArray));
            }
        };
    }
}
