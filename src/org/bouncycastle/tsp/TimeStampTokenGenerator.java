...
public class TimeStampTokenGenerator {
    ...
    public TimeStampTokenGenerator(final SignerInfoGenerator signerInfoGenerator, DigestCalculator digestCalculator, ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean bl) throws IllegalArgumentException, TSPException {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = algorithmIdentifier.getAlgorithm();
        try {
            ...
            if (bl) {
                aSN1Object = new GeneralNames(new GeneralName(x509CertificateHolder.getIssuer()));
                ASN1Integer aSN1Integer = x509CertificateHolder.toASN1Structure().getSerialNumber();
                issuerSerial = new IssuerSerial((GeneralNames)aSN1Object, aSN1Integer);
            }
            if (OIWObjectIdentifiers.idSHA1.equals(aSN1ObjectIdentifier2)) {
                aSN1Object = new ESSCertID(dEROctetString, issuerSerial);
                this.signerInfoGen = new SignerInfoGenerator(signerInfoGenerator, new CMSAttributeTableGenerator(){
                    ...
                    public AttributeTable getAttributes(Map map) throws CMSAttributeTableGenerationException {
                        ...
                        if (attributeTable.get(PKCSObjectIdentifiers.id_aa_signingCertificate) == null) {
                            return attributeTable.add(PKCSObjectIdentifiers.id_aa_signingCertificate, new SigningCertificate(this.val$essCertID));
                        }
                ...
                aSN1Object = new ESSCertIDv2(algorithmIdentifier, dEROctetString, issuerSerial);
                this.signerInfoGen = new SignerInfoGenerator(signerInfoGenerator, new CMSAttributeTableGenerator(){
                    final /* synthetic */ ESSCertIDv2 val$essCertIDv2;
                    final /* synthetic */ TimeStampTokenGenerator this$0;
                    {
                        this.val$essCertIDv2 = eSSCertIDv2;
                        this.this$0 = timeStampTokenGenerator;
                    }
                    ...
                    public AttributeTable getAttributes(Map map) throws CMSAttributeTableGenerationException {
                        ...
                        if (attributeTable.get(PKCSObjectIdentifiers.id_aa_signingCertificateV2) == null) {
                            return attributeTable.add(PKCSObjectIdentifiers.id_aa_signingCertificateV2, new SigningCertificateV2(this.val$essCertIDv2));
                        }
                        return attributeTable;
                    }
                }, signerInfoGenerator.getUnsignedAttributeTableGenerator());
    ...
    public TimeStampToken generate(TimeStampRequest timeStampRequest, BigInteger bigInteger, Date date, Extensions extensions) throws TSPException {
        ...
        TimeStampReq timeStampReq = timeStampRequest.toASN1Structure();
        ...
        aSN1Integer = timeStampReq.getNonce();
        aSN1Primitive = timeStampReq.getReqPolicy();
    ...
    private ASN1GeneralizedTime createGeneralizedTime(Date date) throws TSPException {
        ...
        SimpleDateFormat simpleDateFormat = this.locale == null ? new SimpleDateFormat(string, LocaleUtil.EN_Locale) : new SimpleDateFormat(string, this.locale);
