...
public class CMSTimeStampedData {
    ...
    public CMSTimeStampedData addTimeStamp(TimeStampToken timeStampToken) throws CMSException {
        ...
        return new CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData, new TimeStampedData(this.timeStampedData.getDataUriIA5(), this.timeStampedData.getMetaData(), this.timeStampedData.getContent(), new Evidence(new TimeStampTokenEvidence(timeStampAndCRLArray2)))));
    }
    ...
    public URI getDataUri() throws URISyntaxException {
        ...
        if (aSN1IA5String != null) {
            return new URI(aSN1IA5String.getString());
        }
        return null;
    }
