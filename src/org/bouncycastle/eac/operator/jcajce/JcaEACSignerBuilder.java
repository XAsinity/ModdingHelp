...
public class JcaEACSignerBuilder {
    ...
    public EACSigner build(final ASN1ObjectIdentifier aSN1ObjectIdentifier, PrivateKey privateKey) throws OperatorCreationException {
        ...
        return new EACSigner(){
            final /* synthetic */ JcaEACSignerBuilder this$0;
            {
                this.this$0 = jcaEACSignerBuilder;
            }
    ...
    private static byte[] reencode(byte[] byArray) {
        ...
        int n2 = JcaEACSignerBuilder.unsignedIntLength(byArray2);
        int n3 = JcaEACSignerBuilder.max(n2, n = JcaEACSignerBuilder.unsignedIntLength(byArray3));
        if ((n3 & 1) != 0) {
            ++n3;
        }
        byte[] byArray4 = new byte[n3 * 2];
        Arrays.fill(byArray4, (byte)0);
        JcaEACSignerBuilder.copyUnsignedInt(byArray2, byArray4, n3 - n2);
        JcaEACSignerBuilder.copyUnsignedInt(byArray3, byArray4, 2 * n3 - n);
        return byArray4;
    }
