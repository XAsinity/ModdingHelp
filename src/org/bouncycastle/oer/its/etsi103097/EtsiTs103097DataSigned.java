...
extends EtsiTs103097Data {
    ...
    public static EtsiTs103097DataSigned getInstance(Object object) {
        if (object instanceof EtsiTs103097DataSigned) {
            return (EtsiTs103097DataSigned)object;
        }
        if (object != null) {
            return new EtsiTs103097DataSigned(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
