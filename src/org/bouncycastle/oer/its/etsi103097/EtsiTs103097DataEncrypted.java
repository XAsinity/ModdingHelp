...
extends EtsiTs103097Data {
    ...
    public static EtsiTs103097DataEncrypted getInstance(Object object) {
        if (object instanceof EtsiTs103097DataEncrypted) {
            return (EtsiTs103097DataEncrypted)object;
        }
        if (object != null) {
            return new EtsiTs103097DataEncrypted(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
