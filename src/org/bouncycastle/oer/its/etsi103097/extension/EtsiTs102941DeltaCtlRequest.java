...
extends EtsiTs102941CtlRequest {
    ...
    public static EtsiTs102941DeltaCtlRequest getInstance(Object object) {
        if (object instanceof EtsiTs102941DeltaCtlRequest) {
            return (EtsiTs102941DeltaCtlRequest)object;
        }
        if (object != null) {
            return new EtsiTs102941DeltaCtlRequest(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
