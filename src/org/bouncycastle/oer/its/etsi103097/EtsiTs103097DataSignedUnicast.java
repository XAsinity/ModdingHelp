...
extends EtsiTs103097Data {
    ...
    public static EtsiTs103097DataSignedUnicast getInstance(Object object) {
        if (object instanceof EtsiTs103097DataSignedUnicast) {
            return (EtsiTs103097DataSignedUnicast)object;
        }
        if (object != null) {
            return new EtsiTs103097DataSignedUnicast(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
