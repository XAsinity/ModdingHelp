...
extends ASN1Object {
    ...
    public static Point384 getInstance(Object object) {
        if (object instanceof Point384) {
            return (Point384)object;
        }
        if (object != null) {
            return new Point384(ASN1Sequence.getInstance(object));
        }
        return null;
    }
