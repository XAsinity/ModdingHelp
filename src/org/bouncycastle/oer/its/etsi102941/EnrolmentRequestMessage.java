...
extends EtsiTs103097DataSignedAndEncryptedUnicast {
    ...
    public static EnrolmentRequestMessage getInstance(Object object) {
        if (object instanceof EnrolmentRequestMessage) {
            return (EnrolmentRequestMessage)object;
        }
        if (object != null) {
            return new EnrolmentRequestMessage(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
