...
extends CtlFormat {
    ...
    public static ToBeSignedTlmCtl getInstance(Object object) {
        if (object instanceof ToBeSignedTlmCtl) {
            return (ToBeSignedTlmCtl)object;
        }
        if (object != null) {
            return new ToBeSignedTlmCtl(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
