...
extends EtsiTs103097DataSigned {
    ...
    public static RcaCertificateTrustListMessage getInstance(Object object) {
        if (object instanceof RcaCertificateTrustListMessage) {
            return (RcaCertificateTrustListMessage)object;
        }
        if (object != null) {
            return new RcaCertificateTrustListMessage(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
