...
extends ASN1Enumerated {
    ...
    public AuthorizationResponseCode(int n) {
        super(n);
        this.assertValues();
    }
    ...
    public AuthorizationResponseCode(byte[] byArray) {
        super(byArray);
        this.assertValues();
    }
    ...
    public static AuthorizationResponseCode getInstance(Object object) {
        if (object instanceof AuthorizationResponseCode) {
            return (AuthorizationResponseCode)object;
        }
        if (object != null) {
            return new AuthorizationResponseCode(ASN1Enumerated.getInstance(object));
        }
        return null;
    }
}
