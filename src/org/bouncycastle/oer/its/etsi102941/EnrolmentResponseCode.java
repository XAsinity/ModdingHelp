...
extends ASN1Enumerated {
    ...
    public EnrolmentResponseCode(int n) {
        super(n);
        this.assertValues();
    }
    ...
    public EnrolmentResponseCode(byte[] byArray) {
        super(byArray);
        this.assertValues();
    }
    ...
    public static EnrolmentResponseCode getInstance(Object object) {
        if (object instanceof EnrolmentResponseCode) {
            return (EnrolmentResponseCode)object;
        }
        if (object != null) {
            return new EnrolmentResponseCode(ASN1Enumerated.getInstance(object));
        }
        return null;
    }
