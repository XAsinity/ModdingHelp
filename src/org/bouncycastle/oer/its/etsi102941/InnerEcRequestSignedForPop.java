...
extends EtsiTs103097DataSigned {
    ...
    public static InnerEcRequestSignedForPop getInstance(Object object) {
        if (object instanceof InnerEcRequestSignedForPop) {
            return (InnerEcRequestSignedForPop)object;
        }
        if (object != null) {
            return new InnerEcRequestSignedForPop(ASN1Sequence.getInstance(object));
        }
        return null;
    }
}
