    ...
    public DANEEntryFetcher build(final String string) {
        ...
        if (this.dnsServerList.size() > 0) {
            ...
            while (iterator.hasNext()) {
                ...
                stringBuilder.append("dns://" + iterator.next());
            }
            hashtable.put("java.naming.provider.url", stringBuilder.toString());
        }
        return new DANEEntryFetcher(){
            final /* synthetic */ JndiDANEFetcherFactory this$0;
            {
                this.this$0 = jndiDANEFetcherFactory;
            }
            ...
            public List getEntries() throws DANEException {
                ...
                try {
                    ...
                    if (string.indexOf("_smimecert.") > 0) {
                        ...
                        if (attribute != null) {
                            this.this$0.addEntries(arrayList, string, attribute);
                        }
                    } else {
                        ...
                        while (namingEnumeration.hasMore()) {
                            ...
                            this.this$0.addEntries(arrayList, string3, attribute);
                        }
                    }
                    return arrayList;
                }
