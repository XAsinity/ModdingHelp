...
extends X509v3CertificateBuilder {
    ...
    public JcaX509v3CertificateBuilder(X500Name x500Name, BigInteger bigInteger, Date date, Date date2, X500Name x500Name2, PublicKey publicKey) {
        super(x500Name, bigInteger, date, date2, x500Name2, JcaX509v3CertificateBuilder.getSubjectPublicKeyInfo(publicKey));
    }
    ...
    public JcaX509v3CertificateBuilder(X500Name x500Name, BigInteger bigInteger, Time time, Time time2, X500Name x500Name2, PublicKey publicKey) {
        super(x500Name, bigInteger, time, time2, x500Name2, JcaX509v3CertificateBuilder.getSubjectPublicKeyInfo(publicKey));
    }
    ...
    public JcaX509v3CertificateBuilder(X500Principal x500Principal, BigInteger bigInteger, Date date, Date date2, X500Principal x500Principal2, PublicKey publicKey) {
        super(X500Name.getInstance(x500Principal.getEncoded()), bigInteger, date, date2, X500Name.getInstance(x500Principal2.getEncoded()), JcaX509v3CertificateBuilder.getSubjectPublicKeyInfo(publicKey));
    }
