...
class CertUtils {
    ...
    static ASN1TaggedObject trimExtensions(int n, Extensions extensions) {
        ...
        for (int i = 0; i != aSN1Sequence.size(); ++i) {
            ...
            if (Extension.altSignatureValue.equals(aSN1Sequence2.getObjectAt(0))) continue;
            aSN1EncodableVector.add(aSN1Sequence2);
        }
        return new DERTaggedObject(true, n, (ASN1Encodable)new DERSequence(aSN1EncodableVector));
    }
}
