...
public class JceOpenSSLPKCS8DecryptorProviderBuilder {
    ...
    public InputDecryptorProvider build(final char[] cArray) throws OperatorCreationException {
        return new InputDecryptorProvider(){
            final /* synthetic */ JceOpenSSLPKCS8DecryptorProviderBuilder this$0;
            {
                this.this$0 = jceOpenSSLPKCS8DecryptorProviderBuilder;
            }
            ...
            public InputDecryptor get(final AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
                try {
                    ...
                    if (PEMUtilities.isPKCS5Scheme2(algorithmIdentifier.getAlgorithm())) {
                        ...
                        SecretKey secretKey = PEMUtilities.isHmacSHA1(pBKDF2Params.getPrf()) ? PEMUtilities.generateSecretKeyForPKCS5Scheme2(this.this$0.helper, string, cArray, byArray, n) : PEMUtilities.generateSecretKeyForPKCS5Scheme2(this.this$0.helper, string, cArray, byArray, n, pBKDF2Params.getPrf());
                        cipher = this.this$0.helper.createCipher(PEMUtilities.getCipherName(encryptionScheme.getAlgorithm()));
                        AlgorithmParameters algorithmParameters = this.this$0.helper.createAlgorithmParameters(string);
                        ...
                        cipher = this.this$0.helper.createCipher(PEMUtilities.getCipherName(algorithmIdentifier.getAlgorithm()));
