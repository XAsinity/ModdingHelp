...
public final class Arrays {
    ...
    public static boolean constantTimeAreEqual(int n, long[] lArray, int n2, long[] lArray2, int n3) {
        if (null == lArray) {
            throw new NullPointerException("'a' cannot be null");
        }
        if (null == lArray2) {
        ...
        if (n2 > lArray.length - n) {
            throw new IndexOutOfBoundsException("'aOff' value invalid for specified length");
        }
        if (n3 > lArray2.length - n) {
            throw new IndexOutOfBoundsException("'bOff' value invalid for specified length");
        }
        long l = 0L;
        for (int i = 0; i < n; ++i) {
            l |= lArray[n2 + i] ^ lArray2[n3 + i];
        }
        return 0L == l;
    }
    ...
    public static boolean constantTimeAreEqual(char[] cArray, char[] cArray2) {
        ...
        int n3 = cArray.length ^ cArray2.length;
        for (n = 0; n != n2; ++n) {
            n3 |= cArray[n] ^ cArray2[n];
        }
        for (n = n2; n < cArray2.length; ++n) {
            n3 |= (byte)cArray2[n] ^ (byte)(~cArray2[n]);
        }
        return n3 == 0;
    }

    public static boolean constantTimeAreEqual(long[] lArray, long[] lArray2) {
        int n;
        ...
        long l = lArray.length ^ lArray2.length;
        for (n = 0; n != n2; ++n) {
            l |= lArray[n] ^ lArray2[n];
        }
        for (n = n2; n < lArray2.length; ++n) {
            l |= lArray2[n] ^ (lArray2[n] ^ 0xFFFFFFFFFFFFFFFFL);
        }
        return l == 0L;
    }
    ...
    public static void reverseInPlace(byte[] byArray, int n, int n2) {
        int n3 = n;
        int n4 = n + n2 - 1;
        while (n3 < n4) {
            byte by = byArray[n3];
    ...
    public static void clear(long[] lArray) {
        if (null != lArray) {
            java.util.Arrays.fill(lArray, 0L);
        }
    }

    public static void clear(char[] cArray) {
        if (null != cArray) {
            java.util.Arrays.fill(cArray, '\u0000');
        }
    }
    ...
    public static boolean segmentsOverlap(int n, int n2, int n3, int n4) {
        return n2 > 0 && n4 > 0 && n - n3 < n4 && n3 - n < n2;
    }

    public static void validateRange(byte[] byArray, int n, int n2) {
        if (byArray == null) {
            throw new NullPointerException("'buf' cannot be null");
        }
        if ((n | byArray.length - n | n2 - n | byArray.length - n2) < 0) {
            throw new IndexOutOfBoundsException("buf.length: " + byArray.length + ", from: " + n + ", to: " + n2);
        }
    }

    public static void validateSegment(byte[] byArray, int n, int n2) {
        if (byArray == null) {
            throw new NullPointerException("'buf' cannot be null");
        }
        ...
        int n4 = n3 - n2;
        if ((n | n2 | n3 | n4) < 0) {
            throw new IndexOutOfBoundsException("buf.length: " + byArray.length + ", off: " + n + ", len: " + n2);
        }
    }
