...
public final class Streams {
    ...
    public static void pipeAll(InputStream inputStream, OutputStream outputStream) throws IOException {
        Streams.pipeAll(inputStream, outputStream, BUFFER_SIZE);
    }

    public static void pipeAll(InputStream inputStream, OutputStream outputStream, int n) throws IOException {
        int n2;
    ...
    public static void validateBufferArguments(byte[] byArray, int n, int n2) {
        Arrays.validateSegment(byArray, n, n2);
    }
