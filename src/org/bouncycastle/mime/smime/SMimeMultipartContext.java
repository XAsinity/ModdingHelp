...
implements MimeMultipartContext {
    ...
    public MimeContext createContext(final int n) throws IOException {
        return new MimeContext(){
            final /* synthetic */ SMimeMultipartContext this$0;
            {
                this.this$0 = sMimeMultipartContext;
            }

            @Override
            public InputStream applyContext(Headers headers, InputStream inputStream) throws IOException {
                if (n == 0) {
                    OutputStream outputStream = this.this$0.getDigestOutputStream();
                    headers.dumpHeaders(outputStream);
                    outputStream.write(13);
                    outputStream.write(10);
                    return new TeeInputStream(inputStream, new CanonicalOutputStream(this.this$0.parserContext, headers, outputStream));
                }
                return inputStream;
            }
        };
