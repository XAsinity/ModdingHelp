...
extends ASN1Object {
    ...
    public PrivateKeyInfo(AlgorithmIdentifier algorithmIdentifier, byte[] byArray) throws IOException {
        this(algorithmIdentifier, byArray, null, null);
    }
    ...
    public PrivateKeyInfo(AlgorithmIdentifier algorithmIdentifier, byte[] byArray, ASN1Set aSN1Set) throws IOException {
        this(algorithmIdentifier, byArray, aSN1Set, null);
    }
    ...
    public PrivateKeyInfo(AlgorithmIdentifier algorithmIdentifier, ASN1Encodable aSN1Encodable, ASN1Set aSN1Set, byte[] byArray) throws IOException {
        this(algorithmIdentifier, aSN1Encodable.toASN1Primitive().getEncoded("DER"), aSN1Set, byArray);
    }

    public PrivateKeyInfo(AlgorithmIdentifier algorithmIdentifier, byte[] byArray, ASN1Set aSN1Set, byte[] byArray2) {
        this.version = new ASN1Integer(byArray2 != null ? BigIntegers.ONE : BigIntegers.ZERO);
        this.privateKeyAlgorithm = algorithmIdentifier;
        this.privateKey = new DEROctetString(byArray);
        this.attributes = aSN1Set;
        this.publicKey = byArray2 == null ? null : new DERBitString(byArray2);
    }
