...
extends AbstractX500NameStyle {
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String string) {
        ...
        if (aSN1ObjectIdentifier.equals(C) || aSN1ObjectIdentifier.equals(SERIALNUMBER) || aSN1ObjectIdentifier.equals(DN_QUALIFIER) || aSN1ObjectIdentifier.equals(TELEPHONE_NUMBER) || aSN1ObjectIdentifier.equals(JURISDICTION_C)) {
    ...
    public String toString(X500Name x500Name) {
        ...
        for (int i = 0; i < rDNArray.length; ++i) {
            ...
            IETFUtils.appendRDN(stringBuilder, rDNArray[i], this.defaultSymbols);
        }
