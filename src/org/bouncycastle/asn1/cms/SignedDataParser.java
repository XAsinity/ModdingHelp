...
public class SignedDataParser {
    ...
    public ASN1SetParser getCertificates() throws IOException {
        ...
        if (this._nextObject instanceof ASN1TaggedObjectParser && (aSN1TaggedObjectParser = (ASN1TaggedObjectParser)this._nextObject).hasContextTag(0)) {
    ...
    public ASN1SetParser getCrls() throws IOException {
        ...
        if (this._nextObject instanceof ASN1TaggedObjectParser && (aSN1TaggedObjectParser = (ASN1TaggedObjectParser)this._nextObject).hasContextTag(1)) {
            ASN1SetParser aSN1SetParser = (ASN1SetParser)aSN1TaggedObjectParser.parseBaseUniversal(false, 17);
            this._nextObject = null;
            return aSN1SetParser;
        }
