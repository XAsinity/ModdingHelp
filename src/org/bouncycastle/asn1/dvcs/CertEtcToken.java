...
implements ASN1Choice {
    ...
    private CertEtcToken(ASN1TaggedObject aSN1TaggedObject) {
        ...
        switch (this.tagNo) {
            ...
            case 1: {
                this.value = ESSCertID.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            }
            case 2: {
            ...
            case 3: {
                this.value = ContentInfo.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            }
            case 4: {
            ...
            case 5: {
                this.value = CertStatus.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            }
            case 6: {
            ...
            case 8: {
                this.value = SMIMECapabilities.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            }
            default: {
    ...
    public static CertEtcToken getInstance(Object object) {
        ...
        if (object instanceof ASN1TaggedObject) {
            return new CertEtcToken(ASN1TaggedObject.getInstance(object, 128));
        }
        if (object != null) {
