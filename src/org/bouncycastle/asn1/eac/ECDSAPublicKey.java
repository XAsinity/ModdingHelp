...
extends PublicKeyDataObject {
    ...
    public ASN1EncodableVector getASN1EncodableVector(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean bl) {
        ...
        if (!bl) {
            ...
            aSN1EncodableVector.add(new DERTaggedObject(false, 4, (ASN1Encodable)new DEROctetString(this.getBasePointG())));
            aSN1EncodableVector.add(new UnsignedInteger(5, this.getOrderOfBasePointR()));
        }
        aSN1EncodableVector.add(new DERTaggedObject(false, 6, (ASN1Encodable)new DEROctetString(this.getPublicPointY())));
        if (!bl) {
