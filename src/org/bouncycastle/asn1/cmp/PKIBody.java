...
implements ASN1Choice {
    ...
    private PKIBody(ASN1TaggedObject aSN1TaggedObject) {
        ...
        try {
            this.body = PKIBody.getBodyForType(this.tagNo, aSN1TaggedObject.getExplicitBaseObject());
        }
    ...
    private static ASN1Encodable getBodyForType(int n, ASN1Encodable aSN1Encodable) {
        try {
            ...
            throw new IllegalArgumentException("body type of " + n + " has incorrect type got: " + aSN1Encodable.getClass());
        }
        catch (IllegalArgumentException illegalArgumentException) {
            throw new IllegalArgumentException("body type of " + n + " has incorrect type got: " + aSN1Encodable.getClass());
        }
