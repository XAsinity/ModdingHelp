...
public class PKIHeaderBuilder {
    ...
    public PKIHeaderBuilder setSenderKID(byte[] byArray) {
        return this.setSenderKID(byArray == null ? null : this.createClonedOctetString(byArray));
    }
    ...
    public PKIHeaderBuilder setRecipKID(byte[] byArray) {
        return this.setRecipKID(byArray == null ? null : this.createClonedOctetString(byArray));
    }
    ...
    public PKIHeaderBuilder setTransactionID(byte[] byArray) {
        return this.setTransactionID(byArray == null ? null : this.createClonedOctetString(byArray));
    }
    ...
    public PKIHeaderBuilder setSenderNonce(byte[] byArray) {
        return this.setSenderNonce(byArray == null ? null : this.createClonedOctetString(byArray));
    }
    ...
    public PKIHeaderBuilder setRecipNonce(byte[] byArray) {
        return this.setRecipNonce(byArray == null ? null : this.createClonedOctetString(byArray));
    }
    ...
    private DEROctetString createClonedOctetString(byte[] byArray) {
