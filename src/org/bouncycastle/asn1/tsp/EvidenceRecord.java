...
extends ASN1Object {
    ...
    public EvidenceRecord addArchiveTimeStamp(ArchiveTimeStamp archiveTimeStamp, boolean bl) {
        ...
        AlgorithmIdentifier algorithmIdentifier = archiveTimeStampChainArray[archiveTimeStampChainArray.length - 1].getArchiveTimestamps()[0].getDigestAlgorithmIdentifier();
        if (!algorithmIdentifier.equals(archiveTimeStamp.getDigestAlgorithmIdentifier())) {
