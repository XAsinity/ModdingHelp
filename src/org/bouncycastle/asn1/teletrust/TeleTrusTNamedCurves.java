...
public class TeleTrusTNamedCurves {
    static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("340E7BE2A280EB74E2BE61BADA745D97E8F7C300"), TeleTrusTNamedCurves.fromHex("1E589A8595423412134FAA2DBDEC95C8D8675E58"), bigInteger, bigInteger2, true));
        }
    ...
    static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            BigInteger bigInteger = TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
            BigInteger bigInteger2 = BigInteger.valueOf(1L);
            return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620C"), TeleTrusTNamedCurves.fromHex("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380"), bigInteger, bigInteger2, true));
        }
    ...
    public static X9ECParameters getByName(String string) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = TeleTrusTNamedCurves.getOID(string);
        return aSN1ObjectIdentifier == null ? null : TeleTrusTNamedCurves.getByOID(aSN1ObjectIdentifier);
    }

    public static X9ECParametersHolder getByNameLazy(String string) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = TeleTrusTNamedCurves.getOID(string);
        return aSN1ObjectIdentifier == null ? null : TeleTrusTNamedCurves.getByOIDLazy(aSN1ObjectIdentifier);
    }

    public static X9ECParameters getByOID(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        X9ECParametersHolder x9ECParametersHolder = TeleTrusTNamedCurves.getByOIDLazy(aSN1ObjectIdentifier);
