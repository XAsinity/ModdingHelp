...
extends ASN1Object {
    ...
    private SignatureCheck(ASN1Sequence aSN1Sequence) {
        ...
        int n = 1;
        this.certificates = aSN1Sequence.getObjectAt(1) instanceof ASN1TaggedObject ? ASN1Sequence.getInstance(ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(n++)).getBaseUniversal(true, 16)) : null;
        this.signatureValue = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(n));
    }
