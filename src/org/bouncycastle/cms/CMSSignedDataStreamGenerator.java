...
extends CMSSignedGenerator {
    ...
    private ASN1Integer calculateVersion(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (CMSSignedDataStreamGenerator.checkForVersion3(this._signers, this.signerGens)) {
            return new ASN1Integer(3L);
        }
    ...
    private static boolean checkForVersion3(List list, List list2) {
        ...
        while (iterator.hasNext()) {
            Object object = ((SignerInformation)iterator.next()).toASN1Structure();
            if (!((SignerInfo)object).getVersion().hasValue(3)) continue;
            return true;
        }
