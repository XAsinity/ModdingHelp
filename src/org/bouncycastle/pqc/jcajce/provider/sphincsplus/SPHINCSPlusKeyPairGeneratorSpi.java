...
extends KeyPairGenerator {
    ...
    protected SPHINCSPlusKeyPairGeneratorSpi(SPHINCSPlusParameterSpec sPHINCSPlusParameterSpec) {
        ...
        this.param = new SPHINCSPlusKeyGenerationParameters(this.random, (SPHINCSPlusParameters)parameters.get(sPHINCSPlusParameterSpec.getName()));
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        String string = SPHINCSPlusKeyPairGeneratorSpi.getNameFromParams(algorithmParameterSpec);
        if (string == null) {
            throw new InvalidAlgorithmParameterException("invalid ParameterSpec: " + algorithmParameterSpec);
        }
        this.param = new SPHINCSPlusKeyGenerationParameters(secureRandom, (SPHINCSPlusParameters)parameters.get(string));
        this.engine.init(this.param);
        this.initialised = true;
    }
    ...
    public KeyPair generateKeyPair() {
        ...
        return new KeyPair(new BCSPHINCSPlusPublicKey(sPHINCSPlusPublicKeyParameters), new BCSPHINCSPlusPrivateKey(sPHINCSPlusPrivateKeyParameters));
    }

    private static String getNameFromParams(AlgorithmParameterSpec algorithmParameterSpec) {
        if (algorithmParameterSpec instanceof SPHINCSPlusParameterSpec) {
            SPHINCSPlusParameterSpec sPHINCSPlusParameterSpec = (SPHINCSPlusParameterSpec)algorithmParameterSpec;
