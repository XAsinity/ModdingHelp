...
extends CipherSpi {
    ...
    SNTRUPrimeCipherSpi(String string) throws NoSuchAlgorithmException {
    ...
    protected void engineInit(int n, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (n == 3) {
            if (!(key instanceof BCSNTRUPrimePublicKey)) throw new InvalidKeyException("Only a " + this.algorithmName + " public key can be used for wrapping");
            ...
            if (!(key instanceof BCSNTRUPrimePrivateKey)) throw new InvalidKeyException("Only a " + this.algorithmName + " private key can be used for unwrapping");
    ...
    protected void engineInit(int n, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        this.engineInit(n, key, kTSParameterSpec, secureRandom);
    }
    ...
    protected Key engineUnwrap(byte[] byArray, String string, int n) throws InvalidKeyException, NoSuchAlgorithmException {
        ...
        try {
            ...
            byte[] byArray2 = sNTRUPrimeKEMExtractor.extractSecret(Arrays.copyOfRange(byArray, 0, sNTRUPrimeKEMExtractor.getEncapsulationLength()));
            Wrapper wrapper = WrapUtil.getWrapper(this.kemParameterSpec.getKeyAlgorithmName());
            ...
            byte[] byArray3 = Arrays.copyOfRange(byArray, sNTRUPrimeKEMExtractor.getEncapsulationLength(), byArray.length);
