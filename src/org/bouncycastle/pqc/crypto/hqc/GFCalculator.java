...
class GFCalculator {
    ...
    static int mult(int n, int n2) {
        int n3 = Utils.toUnsigned16Bits(-n >> 31);
        return Utils.toUnsigned16Bits((n3 &= Utils.toUnsigned16Bits(-n2 >> 31)) & exp[GFCalculator.mod(log[n] + log[n2])]);
    }

    static int mod(int n) {
        int n2 = Utils.toUnsigned16Bits(n - 255);
        int n3 = Utils.toUnsigned8bits(-(n2 >> 15));
        return Utils.toUnsigned16Bits(n2 + (n3 & 0xFF));
    }

    static int inverse(int n) {
        int n2 = Utils.toUnsigned16Bits(-n >> 31);
        return n2 & exp[255 - log[n]];
    }
}
