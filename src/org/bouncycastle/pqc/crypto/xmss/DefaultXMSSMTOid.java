...
implements XMSSOid {
    ...
    static {
        ...
        hashMap.put(DefaultXMSSMTOid.createKey("SHA-256", 32, 16, 67, 40, 4), new DefaultXMSSMTOid(4, "XMSSMT_SHA2_40/4_256"));
        hashMap.put(DefaultXMSSMTOid.createKey("SHA-256", 32, 16, 67, 40, 8), new DefaultXMSSMTOid(5, "XMSSMT_SHA2_40/8_256"));
        hashMap.put(DefaultXMSSMTOid.createKey("SHA-256", 32, 16, 67, 60, 3), new DefaultXMSSMTOid(6, "XMSSMT_SHA2_60/3_256"));
