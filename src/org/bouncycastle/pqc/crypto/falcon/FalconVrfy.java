...
class FalconVrfy {
    ...
    static int mq_montysqr(int n) {
        return FalconVrfy.mq_montymul(n, n);
    }

    static int mq_div_12289(int n, int n2) {
        int n3 = FalconVrfy.mq_montymul(n2, 10952);
        int n4 = FalconVrfy.mq_montysqr(n3);
        int n5 = FalconVrfy.mq_montymul(n4, n3);
        int n6 = FalconVrfy.mq_montymul(n5, n4);
        int n7 = FalconVrfy.mq_montysqr(n6);
        int n8 = FalconVrfy.mq_montysqr(n7);
        int n9 = FalconVrfy.mq_montysqr(n8);
        int n10 = FalconVrfy.mq_montysqr(n9);
        int n11 = FalconVrfy.mq_montysqr(n10);
        int n12 = FalconVrfy.mq_montymul(n11, n5);
        int n13 = FalconVrfy.mq_montymul(n12, n11);
        int n14 = FalconVrfy.mq_montysqr(n13);
        int n15 = FalconVrfy.mq_montysqr(n14);
        int n16 = FalconVrfy.mq_montymul(n15, n12);
        int n17 = FalconVrfy.mq_montysqr(n16);
        int n18 = FalconVrfy.mq_montysqr(n17);
        int n19 = FalconVrfy.mq_montymul(n18, n13);
        int n20 = FalconVrfy.mq_montysqr(n19);
        int n21 = FalconVrfy.mq_montymul(n20, n3);
        return FalconVrfy.mq_montymul(n21, n);
    }

    static void mq_NTT(short[] sArray, int n, int n2) {
        int n3;
        int n4 = n3 = 1 << n2;
        for (int i = 1; i < n3; i <<= 1) {
            ...
            while (n6 < i) {
                ...
                int n8 = n7 + n5;
                for (int j = n7; j < n8; ++j) {
                    int n9 = sArray[n + j] & 0xFFFF;
                    int n10 = FalconVrfy.mq_montymul(sArray[n + j + n5], s);
                    sArray[n + j] = (short)FalconVrfy.mq_add(n9, n10);
                    sArray[n + j + n5] = (short)FalconVrfy.mq_sub(n9, n10);
                }
                ++n6;
                n7 += n4;
            }
    ...
    static void mq_iNTT(short[] sArray, int n, int n2) {
        int n3 = 1 << n2;
        int n4 = 1;
        int n5 = n3;
        while (n5 > 1) {
            ...
            while (n8 < n6) {
                ...
                for (int i = n9; i < n10; ++i) {
                    int n11 = sArray[n + i] & 0xFFFF;
                    int n12 = sArray[n + i + n4] & 0xFFFF;
                    sArray[n + i] = (short)FalconVrfy.mq_add(n11, n12);
                    int n13 = FalconVrfy.mq_sub(n11, n12);
                    sArray[n + i + n4] = (short)FalconVrfy.mq_montymul(n13, s);
                }
                ++n8;
                n9 += n7;
            }
        ...
        int n14 = 4091;
        for (n5 = n3; n5 > 1; n5 >>= 1) {
            n14 = FalconVrfy.mq_rshift1(n14);
        }
        for (n5 = 0; n5 < n3; ++n5) {
            sArray[n + n5] = (short)FalconVrfy.mq_montymul(sArray[n + n5], n14);
        }
    }

    static void mq_poly_tomonty(short[] sArray, int n, int n2) {
        int n3 = 1 << n2;
        for (int i = 0; i < n3; ++i) {
            sArray[n + i] = (short)FalconVrfy.mq_montymul(sArray[n + i], 10952);
        }
    }

    static void mq_poly_montymul_ntt(short[] sArray, int n, short[] sArray2, int n2, int n3) {
        int n4 = 1 << n3;
        for (int i = 0; i < n4; ++i) {
            sArray[n + i] = (short)FalconVrfy.mq_montymul(sArray[n + i], sArray2[n2 + i]);
        }
    }

    static void mq_poly_sub(short[] sArray, int n, short[] sArray2, int n2) {
        int n3 = 1 << n2;
        for (int i = 0; i < n3; ++i) {
            sArray[n + i] = (short)FalconVrfy.mq_sub(sArray[n + i], sArray2[i]);
        }
    }

    static void to_ntt_monty(short[] sArray, int n) {
        FalconVrfy.mq_NTT(sArray, 0, n);
        FalconVrfy.mq_poly_tomonty(sArray, 0, n);
    }

    static int verify_raw(short[] sArray, short[] sArray2, short[] sArray3, int n, short[] sArray4) {
        int n2;
        int n3;
        int n4 = 1 << n;
        int n5 = 0;
        for (n3 = 0; n3 < n4; ++n3) {
            n2 = sArray2[n3];
            n2 += 0x3001 & -(n2 >>> 31);
            sArray4[n5 + n3] = (short)n2;
        }
        FalconVrfy.mq_NTT(sArray4, n5, n);
        FalconVrfy.mq_poly_montymul_ntt(sArray4, n5, sArray3, 0, n);
        FalconVrfy.mq_iNTT(sArray4, n5, n);
        FalconVrfy.mq_poly_sub(sArray4, n5, sArray, n);
        for (n3 = 0; n3 < n4; ++n3) {
            n2 = sArray4[n5 + n3] & 0xFFFF;
            n2 -= 0x3001 & -(6144 - n2 >>> 31);
            sArray4[n5 + n3] = (short)n2;
        }
        return FalconCommon.is_short(sArray4, n5, sArray2, n);
    }

    static int compute_public(short[] sArray, int n, byte[] byArray, byte[] byArray2, int n2, short[] sArray2, int n3) {
        int n4;
        int n5 = 1 << n2;
        int n6 = n3;
        for (n4 = 0; n4 < n5; ++n4) {
            sArray2[n6 + n4] = (short)FalconVrfy.mq_conv_small(byArray[n4]);
            sArray[n + n4] = (short)FalconVrfy.mq_conv_small(byArray2[n4]);
        }
        FalconVrfy.mq_NTT(sArray, n, n2);
        FalconVrfy.mq_NTT(sArray2, n6, n2);
        for (n4 = 0; n4 < n5; ++n4) {
            if (sArray2[n6 + n4] == 0) {
                return 0;
            }
            sArray[n + n4] = (short)FalconVrfy.mq_div_12289(sArray[n + n4], sArray2[n6 + n4]);
        }
        FalconVrfy.mq_iNTT(sArray, n, n2);
        return 1;
    }

    static boolean complete_private(byte[] byArray, byte[] byArray2, byte[] byArray3, byte[] byArray4, int n, short[] sArray) {
        int n2;
        int n3;
        int n4 = -1;
        int n5 = 1 << n;
        ...
        int n7 = n6 + n5;
        for (n3 = 0; n3 < n5; ++n3) {
            sArray[n6 + n3] = (short)FalconVrfy.mq_conv_small(byArray3[n3]);
            sArray[n7 + n3] = (short)FalconVrfy.mq_conv_small(byArray4[n3]);
        }
        FalconVrfy.mq_NTT(sArray, n6, n);
        FalconVrfy.mq_NTT(sArray, n7, n);
        FalconVrfy.mq_poly_tomonty(sArray, n6, n);
        FalconVrfy.mq_poly_montymul_ntt(sArray, n6, sArray, n7, n);
        for (n3 = 0; n3 < n5; ++n3) {
            sArray[n7 + n3] = (short)FalconVrfy.mq_conv_small(byArray2[n3]);
        }
        FalconVrfy.mq_NTT(sArray, n7, n);
        for (n3 = 0; n3 < n5; ++n3) {
            n2 = sArray[n7 + n3] & 0xFFFF;
            n4 &= -n2;
            sArray[n6 + n3] = (short)FalconVrfy.mq_div_12289(sArray[n6 + n3], sArray[n7 + n3]);
        }
        FalconVrfy.mq_iNTT(sArray, n6, n);
        for (n3 = 0; n3 < n5; ++n3) {
            n2 = sArray[n6 + n3] & 0xFFFF;
            int n8 = n2 - (0x3001 & 6144 - n2 >> 31);
            n4 &= n8 - 128;
            n4 &= -n8 - 128;
            byArray[n3] = (byte)n8;
        }
