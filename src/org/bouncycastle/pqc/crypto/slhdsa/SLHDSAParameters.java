...
public class SLHDSAParameters {
    ...
    private SLHDSAParameters(String string, SLHDSAEngineProvider sLHDSAEngineProvider, int n) {
        this.name = string;
        this.engineProvider = sLHDSAEngineProvider;
        this.preHashDigest = n;
    }
    ...
    implements SLHDSAEngineProvider {
        ...
        public Sha2EngineProvider(int n, int n2, int n3, int n4, int n5, int n6) {
            this.n = n;
            this.w = n2;
            this.d = n3;
            this.a = n4;
    ...
    implements SLHDSAEngineProvider {
        ...
        public Shake256EngineProvider(int n, int n2, int n3, int n4, int n5, int n6) {
            this.n = n;
            this.w = n2;
            this.d = n3;
            this.a = n4;
