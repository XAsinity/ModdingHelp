...
implements PBE {
    ...
    protected BaseBlockCipher(int n, BlockCipherProvider blockCipherProvider) {
        this.baseEngine = blockCipherProvider.get();
        this.engineProvider = blockCipherProvider;
    ...
    protected BaseBlockCipher(int n, AEADBlockCipher aEADBlockCipher) {
        this.keySizeInBits = n;
    ...
    protected BaseBlockCipher(AEADBlockCipher aEADBlockCipher, boolean bl, int n) {
        this(0, aEADBlockCipher, bl, n);
    }

    protected BaseBlockCipher(int n, AEADBlockCipher aEADBlockCipher, boolean bl, int n2) {
        this.keySizeInBits = n;
        this.baseEngine = aEADBlockCipher.getUnderlyingCipher();
        this.fixedIv = bl;
        this.ivLength = n2;
    ...
    protected BaseBlockCipher(int n, BlockCipher blockCipher, int n2) {
        this.keySizeInBits = n;
        this.baseEngine = blockCipher;
        this.fixedIv = true;
        this.cipher = new BufferedGenericBlockCipher(blockCipher);
    ...
    protected BaseBlockCipher(int n, BufferedBlockCipher bufferedBlockCipher, int n2) {
        this.keySizeInBits = n;
    ...
    protected void engineSetMode(String string) throws NoSuchAlgorithmException {
        ...
        if (this.modeName.equals("ECB")) {
            ...
            if (this.modeName.length() != 3) {
                int n = Integer.parseInt(this.modeName.substring(3));
                this.cipher = new BufferedGenericBlockCipher(CFBBlockCipher.newInstance(this.baseEngine, n));
                return;
            } else {
    ...
    protected void engineInit(int n, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        object4 = algorithmParameterSpec;
        if (algorithmParameterSpec instanceof PBEParameterSpec && (object4 = ((PBEParameterSpec)algorithmParameterSpec).getParameterSpec()) instanceof IvParameterSpec && ((IvParameterSpec)object4).getIV().length == 0) {
            object4 = algorithmParameterSpec;
        }
