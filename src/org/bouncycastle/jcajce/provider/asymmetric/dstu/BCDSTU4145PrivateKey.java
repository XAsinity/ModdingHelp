        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            if (((ASN1Sequence)aSN1Encodable).getObjectAt(0) instanceof ASN1Integer) {
                ...
                if (((DSTU4145Params)aSN1Object).isNamedCurve()) {
                    ...
                    ECCurve.F2m f2m = new ECCurve.F2m(dSTU4145BinaryField.getM(), dSTU4145BinaryField.getK1(), dSTU4145BinaryField.getK2(), dSTU4145BinaryField.getK3(), ((DSTU4145ECBinary)object).getA(), new BigInteger(1, byArray), null, null);
