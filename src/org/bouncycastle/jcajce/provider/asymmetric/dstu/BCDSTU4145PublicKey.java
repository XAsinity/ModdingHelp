    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
            ...
            if (this.dstuParams.isNamedCurve()) {
                ...
                object = new ECCurve.F2m(((DSTU4145BinaryField)object2).getM(), ((DSTU4145BinaryField)object2).getK1(), ((DSTU4145BinaryField)object2).getK2(), ((DSTU4145BinaryField)object2).getK3(), ((DSTU4145ECBinary)object4).getA(), new BigInteger(1, (byte[])object3), null, null);
