...
PKCS12BagAttributeCarrier {
    ...
    public String toString() {
        ...
        stringBuilder.append("DSA Private Key [").append(DSAUtil.generateKeyFingerprint(bigInteger, this.getParams())).append("]").append(string);
        stringBuilder.append("            Y: ").append(bigInteger.toString(16)).append(string);
