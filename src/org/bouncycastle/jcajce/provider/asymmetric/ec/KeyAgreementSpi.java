...
extends BaseAgreementSpi {
    ...
    protected Key engineDoPhase(Key key, boolean bl) throws InvalidKeyException, IllegalStateException {
        ...
        try {
            ...
            throw new InvalidKeyException(this, "calculation failed: " + exception.getMessage()){
                final /* synthetic */ KeyAgreementSpi this$0;
                {
                    this.this$0 = keyAgreementSpi;
                    super(string);
                }
    ...
    protected void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (this.agreement instanceof ECMQVBasicAgreement) {
            ...
            if (key instanceof MQVPrivateKey) {
                ...
                eCPrivateKeyParameters2 = (ECPrivateKeyParameters)ECUtils.generatePrivateKeyParameter(object.getStaticPrivateKey());
                eCPrivateKeyParameters = (ECPrivateKeyParameters)ECUtils.generatePrivateKeyParameter(object.getEphemeralPrivateKey());
                ...
                eCPrivateKeyParameters2 = (ECPrivateKeyParameters)ECUtils.generatePrivateKeyParameter((PrivateKey)key);
                eCPrivateKeyParameters = (ECPrivateKeyParameters)ECUtils.generatePrivateKeyParameter(((MQVParameterSpec)object).getEphemeralPrivateKey());
                eCPublicKeyParameters = null;
            ...
            ECPrivateKeyParameters eCPrivateKeyParameters3 = (ECPrivateKeyParameters)ECUtils.generatePrivateKeyParameter(dHUParameterSpec.getEphemeralPrivateKey());
