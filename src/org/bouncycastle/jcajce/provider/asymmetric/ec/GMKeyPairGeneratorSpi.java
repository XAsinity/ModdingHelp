...
extends KeyPairGenerator {
    public GMKeyPairGeneratorSpi(String string) {
        super(string);
    }
    ...
    extends GMKeyPairGeneratorSpi {
        ...
        public BaseSM2(String string, ProviderConfiguration providerConfiguration) {
            super(string);
        ...
        public void initialize(int n, SecureRandom secureRandom) {
            ...
            ECNamedCurveGenParameterSpec eCNamedCurveGenParameterSpec = (ECNamedCurveGenParameterSpec)ecParameters.get(Integers.valueOf(n));
            if (eCNamedCurveGenParameterSpec == null) {
                throw new InvalidParameterException("unknown key size.");
            }
            try {
                this.initialize(eCNamedCurveGenParameterSpec, secureRandom);
            }
