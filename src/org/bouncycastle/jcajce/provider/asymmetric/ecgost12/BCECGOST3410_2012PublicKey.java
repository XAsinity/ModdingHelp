...
ECPointEncoder {
    ...
    public byte[] getEncoded() {
        ...
        if (aSN1Object == null) {
            ...
            if (this.ecSpec instanceof ECNamedCurveSpec) {
                object = ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec)this.ecSpec).getName());
                aSN1Object = bl ? new GOST3410PublicKeyAlgParameters((ASN1ObjectIdentifier)object, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512) : (((ASN1Primitive)object).equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetB) || ((ASN1Primitive)object).equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetC) || ((ASN1Primitive)object).equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetD) ? new GOST3410PublicKeyAlgParameters((ASN1ObjectIdentifier)object, null) : new GOST3410PublicKeyAlgParameters((ASN1ObjectIdentifier)object, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256));
            } else {
    ...
    public GOST3410PublicKeyAlgParameters getGostParams() {
        if (this.gostParams == null && this.ecSpec instanceof ECNamedCurveSpec) {
            ...
            this.gostParams = bl ? new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512) : (aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetB) || aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetC) || aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetD) ? new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier, null) : new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256));
        }
