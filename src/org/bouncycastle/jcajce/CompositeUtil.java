...
class CompositeUtil {
    ...
    static ASN1ObjectIdentifier getOid(String string) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = algorithmOids.get(Strings.toUpperCase(string));
        if (aSN1ObjectIdentifier == null) {
            throw new IllegalArgumentException("name " + string + " not recognized");
        }
