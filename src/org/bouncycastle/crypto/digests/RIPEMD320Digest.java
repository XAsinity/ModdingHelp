...
extends GeneralDigest {
    ...
    protected void processWord(byte[] byArray, int n) {
        this.X[this.xOff++] = Pack.littleEndianToInt(byArray, n);
        if (this.xOff == 16) {
            this.processBlock();
        }
    }
    ...
    public int doFinal(byte[] byArray, int n) {
        this.finish();
        Pack.intToLittleEndian(this.H0, byArray, n);
        Pack.intToLittleEndian(this.H1, byArray, n + 4);
        Pack.intToLittleEndian(this.H2, byArray, n + 8);
        Pack.intToLittleEndian(this.H3, byArray, n + 12);
        Pack.intToLittleEndian(this.H4, byArray, n + 16);
        Pack.intToLittleEndian(this.H5, byArray, n + 20);
        Pack.intToLittleEndian(this.H6, byArray, n + 24);
        Pack.intToLittleEndian(this.H7, byArray, n + 28);
        Pack.intToLittleEndian(this.H8, byArray, n + 32);
        Pack.intToLittleEndian(this.H9, byArray, n + 36);
        this.reset();
        return 40;
    }
