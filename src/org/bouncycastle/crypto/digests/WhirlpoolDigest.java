...
Memoable {
    ...
    public WhirlpoolDigest(CryptoServicePurpose cryptoServicePurpose) {
        ...
        for (int i = 1; i <= 10; ++i) {
            int n = 8 * (i - 1);
            this._rc[i] = C0[n] & 0xFF00000000000000L ^ C1[n + 1] & 0xFF000000000000L ^ C2[n + 2] & 0xFF0000000000L ^ C3[n + 3] & 0xFF00000000L ^ C4[n + 4] & 0xFF000000L ^ C5[n + 5] & 0xFF0000L ^ C6[n + 6] & 0xFF00L ^ C7[n + 7] & 0xFFL;
        }
    ...
    static {
        ...
        for (int i = 0; i < 256; ++i) {
            int n = SBOX[i];
            int n2 = WhirlpoolDigest.mulX(n);
            int n3 = WhirlpoolDigest.mulX(n2);
            int n4 = n3 ^ n;
            int n5 = WhirlpoolDigest.mulX(n3);
            int n6 = n5 ^ n;
            WhirlpoolDigest.C0[i] = WhirlpoolDigest.packIntoLong(n, n, n3, n, n5, n4, n2, n6);
            WhirlpoolDigest.C1[i] = WhirlpoolDigest.packIntoLong(n6, n, n, n3, n, n5, n4, n2);
            WhirlpoolDigest.C2[i] = WhirlpoolDigest.packIntoLong(n2, n6, n, n, n3, n, n5, n4);
            WhirlpoolDigest.C3[i] = WhirlpoolDigest.packIntoLong(n4, n2, n6, n, n, n3, n, n5);
            WhirlpoolDigest.C4[i] = WhirlpoolDigest.packIntoLong(n5, n4, n2, n6, n, n, n3, n);
            WhirlpoolDigest.C5[i] = WhirlpoolDigest.packIntoLong(n, n5, n4, n2, n6, n, n, n3);
            WhirlpoolDigest.C6[i] = WhirlpoolDigest.packIntoLong(n3, n, n5, n4, n2, n6, n, n);
            WhirlpoolDigest.C7[i] = WhirlpoolDigest.packIntoLong(n, n3, n, n5, n4, n2, n6, n);
        }
    }
}
