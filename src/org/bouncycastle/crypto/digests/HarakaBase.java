...
implements Digest {
    ...
    static byte mulX(byte by) {
        return (byte)((by & 0x7F) << 1 ^ ((by & 0x80) >> 7) * 27);
    }
    ...
    private static byte[] mixColumns(byte[] byArray) {
        ...
        int n = 0;
        for (int i = 0; i < 4; ++i) {
            byArray2[n++] = (byte)(HarakaBase.mulX(byArray[4 * i]) ^ HarakaBase.mulX(byArray[4 * i + 1]) ^ byArray[4 * i + 1] ^ byArray[4 * i + 2] ^ byArray[4 * i + 3]);
            byArray2[n++] = (byte)(byArray[4 * i] ^ HarakaBase.mulX(byArray[4 * i + 1]) ^ HarakaBase.mulX(byArray[4 * i + 2]) ^ byArray[4 * i + 2] ^ byArray[4 * i + 3]);
            byArray2[n++] = (byte)(byArray[4 * i] ^ byArray[4 * i + 1] ^ HarakaBase.mulX(byArray[4 * i + 2]) ^ HarakaBase.mulX(byArray[4 * i + 3]) ^ byArray[4 * i + 3]);
            byArray2[n++] = (byte)(HarakaBase.mulX(byArray[4 * i]) ^ byArray[4 * i] ^ byArray[4 * i + 1] ^ byArray[4 * i + 2] ^ HarakaBase.mulX(byArray[4 * i + 3]));
        }
        return byArray2;
    }
