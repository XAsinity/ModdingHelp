...
implements ExtendedDigest {
    ...
    public Blake2bDigest(int n, CryptoServicePurpose cryptoServicePurpose) {
    ...
    public Blake2bDigest(byte[] byArray, int n, byte[] byArray2, byte[] byArray3, CryptoServicePurpose cryptoServicePurpose) {
        this.purpose = cryptoServicePurpose;
        this.buffer = new byte[128];
        if (n < 1 || n > 64) {
    ...
    public int doFinal(byte[] byArray, int n) {
        ...
        int n2 = this.digestLength >>> 3;
        int n3 = this.digestLength & 7;
        Pack.longToLittleEndian(this.chainValue, 0, n2, byArray, n);
        if (n3 > 0) {
            byte[] byArray2 = new byte[8];
            Pack.longToLittleEndian(this.chainValue[n2], byArray2, 0);
    ...
    private void compress(byte[] byArray, int n) {
        ...
        Pack.littleEndianToLong(byArray, n, lArray);
