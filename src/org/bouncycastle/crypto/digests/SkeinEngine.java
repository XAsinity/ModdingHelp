...
implements Memoable {
    ...
    private void output(long l, byte[] byArray, int n, int n2) {
        ...
        Pack.longToLittleEndian(l, byArray2, 0);
        ...
        for (int i = 0; i < n3; ++i) {
            ...
            if (n4 == 8) {
                Pack.longToLittleEndian(lArray[i], byArray, n + i * 8);
                continue;
            }
            Pack.longToLittleEndian(lArray[i], byArray2, 0);
    ...
    private static class Configuration {
        ...
        public Configuration(long l) {
            ...
            this.bytes[4] = 1;
            this.bytes[5] = 0;
            Pack.longToLittleEndian(l, this.bytes, 8);
        }
    ...
    private class UBI {
        ...
        private void processBlock(long[] lArray) {
            ...
            for (int i = 0; i < lArray.length; ++i) {
                int n = i;
                lArray[n] = lArray[n] ^ this.message[i];
            }
        }
