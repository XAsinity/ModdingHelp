...
public abstract class GCMUtil {
    ...
    static void multiply(byte[] byArray, long[] lArray) {
        ...
        long l2 = Pack.bigEndianToLong(byArray, 8);
        long l3 = lArray[0];
        long l4 = lArray[1];
        ...
        Pack.longToBigEndian(l15 ^= (l17 ^= l18 << 62 ^ l18 << 57) ^ l17 >>> 1 ^ l17 >>> 2 ^ l17 >>> 7, byArray, 0);
        Pack.longToBigEndian(l16 ^= l17 << 63 ^ l17 << 62 ^ l17 << 57, byArray, 8);
    }
