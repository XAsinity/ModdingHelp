...
public final class CryptoServicesRegistrar {
    ...
    public static void setServicesConstraints(CryptoServicesConstraints cryptoServicesConstraints) {
        CryptoServicesConstraints cryptoServicesConstraints2;
        CryptoServicesRegistrar.checkPermission(CanSetConstraints);
        CryptoServicesConstraints cryptoServicesConstraints3 = cryptoServicesConstraints2 = cryptoServicesConstraints == null ? noConstraintsImpl : cryptoServicesConstraints;
        if (preconfiguredConstraints) {
            if (Properties.isOverrideSet("org.bouncycastle.constraints.allow_override")) {
                servicesConstraints.set(cryptoServicesConstraints2);
            } else {
