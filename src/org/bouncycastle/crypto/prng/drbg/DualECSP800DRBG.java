...
implements SP80090DRBG {
    ...
    private static final DualECPoints[] nistPoints = new DualECPoints[]{DualECSP800DRBG.createDualECPoints("P-256", 128, p256_Px, p256_Py, p256_Qx, p256_Qy, 1), DualECSP800DRBG.createDualECPoints("P-384", 192, p384_Px, p384_Py, p384_Qx, p384_Qy, 1), DualECSP800DRBG.createDualECPoints("P-521", 256, p521_Px, p521_Py, p521_Qx, p521_Qy, 1)};
    ...
    private static DualECPoints createDualECPoints(String string, int n, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, int n2) {
        ECCurve.AbstractFp abstractFp = (ECCurve.AbstractFp)CustomNamedCurves.getByNameLazy(string).getCurve();
        return new DualECPoints(n, abstractFp.createPoint(bigInteger, bigInteger2), abstractFp.createPoint(bigInteger3, bigInteger4), n2);
    }
    ...
    public int generate(byte[] byArray, byte[] byArray2, boolean bl) {
        ...
        if (n3 < byArray.length) {
            ...
            if (byArray4.length >= this._outlen) {
                ...
                int n5 = this._outlen - byArray4.length;
                if (n5 < n4) {
                    System.arraycopy(byArray4, 0, byArray, n3 + n5, n4 - n5);
                }
            }
            ++this._reseedCounter;
        }
