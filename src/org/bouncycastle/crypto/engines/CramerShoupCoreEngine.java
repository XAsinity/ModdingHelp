...
public class CramerShoupCoreEngine {
    ...
    public void init(boolean bl, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties("CramerShoup", ConstraintUtils.bitsOfSecurityFor(this.key.getParameters().getP()), this.key, Utils.getPurpose(bl)));
    }
