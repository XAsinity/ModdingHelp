...
implements AsymmetricBlockCipher {
    ...
    public void init(boolean bl, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties("RSA", ConstraintUtils.bitsOfSecurityFor(this.key.getParameters().getP()), this.key, Utils.getPurpose(bl)));
    }
