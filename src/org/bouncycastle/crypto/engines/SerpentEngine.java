...
extends SerpentEngineBase {
    ...
    protected void encryptBlock(byte[] byArray, int n, byte[] byArray2, int n2) {
        int[] nArray = new int[]{Pack.littleEndianToInt(byArray, n), Pack.littleEndianToInt(byArray, n + 4), Pack.littleEndianToInt(byArray, n + 8), Pack.littleEndianToInt(byArray, n + 12)};
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ nArray[0], byArray2, n2);
        Pack.intToLittleEndian(this.wKey[129] ^ nArray[1], byArray2, n2 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ nArray[2], byArray2, n2 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ nArray[3], byArray2, n2 + 12);
    }

    @Override
    protected void decryptBlock(byte[] byArray, int n, byte[] byArray2, int n2) {
        int[] nArray = new int[]{this.wKey[128] ^ Pack.littleEndianToInt(byArray, n), this.wKey[129] ^ Pack.littleEndianToInt(byArray, n + 4), this.wKey[130] ^ Pack.littleEndianToInt(byArray, n + 8), this.wKey[131] ^ Pack.littleEndianToInt(byArray, n + 12)};
        ...
        this.inverseLT(nArray);
        this.ib0(nArray, nArray[0], nArray[1], nArray[2], nArray[3]);
        Pack.intToLittleEndian(nArray[0] ^ this.wKey[0], byArray2, n2);
        Pack.intToLittleEndian(nArray[1] ^ this.wKey[1], byArray2, n2 + 4);
        Pack.intToLittleEndian(nArray[2] ^ this.wKey[2], byArray2, n2 + 8);
        Pack.intToLittleEndian(nArray[3] ^ this.wKey[3], byArray2, n2 + 12);
    }
}
