...
implements BlockCipher {
    ...
    public void init(boolean bl, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), n < 256 ? n : 256, cipherParameters, Utils.getPurpose(this.forEncryption)));
    }
