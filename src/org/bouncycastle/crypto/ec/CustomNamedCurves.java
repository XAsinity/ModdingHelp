...
public class CustomNamedCurves {
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return CustomNamedCurves.configureCurveGLV(new SecP160K1Curve(), gLVTypeBParameters);
        }
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return CustomNamedCurves.configureCurveGLV(new SecP192K1Curve(), gLVTypeBParameters);
        }
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return CustomNamedCurves.configureCurveGLV(new SecP224K1Curve(), gLVTypeBParameters);
        }
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder(){
        ...
        protected ECCurve createCurve() {
            ...
            return CustomNamedCurves.configureCurveGLV(new SecP256K1Curve(), gLVTypeBParameters);
        }
    ...
    public static X9ECParametersHolder getByNameLazy(String string) {
        return (X9ECParametersHolder)nameToCurve.get(Strings.toLowerCase(string));
    }
