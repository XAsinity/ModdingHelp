...
implements Signer {
    ...
    public static PSSSigner createRawSigner(AsymmetricBlockCipher asymmetricBlockCipher, Digest digest, Digest digest2, int n, byte by) {
        return new PSSSigner(asymmetricBlockCipher, (Digest)Prehash.forDigest(digest), digest, digest2, n, by);
    }
    ...
    public PSSSigner(AsymmetricBlockCipher asymmetricBlockCipher, Digest digest, Digest digest2, int n, byte by) {
        this(asymmetricBlockCipher, digest, digest, digest2, n, by);
    }

    private PSSSigner(AsymmetricBlockCipher asymmetricBlockCipher, Digest digest, Digest digest2, Digest digest3, int n, byte by) {
    ...
    public void update(byte[] byArray, int n, int n2) {
        this.contentDigest1.update(byArray, n, n2);
    }
