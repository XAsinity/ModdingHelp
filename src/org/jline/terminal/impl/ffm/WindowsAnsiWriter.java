...
extends AnsiWriter {
    ...
    protected void processEraseScreen(int eraseOption) throws IOException {
        ...
        try (Arena arena = Arena.ofConfined();){
            MemorySegment written = arena.allocate((MemoryLayout)ValueLayout.JAVA_INT);
            switch (eraseOption) {
                case 2: {
                    Kernel32.COORD topLeft = new Kernel32.COORD(arena, 0, this.info.window().top());
                ...
                case 1: {
                    Kernel32.COORD topLeft2 = new Kernel32.COORD(arena, 0, this.info.window().top());
    ...
    protected void processEraseLine(int eraseOption) throws IOException {
        ...
        try (Arena arena = Arena.ofConfined();){
            ...
            switch (eraseOption) {
                case 2: {
                    Kernel32.COORD leftColCurrRow = new Kernel32.COORD(arena, 0, this.info.cursorPosition().y());
                ...
                case 1: {
                    Kernel32.COORD leftColCurrRow2 = new Kernel32.COORD(arena, 0, this.info.cursorPosition().y());
    ...
    protected void processSetForegroundColorExt(int paletteIndex) throws IOException {
        ...
        this.info.attributes((short)(this.info.attributes() & 0xFFFFFFF8 | ANSI_FOREGROUND_COLOR_MAP[color & 7]));
    ...
    protected void processSetBackgroundColorExt(int paletteIndex) throws IOException {
        int color = Colors.roundColor(paletteIndex, 16);
        this.info.attributes((short)(this.info.attributes() & 0xFFFFFF8F | ANSI_BACKGROUND_COLOR_MAP[color & 7]));
    ...
    protected void processInsertLine(int optionInt) throws IOException {
        try (Arena arena = Arena.ofConfined();){
            ...
            Kernel32.COORD org = new Kernel32.COORD(arena, 0, (short)(this.info.cursorPosition().y() + optionInt));
            Kernel32.CHAR_INFO info = new Kernel32.CHAR_INFO(arena, ' ', this.originalColors);
