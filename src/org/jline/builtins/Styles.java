...
public class Styles {
    ...
    public static boolean isStylePattern(String style) {
        ...
        return Arrays.stream(styleElements).allMatch(element -> element.isEmpty() || STYLE_ELEMENT_PATTERN.matcher((CharSequence)element).matches());
    }
    ...
    private static String consoleOption(String name) {
        String out = null;
        ConsoleOptionGetter cog = Styles.optionGetter();
        if (cog != null && (out = (String)cog.consoleOption(name)) != null && !Styles.isStylePattern(out)) {
            out = null;
        }
        if (out == null && (out = System.getenv(name)) != null && !Styles.isStylePattern(out)) {
            out = null;
        }
        return out;
    }
    ...
    public static class StyleCompiler {
        ...
        public String getStyle(String reference) {
            ...
            } else if (!this.nanoStyle && rawStyle.matches(ANSI_VALUE)) {
                return rawStyle;
            }
