    ...
    public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>(){
                ...
                {
                    this.comparator = Int2CharRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2CharRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
