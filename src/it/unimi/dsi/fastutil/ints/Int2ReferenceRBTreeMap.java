...
Cloneable {
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Int2ReferenceRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2ReferenceRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
    ...
    public Int2ReferenceRBTreeMap<V> clone() {
        ...
        try {
            c = (Int2ReferenceRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2ReferenceRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(int k, V v) {
            ...
            Object oldValue = Int2ReferenceRBTreeMap.this.put(k, v);
