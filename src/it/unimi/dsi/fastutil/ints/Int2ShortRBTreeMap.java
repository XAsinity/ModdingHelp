    ...
    public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Int2ShortRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2ShortRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
