...
Cloneable {
    ...
    public Int2ByteAVLTreeMap(SortedMap<Integer, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Integer, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Int2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2ByteAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
