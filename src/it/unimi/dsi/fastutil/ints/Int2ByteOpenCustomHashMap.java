...
Hash {
    ...
    implements Int2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2ByteMap.Entry> consumer) {
            if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2ByteOpenCustomHashMap.this.n));
            }
            int pos = Int2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ByteOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2ByteMap.Entry> consumer) {
            ...
            if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.index = Int2ByteOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2ByteOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2ByteOpenCustomHashMap.this.n);
                return true;
            }
            int[] key = Int2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2ByteOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2ByteOpenCustomHashMap.this.size - this.c), (long)((double)Int2ByteOpenCustomHashMap.this.realSize() / (double)Int2ByteOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
