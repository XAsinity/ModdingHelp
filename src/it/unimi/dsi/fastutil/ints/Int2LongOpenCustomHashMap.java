...
Hash {
    ...
    implements Int2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
            if (Int2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2LongOpenCustomHashMap.this.n));
            }
            int pos = Int2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2LongOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2LongOpenCustomHashMap.this.size - this.c), (long)((double)Int2LongOpenCustomHashMap.this.realSize() / (double)Int2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
