...
Hash {
    ...
    implements Int2ShortMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2ShortMap.Entry> consumer) {
            if (Int2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2ShortOpenHashMap.this.n));
            }
            int pos = Int2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ShortOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2ShortMap.Entry> consumer) {
            ...
            if (Int2ShortOpenHashMap.this.containsNullKey) {
                entry.index = Int2ShortOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2ShortOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2ShortOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2ShortOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2ShortOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2ShortOpenHashMap.this.size - this.c), (long)((double)Int2ShortOpenHashMap.this.realSize() / (double)Int2ShortOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
