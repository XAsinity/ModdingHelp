...
Cloneable {
    ...
    public Int2CharAVLTreeMap(SortedMap<Integer, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Integer, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>(){
                ...
                {
                    this.comparator = Int2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2CharAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
