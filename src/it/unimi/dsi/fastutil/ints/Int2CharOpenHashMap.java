...
Hash {
    ...
    implements Int2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2CharOpenHashMap.this.n));
            }
            int pos = Int2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2CharMap.Entry> consumer) {
            ...
            if (Int2CharOpenHashMap.this.containsNullKey) {
                entry.index = Int2CharOpenHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Int2CharMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2CharOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2CharOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2CharOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2CharOpenHashMap.this.size - this.c), (long)((double)Int2CharOpenHashMap.this.realSize() / (double)Int2CharOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
