...
Hash {
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            if (Int2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2FloatOpenHashMap.this.n));
            }
            int pos = Int2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2FloatOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            ...
            if (Int2FloatOpenHashMap.this.containsNullKey) {
                entry.index = Int2FloatOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2FloatOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2FloatOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2FloatOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2FloatOpenHashMap.this.size - this.c), (long)((double)Int2FloatOpenHashMap.this.realSize() / (double)Int2FloatOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
