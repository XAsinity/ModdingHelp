...
Hash {
    ...
    implements Int2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2CharOpenCustomHashMap.this.n));
            }
            int pos = Int2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2CharOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2CharOpenCustomHashMap.this.size - this.c), (long)((double)Int2CharOpenCustomHashMap.this.realSize() / (double)Int2CharOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
