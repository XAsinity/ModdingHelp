...
Cloneable {
    ...
    public Int2BooleanAVLTreeMap(SortedMap<Integer, Boolean> m) {
        this(m.comparator());
        this.putAll((Map<? extends Integer, ? extends Boolean>)m);
    }
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Int2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2BooleanAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
