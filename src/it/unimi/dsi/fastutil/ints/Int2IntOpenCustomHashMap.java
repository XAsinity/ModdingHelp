...
Hash {
    ...
    implements Int2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2IntMap.Entry> consumer) {
            if (Int2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2IntOpenCustomHashMap.this.n));
            }
            int pos = Int2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2IntOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2IntMap.Entry> consumer) {
            ...
            if (Int2IntOpenCustomHashMap.this.containsNullKey) {
                entry.index = Int2IntOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2IntOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2IntOpenCustomHashMap.this.n);
                return true;
            }
            int[] key = Int2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2IntOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2IntOpenCustomHashMap.this.size - this.c), (long)((double)Int2IntOpenCustomHashMap.this.realSize() / (double)Int2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
