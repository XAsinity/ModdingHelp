    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Int2DoubleRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2DoubleRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
