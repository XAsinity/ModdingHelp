...
Hash {
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
            if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2DoubleOpenCustomHashMap.this.n));
            }
            int pos = Int2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2DoubleOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2DoubleOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2DoubleOpenCustomHashMap.this.size - this.c), (long)((double)Int2DoubleOpenCustomHashMap.this.realSize() / (double)Int2DoubleOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
