 ...
 *  it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$EntrySet.EntrySetSpliterator
 *  it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$KeySet.KeySetSpliterator
 *  it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$ValuesCollection.ValuesSpliterator
 */
...
Cloneable {
    ...
    implements Int2ObjectMap.FastEntrySet<V> {
        ...
        implements ObjectSpliterator<Int2ObjectMap.Entry<V>> {
            ...
            protected final it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    extends AbstractIntSet {
        ...
        implements IntSpliterator {
            ...
            protected final it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    extends AbstractObjectCollection<V> {
        ...
        implements ObjectSpliterator<V> {
            ...
            protected final it.unimi.dsi.fastutil.ints.Int2ObjectArrayMap$ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
