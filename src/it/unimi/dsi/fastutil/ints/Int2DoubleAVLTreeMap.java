...
Cloneable {
    ...
    public Int2DoubleAVLTreeMap(SortedMap<Integer, Double> m) {
        this(m.comparator());
        this.putAll((Map<? extends Integer, ? extends Double>)m);
    }
    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Int2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2DoubleAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
