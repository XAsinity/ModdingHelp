    ...
    public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(){
                ...
                {
                    this.comparator = Int2LongRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2LongRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
