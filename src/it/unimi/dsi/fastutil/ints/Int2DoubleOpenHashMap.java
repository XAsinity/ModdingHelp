...
Hash {
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
            if (Int2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2DoubleOpenHashMap.this.n));
            }
            int pos = Int2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2DoubleOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
            ...
            if (Int2DoubleOpenHashMap.this.containsNullKey) {
                entry.index = Int2DoubleOpenHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Int2DoubleMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2DoubleOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2DoubleOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2DoubleOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2DoubleOpenHashMap.this.size - this.c), (long)((double)Int2DoubleOpenHashMap.this.realSize() / (double)Int2DoubleOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
