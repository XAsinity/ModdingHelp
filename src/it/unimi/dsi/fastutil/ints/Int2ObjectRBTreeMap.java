...
Cloneable {
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Int2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2ObjectRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
    ...
    implements Serializable {
        ...
        public V get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(int k, V v) {
            ...
            Object oldValue = Int2ObjectRBTreeMap.this.put(k, v);
            return Int2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public V remove(int k) {
            ...
            return Int2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
        }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
