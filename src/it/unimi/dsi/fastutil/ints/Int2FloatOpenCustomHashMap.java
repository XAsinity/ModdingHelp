...
Hash {
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2FloatOpenCustomHashMap.this.n));
            }
            int pos = Int2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2FloatOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            ...
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.index = Int2FloatOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Int2FloatMap.Entry>>
    ...
    implements FloatSpliterator {
        ...
        final void acceptOnIndex(FloatConsumer action, int index) {
            action.accept(Int2FloatOpenCustomHashMap.this.value[index]);
        }
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index) {
            action.accept(Int2FloatOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Int2FloatMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2FloatOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Int2FloatOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2FloatOpenCustomHashMap.this.n);
                return true;
            }
            int[] key = Int2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2FloatOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2FloatOpenCustomHashMap.this.size - this.c), (long)((double)Int2FloatOpenCustomHashMap.this.realSize() / (double)Int2FloatOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
