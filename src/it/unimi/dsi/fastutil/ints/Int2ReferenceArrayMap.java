 ...
 *  it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$EntrySet.EntrySetSpliterator
 *  it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$KeySet.KeySetSpliterator
 *  it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$ValuesCollection.ValuesSpliterator
 */
...
Cloneable {
    ...
    public Int2ReferenceArrayMap(Int2ReferenceMap<V> m) {
        this(m.size());
        int i = 0;
        for (Int2ReferenceMap.Entry entry : m.int2ReferenceEntrySet()) {
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Int2ReferenceMap.Entry<V>>(){
                ...
                public void forEachRemaining(Consumer<? super Int2ReferenceMap.Entry<V>> action) {
                    ...
                    while (this.next < max) {
                        this.curr = this.next;
                        action.accept(new AbstractInt2ReferenceMap.BasicEntry<Object>(Int2ReferenceArrayMap.this.key[this.curr], Int2ReferenceArrayMap.this.value[this.next++]));
                    }
                }
            };
        }
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> action) {
            int max = Int2ReferenceArrayMap.this.size;
            for (int i = 0; i < max; ++i) {
                action.accept(new AbstractInt2ReferenceMap.BasicEntry<Object>(Int2ReferenceArrayMap.this.key[i], Int2ReferenceArrayMap.this.value[i]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> action) {
            ...
            for (int i = 0; i < max; ++i) {
                ...
                entry.value = Int2ReferenceArrayMap.this.value[i];
                action.accept(entry);
            }
        }
        ...
        implements ObjectSpliterator<Int2ReferenceMap.Entry<V>> {
            ...
            protected final Int2ReferenceMap.Entry<V> get(int location) {
                return new AbstractInt2ReferenceMap.BasicEntry<Object>(Int2ReferenceArrayMap.this.key[location], Int2ReferenceArrayMap.this.value[location]);
            }

            protected final it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    extends AbstractIntSet {
        ...
        implements IntSpliterator {
            ...
            protected final it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    extends AbstractReferenceCollection<V> {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    int max = Int2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
                        action.accept(Int2ReferenceArrayMap.this.value[this.pos++]);
                    }
                }
            };
        }
        ...
        implements ObjectSpliterator<V> {
            ...
            protected final V get(int location) {
                return Int2ReferenceArrayMap.this.value[location];
            }

            protected final it.unimi.dsi.fastutil.ints.Int2ReferenceArrayMap$ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
