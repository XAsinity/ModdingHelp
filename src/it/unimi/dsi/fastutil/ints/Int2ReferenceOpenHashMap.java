...
Hash {
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2ReferenceOpenHashMap.this.n));
            }
            int pos = Int2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Int2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Int2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Int2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index) {
            action.accept(Int2ReferenceOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2ReferenceOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2ReferenceOpenHashMap.this.n);
                return true;
            }
            int[] key = Int2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2ReferenceOpenHashMap.this.size - this.c), (long)((double)Int2ReferenceOpenHashMap.this.realSize() / (double)Int2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
