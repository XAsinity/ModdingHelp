...
Hash {
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Int2ObjectOpenCustomHashMap.this.value[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2ObjectOpenCustomHashMap.this.n);
                return true;
            }
            int[] key = Int2ObjectOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            ...
            return Math.min((long)(Int2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Int2ObjectOpenCustomHashMap.this.realSize() / (double)Int2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
