...
Hash {
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2ReferenceOpenCustomHashMap.this.n));
            }
            int pos = Int2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                entry.index = Int2ReferenceOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Int2ReferenceOpenCustomHashMap.this.value[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Int2ReferenceMap.Entry<V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Int2ReferenceOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Int2ReferenceOpenCustomHashMap.this.n);
                return true;
            }
            int[] key = Int2ReferenceOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2ReferenceOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2ReferenceOpenCustomHashMap.this.size - this.c), (long)((double)Int2ReferenceOpenCustomHashMap.this.realSize() / (double)Int2ReferenceOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
