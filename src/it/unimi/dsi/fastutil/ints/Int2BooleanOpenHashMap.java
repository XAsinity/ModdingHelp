...
Hash {
    ...
    implements Int2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Int2BooleanOpenHashMap.this.n));
            }
            int pos = Int2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanOpenHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Int2BooleanOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Int2BooleanOpenHashMap.this.size - this.c), (long)((double)Int2BooleanOpenHashMap.this.realSize() / (double)Int2BooleanOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
