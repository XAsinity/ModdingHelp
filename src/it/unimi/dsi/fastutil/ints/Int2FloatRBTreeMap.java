    ...
    public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Int2FloatRBTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2FloatRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
