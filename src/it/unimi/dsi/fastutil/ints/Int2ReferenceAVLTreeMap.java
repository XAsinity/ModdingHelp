...
Cloneable {
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Int2ReferenceAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2ReferenceAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
    ...
    implements Serializable {
        ...
        public V get(int k) {
            Entry e;
            int kk = k;
            return this.in(kk) && (e = Int2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(int k, V v) {
            ...
            Object oldValue = Int2ReferenceAVLTreeMap.this.put(k, v);
            return Int2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public V remove(int k) {
            ...
            return Int2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.ints.Int2ReferenceAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.ints.Int2ReferenceAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
