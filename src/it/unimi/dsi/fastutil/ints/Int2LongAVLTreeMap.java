...
Cloneable {
    ...
    public Int2LongAVLTreeMap(SortedMap<Integer, Long> m) {
        this(m.comparator());
        this.putAll((Map<? extends Integer, ? extends Long>)m);
    }
    ...
    public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(){
                ...
                {
                    this.comparator = Int2LongAVLTreeMap.this.actualComparator == null ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey()) : (x, y) -> Int2LongAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                }
