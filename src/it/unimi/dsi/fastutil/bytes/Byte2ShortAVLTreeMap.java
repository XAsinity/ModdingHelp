...
Cloneable {
    ...
    public Byte2ShortAVLTreeMap(SortedMap<Byte, Short> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Short>)m);
    }
    ...
    public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Byte2ShortAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2ShortAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
