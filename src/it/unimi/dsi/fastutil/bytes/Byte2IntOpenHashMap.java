...
Hash {
    ...
    implements Byte2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2IntOpenHashMap.this.n));
            }
            int pos = Byte2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2IntOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntOpenHashMap.this.containsNullKey) {
                entry.index = Byte2IntOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Byte2IntOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2IntOpenHashMap.this.n);
                return true;
            }
            byte[] key = Byte2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2IntOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2IntOpenHashMap.this.size - this.c), (long)((double)Byte2IntOpenHashMap.this.realSize() / (double)Byte2IntOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
