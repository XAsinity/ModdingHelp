...
Cloneable {
    ...
    public Byte2LongAVLTreeMap(SortedMap<Byte, Long> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Long>)m);
    }
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                ...
                {
                    this.comparator = Byte2LongAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2LongAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
