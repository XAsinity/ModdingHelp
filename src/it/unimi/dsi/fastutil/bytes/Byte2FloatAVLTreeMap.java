...
Cloneable {
    ...
    public Byte2FloatAVLTreeMap(SortedMap<Byte, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Byte2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2FloatAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
