...
Hash {
    ...
    implements Byte2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2ByteOpenHashMap.this.n));
            }
            int pos = Byte2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ByteOpenHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2ByteOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2ByteOpenHashMap.this.size - this.c), (long)((double)Byte2ByteOpenHashMap.this.realSize() / (double)Byte2ByteOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
