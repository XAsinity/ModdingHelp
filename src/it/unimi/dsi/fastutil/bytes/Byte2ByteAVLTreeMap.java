...
Cloneable {
    ...
    public Byte2ByteAVLTreeMap(SortedMap<Byte, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Byte2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2ByteAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
