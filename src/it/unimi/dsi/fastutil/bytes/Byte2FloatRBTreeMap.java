    ...
    public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Byte2FloatRBTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2FloatRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
