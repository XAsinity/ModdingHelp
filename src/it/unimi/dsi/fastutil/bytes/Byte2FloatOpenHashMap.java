...
Hash {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            ...
            return Math.min((long)(Byte2FloatOpenHashMap.this.size - this.c), (long)((double)Byte2FloatOpenHashMap.this.realSize() / (double)Byte2FloatOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
