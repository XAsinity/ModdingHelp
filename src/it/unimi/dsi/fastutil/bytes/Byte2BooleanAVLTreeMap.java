...
Cloneable {
    ...
    public Byte2BooleanAVLTreeMap(SortedMap<Byte, Boolean> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Boolean>)m);
    }
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Byte2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2BooleanAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
