...
Hash {
    ...
    implements Byte2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2IntOpenCustomHashMap.this.n));
            }
            int pos = Byte2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2IntOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                entry.index = Byte2IntOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Byte2IntMap.Entry>>
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index) {
            action.accept(Byte2IntOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ByteSpliterator {
        ...
        final void acceptOnIndex(ByteConsumer action, int index) {
            action.accept(Byte2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Byte2IntMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Byte2IntOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Byte2IntOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2IntOpenCustomHashMap.this.n);
                return true;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2IntOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2IntOpenCustomHashMap.this.size - this.c), (long)((double)Byte2IntOpenCustomHashMap.this.realSize() / (double)Byte2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
