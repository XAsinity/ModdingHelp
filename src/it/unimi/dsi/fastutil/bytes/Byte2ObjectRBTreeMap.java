...
Cloneable {
    ...
    public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Byte2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2ObjectRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
    ...
    public Byte2ObjectRBTreeMap<V> clone() {
        ...
        try {
            c = (Byte2ObjectRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(byte k, V v) {
            ...
            Object oldValue = Byte2ObjectRBTreeMap.this.put(k, v);
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.bytes.Byte2ObjectRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.bytes.Byte2ObjectRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
