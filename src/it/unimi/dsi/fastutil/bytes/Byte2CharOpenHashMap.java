...
Hash {
    ...
    implements Byte2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2CharMap.Entry> consumer) {
            if (Byte2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2CharOpenHashMap.this.n));
            }
            int pos = Byte2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2CharOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2CharMap.Entry> consumer) {
            ...
            if (Byte2CharOpenHashMap.this.containsNullKey) {
                entry.index = Byte2CharOpenHashMap.this.n;
    ...
    implements CharSpliterator {
        ...
        final void acceptOnIndex(CharConsumer action, int index) {
            action.accept(Byte2CharOpenHashMap.this.value[index]);
        }
    ...
    implements ByteSpliterator {
        ...
        final void acceptOnIndex(ByteConsumer action, int index) {
            action.accept(Byte2CharOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Byte2CharOpenHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Byte2CharOpenHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2CharOpenHashMap.this.n);
                return true;
            }
            byte[] key = Byte2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2CharOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2CharOpenHashMap.this.size - this.c), (long)((double)Byte2CharOpenHashMap.this.realSize() / (double)Byte2CharOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
