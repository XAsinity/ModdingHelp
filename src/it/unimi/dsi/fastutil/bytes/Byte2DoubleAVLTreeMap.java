...
Cloneable {
    ...
    public Byte2DoubleAVLTreeMap(SortedMap<Byte, Double> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Double>)m);
    }
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Byte2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2DoubleAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
