...
Cloneable {
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Byte2ReferenceAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2ReferenceAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
    ...
    public Byte2ReferenceAVLTreeMap<V> clone() {
        ...
        try {
            c = (Byte2ReferenceAVLTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(byte k) {
            Entry e;
            byte kk = k;
            return this.in(kk) && (e = Byte2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(byte k, V v) {
            ...
            Object oldValue = Byte2ReferenceAVLTreeMap.this.put(k, v);
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
