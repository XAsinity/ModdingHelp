    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Byte2DoubleRBTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2DoubleRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
