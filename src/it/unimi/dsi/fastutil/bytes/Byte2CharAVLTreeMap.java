...
Cloneable {
    ...
    public Byte2CharAVLTreeMap(SortedMap<Byte, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Byte, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(){
                ...
                {
                    this.comparator = Byte2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2CharAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
