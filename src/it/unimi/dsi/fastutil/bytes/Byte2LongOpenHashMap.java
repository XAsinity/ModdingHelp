...
Hash {
    ...
    implements Byte2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            if (Byte2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2LongOpenHashMap.this.n));
            }
            int pos = Byte2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2LongOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            ...
            if (Byte2LongOpenHashMap.this.containsNullKey) {
                entry.index = Byte2LongOpenHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Byte2LongMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Byte2LongMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2LongOpenHashMap.this.n);
                return true;
            }
            byte[] key = Byte2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2LongOpenHashMap.this.size - this.c), (long)((double)Byte2LongOpenHashMap.this.realSize() / (double)Byte2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
