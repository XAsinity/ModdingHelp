    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                ...
                {
                    this.comparator = Byte2LongRBTreeMap.this.actualComparator == null ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey()) : (x, y) -> Byte2LongRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                }
