...
Hash {
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2DoubleOpenCustomHashMap.this.n));
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2DoubleOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                entry.index = Byte2DoubleOpenCustomHashMap.this.n;
    ...
    implements DoubleSpliterator {
        ...
        final void acceptOnIndex(DoubleConsumer action, int index) {
            action.accept(Byte2DoubleOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ByteSpliterator {
        ...
        final void acceptOnIndex(ByteConsumer action, int index) {
            action.accept(Byte2DoubleOpenCustomHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Byte2DoubleOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Byte2DoubleOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2DoubleOpenCustomHashMap.this.n);
                return true;
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2DoubleOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2DoubleOpenCustomHashMap.this.size - this.c), (long)((double)Byte2DoubleOpenCustomHashMap.this.realSize() / (double)Byte2DoubleOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
