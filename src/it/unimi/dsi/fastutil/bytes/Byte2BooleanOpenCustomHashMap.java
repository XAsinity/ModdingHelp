...
Hash {
    ...
    implements Byte2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
            if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2BooleanOpenCustomHashMap.this.n));
            }
            int pos = Byte2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2BooleanOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2BooleanOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2BooleanOpenCustomHashMap.this.size - this.c), (long)((double)Byte2BooleanOpenCustomHashMap.this.realSize() / (double)Byte2BooleanOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
