...
Hash {
    ...
    implements Byte2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2LongOpenCustomHashMap.this.n));
            }
            int pos = Byte2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2LongOpenCustomHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2LongOpenCustomHashMap.this.size - this.c), (long)((double)Byte2LongOpenCustomHashMap.this.realSize() / (double)Byte2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
