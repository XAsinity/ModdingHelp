...
Hash {
    ...
    implements Byte2ShortMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
            if (Byte2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Byte2ShortOpenHashMap.this.n));
            }
            int pos = Byte2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ShortOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
            ...
            if (Byte2ShortOpenHashMap.this.containsNullKey) {
                entry.index = Byte2ShortOpenHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Byte2ShortMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Byte2ShortOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Byte2ShortOpenHashMap.this.n);
                return true;
            }
            byte[] key = Byte2ShortOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Byte2ShortOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Byte2ShortOpenHashMap.this.size - this.c), (long)((double)Byte2ShortOpenHashMap.this.realSize() / (double)Byte2ShortOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
