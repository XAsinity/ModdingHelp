...
Hash {
    ...
    implements Short2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
            if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ReferenceOpenCustomHashMap.this.n));
            }
            int pos = Short2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ReferenceOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
                entry.index = Short2ReferenceOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Short2ReferenceMap.Entry<V>>>
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Short2ReferenceOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ShortSpliterator {
        ...
        final void acceptOnIndex(ShortConsumer action, int index) {
            action.accept(Short2ReferenceOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Short2ReferenceMap.Entry<V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2ReferenceOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Short2ReferenceOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2ReferenceOpenCustomHashMap.this.n);
                return true;
            }
            short[] key = Short2ReferenceOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ReferenceOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ReferenceOpenCustomHashMap.this.size - this.c), (long)((double)Short2ReferenceOpenCustomHashMap.this.realSize() / (double)Short2ReferenceOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
