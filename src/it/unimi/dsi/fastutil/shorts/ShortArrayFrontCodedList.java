...
RandomAccess {
    ...
    static int readInt(short[][] a, long pos) {
        int s0 = BigArrays.get(a, pos);
        return s0 >= 0 ? s0 : s0 << 16 | BigArrays.get(a, pos + 1L) & 0xFFFF;
    }
        ...
        return new ObjectListIterator<short[]>(){
            ...
            public short[] next() {
                ...
                if (this.i % ShortArrayFrontCodedList.this.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(ShortArrayFrontCodedList.this.array, this.pos + (long)ShortArrayFrontCodedList.count(length), this.s, 0, length);
                    ...
                    BigArrays.copyFromBig(ShortArrayFrontCodedList.this.array, this.pos + (long)ShortArrayFrontCodedList.count(length) + (long)ShortArrayFrontCodedList.count(common), this.s, common, length);
