...
Hash {
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2DoubleOpenHashMap.this.n));
            }
            int pos = Short2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            ...
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                entry.index = Short2DoubleOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2DoubleOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2DoubleOpenHashMap.this.n);
                return true;
            }
            short[] key = Short2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2DoubleOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2DoubleOpenHashMap.this.size - this.c), (long)((double)Short2DoubleOpenHashMap.this.realSize() / (double)Short2DoubleOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
