...
Hash {
    ...
    implements Short2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2CharOpenCustomHashMap.this.n));
            }
            int pos = Short2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2CharOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
            ...
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                entry.index = Short2CharOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Short2CharMap.Entry>>
    ...
    implements CharSpliterator {
        ...
        final void acceptOnIndex(CharConsumer action, int index) {
            action.accept(Short2CharOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ShortSpliterator {
        ...
        final void acceptOnIndex(ShortConsumer action, int index) {
            action.accept(Short2CharOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Short2CharMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2CharOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Short2CharOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2CharOpenCustomHashMap.this.n);
                return true;
            }
            short[] key = Short2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2CharOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2CharOpenCustomHashMap.this.size - this.c), (long)((double)Short2CharOpenCustomHashMap.this.realSize() / (double)Short2CharOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
