...
Cloneable {
    ...
    public Short2CharAVLTreeMap(SortedMap<Short, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Short, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(){
                ...
                {
                    this.comparator = Short2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2CharAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
