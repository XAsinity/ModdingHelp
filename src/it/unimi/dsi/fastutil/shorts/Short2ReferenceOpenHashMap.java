...
Hash {
    ...
    implements Short2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
            if (Short2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ReferenceOpenHashMap.this.n));
            }
            int pos = Short2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ReferenceOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Short2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Short2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Short2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2ReferenceOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2ReferenceOpenHashMap.this.n);
                return true;
            }
            short[] key = Short2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ReferenceOpenHashMap.this.size - this.c), (long)((double)Short2ReferenceOpenHashMap.this.realSize() / (double)Short2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
