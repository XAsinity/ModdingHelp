...
Cloneable {
    ...
    public Short2FloatAVLTreeMap(SortedMap<Short, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Short, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Short2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
