...
Hash {
    ...
    implements Short2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2IntOpenCustomHashMap.this.n));
            }
            int pos = Short2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2IntOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
            ...
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                entry.index = Short2IntOpenCustomHashMap.this.n;
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index) {
            action.accept(Short2IntOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ShortSpliterator {
        ...
        final void acceptOnIndex(ShortConsumer action, int index) {
            action.accept(Short2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Short2IntMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2IntOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Short2IntOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2IntOpenCustomHashMap.this.n);
                return true;
            }
            short[] key = Short2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2IntOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2IntOpenCustomHashMap.this.size - this.c), (long)((double)Short2IntOpenCustomHashMap.this.realSize() / (double)Short2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
