    ...
    public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Short2FloatRBTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2FloatRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
