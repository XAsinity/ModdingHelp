...
Hash {
    ...
    implements Short2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
            if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2BooleanOpenCustomHashMap.this.n));
            }
            int pos = Short2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2BooleanOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
            ...
            if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.index = Short2BooleanOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2BooleanOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2BooleanOpenCustomHashMap.this.n);
                return true;
            }
            short[] key = Short2BooleanOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2BooleanOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2BooleanOpenCustomHashMap.this.size - this.c), (long)((double)Short2BooleanOpenCustomHashMap.this.realSize() / (double)Short2BooleanOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
