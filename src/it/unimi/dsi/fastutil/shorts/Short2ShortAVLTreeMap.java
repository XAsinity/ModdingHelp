...
Cloneable {
    ...
    public Short2ShortAVLTreeMap(SortedMap<Short, Short> m) {
        this(m.comparator());
        this.putAll((Map<? extends Short, ? extends Short>)m);
    }
    ...
    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Short2ShortAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2ShortAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
