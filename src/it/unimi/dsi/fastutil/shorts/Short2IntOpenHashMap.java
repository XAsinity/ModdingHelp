...
Hash {
    ...
    implements Short2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
            if (Short2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2IntOpenHashMap.this.n));
            }
            int pos = Short2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2IntOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
            ...
            if (Short2IntOpenHashMap.this.containsNullKey) {
                entry.index = Short2IntOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2IntOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2IntOpenHashMap.this.n);
                return true;
            }
            short[] key = Short2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2IntOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2IntOpenHashMap.this.size - this.c), (long)((double)Short2IntOpenHashMap.this.realSize() / (double)Short2IntOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
