...
Cloneable {
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Short2ObjectAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2ObjectAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
    ...
    implements Serializable {
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
