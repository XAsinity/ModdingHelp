...
Hash {
    ...
    implements Short2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            if (Short2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ByteOpenHashMap.this.n));
            }
            int pos = Short2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ByteOpenHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ByteOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ByteOpenHashMap.this.size - this.c), (long)((double)Short2ByteOpenHashMap.this.realSize() / (double)Short2ByteOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
