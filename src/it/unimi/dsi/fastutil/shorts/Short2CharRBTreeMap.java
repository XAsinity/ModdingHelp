    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(){
                ...
                {
                    this.comparator = Short2CharRBTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2CharRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
