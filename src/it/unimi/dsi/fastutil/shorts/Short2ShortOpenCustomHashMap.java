...
Hash {
    ...
    implements Short2ShortMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ShortOpenCustomHashMap.this.n));
            }
            int pos = Short2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ShortOpenCustomHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            ...
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                entry.index = Short2ShortOpenCustomHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Short2ShortMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2ShortOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2ShortOpenCustomHashMap.this.n);
                return true;
            }
            short[] key = Short2ShortOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ShortOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ShortOpenCustomHashMap.this.size - this.c), (long)((double)Short2ShortOpenCustomHashMap.this.realSize() / (double)Short2ShortOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
