...
Hash {
    ...
    implements Short2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
            if (Short2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ObjectOpenHashMap.this.n));
            }
            int pos = Short2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ObjectOpenHashMap.this.key[pos] == 0) continue;
        ...
        public void fastForEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
            ...
            if (Short2ObjectOpenHashMap.this.containsNullKey) {
                entry.index = Short2ObjectOpenHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Short2ObjectMap.Entry<V>>>
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Short2ObjectOpenHashMap.this.value[index]);
        }
    ...
    implements ShortSpliterator {
        ...
        final void acceptOnIndex(ShortConsumer action, int index) {
            action.accept(Short2ObjectOpenHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Short2ObjectMap.Entry<V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Short2ObjectOpenHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Short2ObjectOpenHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2ObjectOpenHashMap.this.n);
                return true;
            }
            short[] key = Short2ObjectOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ObjectOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ObjectOpenHashMap.this.size - this.c), (long)((double)Short2ObjectOpenHashMap.this.realSize() / (double)Short2ObjectOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
