...
Cloneable {
    ...
    public Short2IntAVLTreeMap(SortedMap<Short, Integer> m) {
        this(m.comparator());
        this.putAll((Map<? extends Short, ? extends Integer>)m);
    }
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(){
                ...
                {
                    this.comparator = Short2IntAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2IntAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
