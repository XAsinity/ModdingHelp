...
Cloneable {
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Short2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2ObjectRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
    ...
    implements Serializable {
        ...
        public V get(short k) {
            Entry e;
            short kk = k;
            return this.in(kk) && (e = Short2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(short k, V v) {
            ...
            Object oldValue = Short2ObjectRBTreeMap.this.put(k, v);
