    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(){
                ...
                {
                    this.comparator = Short2IntRBTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2IntRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
