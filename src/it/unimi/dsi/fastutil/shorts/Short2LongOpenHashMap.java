...
Hash {
    ...
    implements Short2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
            if (Short2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2LongOpenHashMap.this.n));
            }
            int pos = Short2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2LongOpenHashMap.this.key[pos] == 0) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2LongOpenHashMap.this.size - this.c), (long)((double)Short2LongOpenHashMap.this.realSize() / (double)Short2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
