    ...
    public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Short2ByteRBTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2ByteRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
