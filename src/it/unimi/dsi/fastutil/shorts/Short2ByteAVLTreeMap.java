...
Cloneable {
    ...
    public Short2ByteAVLTreeMap(SortedMap<Short, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Short, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Short2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey()) : (x, y) -> Short2ByteAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                }
