...
Hash {
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                entry.index = Short2FloatOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Short2FloatOpenHashMap.this.n);
                return true;
            }
            short[] key = Short2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            ...
            return Math.min((long)(Short2FloatOpenHashMap.this.size - this.c), (long)((double)Short2FloatOpenHashMap.this.realSize() / (double)Short2FloatOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
