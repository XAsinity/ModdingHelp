...
Hash {
    ...
    implements Double2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
            if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2BooleanOpenCustomHashMap.this.n));
            }
            int pos = Double2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2BooleanOpenCustomHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
            ...
            if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.index = Double2BooleanOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Double2BooleanMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Double2BooleanMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Double2BooleanOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Double2BooleanOpenCustomHashMap.this.n);
                return true;
            }
            double[] key = Double2BooleanOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2BooleanOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2BooleanOpenCustomHashMap.this.size - this.c), (long)((double)Double2BooleanOpenCustomHashMap.this.realSize() / (double)Double2BooleanOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
