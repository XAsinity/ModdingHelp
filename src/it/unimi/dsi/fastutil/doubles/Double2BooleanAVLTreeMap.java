...
Cloneable {
    ...
    public Double2BooleanAVLTreeMap(SortedMap<Double, Boolean> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Boolean>)m);
    }
    ...
    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Double2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2BooleanAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
