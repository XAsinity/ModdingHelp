...
Hash {
    ...
    implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
            if (Double2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2ReferenceOpenHashMap.this.n));
            }
            int pos = Double2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Double2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Double2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Double2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Double2ReferenceOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Double2ReferenceOpenHashMap.this.n);
                return true;
            }
            double[] key = Double2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2ReferenceOpenHashMap.this.size - this.c), (long)((double)Double2ReferenceOpenHashMap.this.realSize() / (double)Double2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
