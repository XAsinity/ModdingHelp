...
Hash {
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2DoubleMap.Entry> consumer) {
            if (Double2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2DoubleOpenCustomHashMap.this.n));
            }
            int pos = Double2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2DoubleOpenCustomHashMap.this.key[pos]) == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2DoubleOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2DoubleOpenCustomHashMap.this.size - this.c), (long)((double)Double2DoubleOpenCustomHashMap.this.realSize() / (double)Double2DoubleOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
