    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Double2ByteRBTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ByteRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
