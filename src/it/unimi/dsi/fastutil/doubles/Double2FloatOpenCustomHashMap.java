...
Hash {
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2FloatMap.Entry> consumer) {
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2FloatOpenCustomHashMap.this.n));
            }
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2FloatMap.Entry> consumer) {
            ...
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.index = Double2FloatOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Double2FloatMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Double2FloatMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Double2FloatOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Double2FloatOpenCustomHashMap.this.n);
                return true;
            }
            double[] key = Double2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2FloatOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2FloatOpenCustomHashMap.this.size - this.c), (long)((double)Double2FloatOpenCustomHashMap.this.realSize() / (double)Double2FloatOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
