...
Hash {
    ...
    implements Double2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2ByteOpenCustomHashMap.this.n));
            }
            int pos = Double2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            ...
            if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.index = Double2ByteOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Double2ByteMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Double2ByteMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Double2ByteOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Double2ByteOpenCustomHashMap.this.n);
                return true;
            }
            double[] key = Double2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2ByteOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2ByteOpenCustomHashMap.this.size - this.c), (long)((double)Double2ByteOpenCustomHashMap.this.realSize() / (double)Double2ByteOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
