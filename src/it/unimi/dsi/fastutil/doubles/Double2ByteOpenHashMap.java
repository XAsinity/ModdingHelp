...
Hash {
    ...
    implements Double2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2ByteOpenHashMap.this.n));
            }
            int pos = Double2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2ByteOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2ByteOpenHashMap.this.size - this.c), (long)((double)Double2ByteOpenHashMap.this.realSize() / (double)Double2ByteOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
