...
Cloneable {
    ...
    public Double2IntAVLTreeMap(SortedMap<Double, Integer> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Integer>)m);
    }
    ...
    public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>(){
                ...
                {
                    this.comparator = Double2IntAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2IntAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
