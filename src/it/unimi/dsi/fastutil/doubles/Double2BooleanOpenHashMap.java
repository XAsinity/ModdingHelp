...
Hash {
    ...
    implements Double2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
            if (Double2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2BooleanOpenHashMap.this.n));
            }
            int pos = Double2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[pos]) == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2BooleanOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2BooleanOpenHashMap.this.size - this.c), (long)((double)Double2BooleanOpenHashMap.this.realSize() / (double)Double2BooleanOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
