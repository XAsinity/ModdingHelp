...
Cloneable {
    ...
    public Double2DoubleAVLTreeMap(SortedMap<Double, Double> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Double>)m);
    }
    ...
    public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Double2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2DoubleAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
