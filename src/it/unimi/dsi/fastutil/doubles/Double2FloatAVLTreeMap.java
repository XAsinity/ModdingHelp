...
Cloneable {
    ...
    public Double2FloatAVLTreeMap(SortedMap<Double, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Double2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2FloatAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
