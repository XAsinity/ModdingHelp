    ...
    public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Double2DoubleRBTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2DoubleRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
