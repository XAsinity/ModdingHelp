...
Cloneable {
    ...
    public Double2ShortAVLTreeMap(SortedMap<Double, Short> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Short>)m);
    }
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Double2ShortAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ShortAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
