...
Cloneable {
    ...
    public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Double2ObjectAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ObjectAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
    ...
    public Double2ObjectAVLTreeMap<V> clone() {
        ...
        try {
            c = (Double2ObjectAVLTreeMap)super.clone();
        }
    ...
    extends AbstractDouble2ObjectSortedMap.KeySet {
        private KeySet() {
        }
    ...
    implements Serializable {
        ...
        public V get(double k) {
            Entry e;
            double kk = k;
            return this.in(kk) && (e = Double2ObjectAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(double k, V v) {
            ...
            Object oldValue = Double2ObjectAVLTreeMap.this.put(k, v);
            return Double2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public V remove(double k) {
            ...
            return Double2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.doubles.Double2ObjectAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.doubles.Double2ObjectAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
