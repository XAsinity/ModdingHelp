...
Cloneable {
    ...
    public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Double2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ObjectRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
    ...
    implements Serializable {
        ...
        public V get(double k) {
            Entry e;
            double kk = k;
            return this.in(kk) && (e = Double2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(double k, V v) {
            ...
            Object oldValue = Double2ObjectRBTreeMap.this.put(k, v);
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.doubles.Double2ObjectRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.doubles.Double2ObjectRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
