    ...
    public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>(){
                ...
                {
                    this.comparator = Double2LongRBTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2LongRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
