    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Double2ShortRBTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ShortRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
