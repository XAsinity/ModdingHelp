...
Hash {
    ...
    implements Double2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Double2LongOpenHashMap.this.n));
            }
            int pos = Double2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2LongOpenHashMap.this.key[pos]) == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
            ...
            if (Double2LongOpenHashMap.this.containsNullKey) {
                entry.index = Double2LongOpenHashMap.this.n;
    ...
    implements LongSpliterator {
        ...
        final void acceptOnIndex(LongConsumer action, int index) {
            action.accept(Double2LongOpenHashMap.this.value[index]);
        }
    ...
    implements DoubleSpliterator {
        ...
        final void acceptOnIndex(DoubleConsumer action, int index) {
            action.accept(Double2LongOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Double2LongOpenHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Double2LongOpenHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Double2LongOpenHashMap.this.n);
                return true;
            }
            double[] key = Double2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Double2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Double2LongOpenHashMap.this.size - this.c), (long)((double)Double2LongOpenHashMap.this.realSize() / (double)Double2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
