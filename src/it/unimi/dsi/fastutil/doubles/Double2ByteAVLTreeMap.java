...
Cloneable {
    ...
    public Double2ByteAVLTreeMap(SortedMap<Double, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Double, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Double2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey()) : (x, y) -> Double2ByteAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                }
