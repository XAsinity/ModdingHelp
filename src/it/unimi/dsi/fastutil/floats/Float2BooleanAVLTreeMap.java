...
Cloneable {
    ...
    public Float2BooleanAVLTreeMap(SortedMap<Float, Boolean> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Boolean>)m);
    }
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Float2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2BooleanAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
