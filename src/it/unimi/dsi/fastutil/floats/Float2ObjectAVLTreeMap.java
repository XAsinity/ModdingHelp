...
Cloneable {
    ...
    public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Float2ObjectAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2ObjectAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
    ...
    implements Serializable {
        ...
        public V get(float k) {
            Entry e;
            float kk = k;
            return this.in(kk) && (e = Float2ObjectAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(float k, V v) {
            ...
            Object oldValue = Float2ObjectAVLTreeMap.this.put(k, v);
