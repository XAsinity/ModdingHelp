...
Cloneable {
    ...
    public Float2DoubleAVLTreeMap(SortedMap<Float, Double> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Double>)m);
    }
    ...
    public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Float2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2DoubleAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
