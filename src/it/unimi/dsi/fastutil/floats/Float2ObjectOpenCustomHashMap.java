...
Hash {
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Float2ObjectOpenCustomHashMap.this.n));
            }
            int pos = Float2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ObjectOpenCustomHashMap.this.key[pos]) == 0) continue;
        ...
        public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            ...
            if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                entry.index = Float2ObjectOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Float2ObjectOpenCustomHashMap.this.value[index]);
        }
    ...
    implements FloatSpliterator {
        ...
        final void acceptOnIndex(FloatConsumer action, int index) {
            action.accept(Float2ObjectOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Float2ObjectMap.Entry<V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Float2ObjectOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Float2ObjectOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Float2ObjectOpenCustomHashMap.this.n);
                return true;
            }
            float[] key = Float2ObjectOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Float2ObjectOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Float2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Float2ObjectOpenCustomHashMap.this.realSize() / (double)Float2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
