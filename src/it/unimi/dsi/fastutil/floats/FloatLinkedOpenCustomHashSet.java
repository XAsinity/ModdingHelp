    ...
    implements FloatListIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                int n = this.prev;
                FloatLinkedOpenCustomHashSet.this.link[n] = FloatLinkedOpenCustomHashSet.this.link[n] ^ (FloatLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                FloatLinkedOpenCustomHashSet.this.last = this.prev;
            } else {
                int n = this.next;
                FloatLinkedOpenCustomHashSet.this.link[n] = FloatLinkedOpenCustomHashSet.this.link[n] ^ (FloatLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L;
            }
            int pos = this.curr;
            this.curr = -1;
