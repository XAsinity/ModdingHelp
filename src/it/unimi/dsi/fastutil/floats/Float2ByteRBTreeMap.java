    ...
    public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Float2ByteRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2ByteRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
