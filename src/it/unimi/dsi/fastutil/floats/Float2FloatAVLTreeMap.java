...
Cloneable {
    ...
    public Float2FloatAVLTreeMap(SortedMap<Float, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Float2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
