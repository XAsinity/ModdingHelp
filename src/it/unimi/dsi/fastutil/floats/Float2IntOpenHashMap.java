...
Hash {
    ...
    implements Float2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
            if (Float2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Float2IntOpenHashMap.this.n));
            }
            int pos = Float2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2IntOpenHashMap.this.key[pos]) == 0) continue;
        ...
        public void fastForEach(Consumer<? super Float2IntMap.Entry> consumer) {
            ...
            if (Float2IntOpenHashMap.this.containsNullKey) {
                entry.index = Float2IntOpenHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Float2IntMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Float2IntOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Float2IntOpenHashMap.this.n);
                return true;
            }
            float[] key = Float2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Float2IntOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Float2IntOpenHashMap.this.size - this.c), (long)((double)Float2IntOpenHashMap.this.realSize() / (double)Float2IntOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
