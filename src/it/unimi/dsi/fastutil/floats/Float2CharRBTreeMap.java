    ...
    public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(){
                ...
                {
                    this.comparator = Float2CharRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2CharRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
