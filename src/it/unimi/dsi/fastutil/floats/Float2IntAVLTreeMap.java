...
Cloneable {
    ...
    public Float2IntAVLTreeMap(SortedMap<Float, Integer> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Integer>)m);
    }
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(){
                ...
                {
                    this.comparator = Float2IntAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2IntAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
