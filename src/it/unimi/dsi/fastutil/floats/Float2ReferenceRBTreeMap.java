...
Cloneable {
    ...
    public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Float2ReferenceRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2ReferenceRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
    ...
    implements Serializable {
        ...
        public V get(float k) {
            Entry e;
            float kk = k;
            return this.in(kk) && (e = Float2ReferenceRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(float k, V v) {
            ...
            Object oldValue = Float2ReferenceRBTreeMap.this.put(k, v);
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
