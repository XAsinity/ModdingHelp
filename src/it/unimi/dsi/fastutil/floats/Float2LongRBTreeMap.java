    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(){
                ...
                {
                    this.comparator = Float2LongRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2LongRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
