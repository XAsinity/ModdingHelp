...
Cloneable {
    ...
    public Float2LongAVLTreeMap(SortedMap<Float, Long> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Long>)m);
    }
    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(){
                ...
                {
                    this.comparator = Float2LongAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2LongAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
