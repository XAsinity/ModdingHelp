    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Float2BooleanRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2BooleanRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
