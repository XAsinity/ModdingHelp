...
Hash {
    ...
    implements Float2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
            if (Float2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Float2LongOpenCustomHashMap.this.n));
            }
            int pos = Float2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) == 0) continue;
        ...
        public void fastForEach(Consumer<? super Float2LongMap.Entry> consumer) {
            ...
            if (Float2LongOpenCustomHashMap.this.containsNullKey) {
                entry.index = Float2LongOpenCustomHashMap.this.n;
    ...
    extends MapSpliterator<Consumer<? super Float2LongMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Float2LongOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Float2LongOpenCustomHashMap.this.n);
                return true;
            }
            float[] key = Float2LongOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Float2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Float2LongOpenCustomHashMap.this.size - this.c), (long)((double)Float2LongOpenCustomHashMap.this.realSize() / (double)Float2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
