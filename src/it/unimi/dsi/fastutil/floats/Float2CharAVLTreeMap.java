...
Cloneable {
    ...
    public Float2CharAVLTreeMap(SortedMap<Float, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Float, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(){
                ...
                {
                    this.comparator = Float2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2CharAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
