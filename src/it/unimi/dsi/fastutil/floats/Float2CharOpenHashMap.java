...
Hash {
    ...
    implements Float2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Float2CharMap.Entry> consumer) {
            if (Float2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Float2CharOpenHashMap.this.n));
            }
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) == 0) continue;
        ...
        public void fastForEach(Consumer<? super Float2CharMap.Entry> consumer) {
            ...
            if (Float2CharOpenHashMap.this.containsNullKey) {
                entry.index = Float2CharOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Float2CharOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Float2CharOpenHashMap.this.n);
                return true;
            }
            float[] key = Float2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Float2CharOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Float2CharOpenHashMap.this.size - this.c), (long)((double)Float2CharOpenHashMap.this.realSize() / (double)Float2CharOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
