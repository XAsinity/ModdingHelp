    ...
    public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Float2ShortRBTreeMap.this.actualComparator == null ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey()) : (x, y) -> Float2ShortRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                }
