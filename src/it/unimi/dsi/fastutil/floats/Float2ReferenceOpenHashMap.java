...
Hash {
    ...
    public Float2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            c = (Float2ReferenceOpenHashMap)super.clone();
        }
    ...
    implements Float2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Float2ReferenceOpenHashMap.this.n));
            }
            int pos = Float2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[pos]) == 0) continue;
        ...
        public void fastForEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Float2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Float2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Float2ReferenceOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Float2ReferenceOpenHashMap.this.n);
                return true;
            }
            float[] key = Float2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Float2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Float2ReferenceOpenHashMap.this.size - this.c), (long)((double)Float2ReferenceOpenHashMap.this.realSize() / (double)Float2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
