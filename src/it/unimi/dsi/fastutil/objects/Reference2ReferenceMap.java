...
Map<K, V> {
    ...
    default public void forEach(BiConsumer<? super K, ? super V> consumer) {
        ObjectSet<Entry<K, V>> entrySet = this.reference2ReferenceEntrySet();
    ...
    @Override
    default public V computeIfAbsent(K key, Reference2ReferenceFunction<? super K, ? extends V> mappingFunction) {
    ...
    @Deprecated
    default public V computeReferenceIfAbsentPartial(K key, Reference2ReferenceFunction<? super K, ? extends V> mappingFunction) {
