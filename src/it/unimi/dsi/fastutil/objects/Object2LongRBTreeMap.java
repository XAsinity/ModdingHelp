...
Cloneable {
    ...
    public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2LongRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2LongRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        public Object2LongSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2LongRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2LongRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
