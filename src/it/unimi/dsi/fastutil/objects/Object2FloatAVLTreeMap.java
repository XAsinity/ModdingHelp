...
Cloneable {
    ...
    public Object2FloatAVLTreeMap(Map<? extends K, ? extends Float> m) {
        this();
        this.putAll((Map<? extends K, Float>)m);
    }

    public Object2FloatAVLTreeMap(SortedMap<K, Float> m) {
        this(m.comparator());
        this.putAll((Map<K, Float>)m);
    }
    ...
    public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2FloatAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        public Object2FloatSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2FloatAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2FloatAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
