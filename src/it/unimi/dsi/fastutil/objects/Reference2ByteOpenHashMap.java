...
Hash {
    ...
    public Reference2ByteOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2ByteOpenHashMap)super.clone();
        }
    ...
    implements Reference2ByteMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
            if (Reference2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2ByteOpenHashMap.this.n));
            }
            int pos = Reference2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ByteOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
            ...
            if (Reference2ByteOpenHashMap.this.containsNullKey) {
                entry.index = Reference2ByteOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2ByteOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2ByteOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2ByteOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2ByteOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2ByteOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2ByteOpenHashMap.this.size - this.c), (long)((double)Reference2ByteOpenHashMap.this.realSize() / (double)Reference2ByteOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
