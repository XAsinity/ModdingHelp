...
Cloneable {
    ...
    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>(){
                ...
                {
                    this.comparator = Object2ReferenceAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2ReferenceAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        public V get(Object k) {
            Entry e;
            Object kk = k;
            return this.in(kk) && (e = Object2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(K k, V v) {
            ...
            Object oldValue = Object2ReferenceAVLTreeMap.this.put(k, v);
        ...
        public Object2ReferenceSortedMap<K, V> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2ReferenceAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2ReferenceAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
