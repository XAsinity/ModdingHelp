...
Cloneable {
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2DoubleAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2DoubleAVLTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2DoubleSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
