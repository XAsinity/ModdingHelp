...
Hash {
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2ObjectOpenCustomHashMap.this.n));
            }
            int pos = Reference2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ObjectOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            ...
            if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
                entry.index = Reference2ObjectOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>>
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Reference2ObjectOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2ObjectOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2ObjectOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2ObjectOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Reference2ObjectOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2ObjectOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Reference2ObjectOpenCustomHashMap.this.realSize() / (double)Reference2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
