...
Hash {
    ...
    implements Reference2IntMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2IntOpenCustomHashMap.this.n));
            }
            int pos = Reference2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2IntOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            ...
            if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
                entry.index = Reference2IntOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2IntOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2IntOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Reference2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2IntOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2IntOpenCustomHashMap.this.size - this.c), (long)((double)Reference2IntOpenCustomHashMap.this.realSize() / (double)Reference2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
