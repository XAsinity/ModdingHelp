...
Hash {
    ...
    implements Object2DoubleMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            if (Object2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2DoubleOpenHashMap.this.n));
            }
            int pos = Object2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2DoubleOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            ...
            if (Object2DoubleOpenHashMap.this.containsNullKey) {
                entry.index = Object2DoubleOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2DoubleOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2DoubleOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2DoubleOpenHashMap.this.n);
                return true;
            }
            K[] key = Object2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2DoubleOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2DoubleOpenHashMap.this.size - this.c), (long)((double)Object2DoubleOpenHashMap.this.realSize() / (double)Object2DoubleOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
