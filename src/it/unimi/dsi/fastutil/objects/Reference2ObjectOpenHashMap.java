...
Hash {
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            if (Reference2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2ObjectOpenHashMap.this.n));
            }
            int pos = Reference2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ObjectOpenHashMap.this.key[pos] == null) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2ObjectOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2ObjectOpenHashMap.this.size - this.c), (long)((double)Reference2ObjectOpenHashMap.this.realSize() / (double)Reference2ObjectOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
