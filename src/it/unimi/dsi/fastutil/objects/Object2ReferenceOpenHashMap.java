...
Hash {
    ...
    implements Object2ReferenceMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            if (Object2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2ReferenceOpenHashMap.this.n));
            }
            int pos = Object2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ReferenceOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            ...
            if (Object2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Object2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Object2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2ReferenceOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2ReferenceOpenHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Object2ReferenceOpenHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2ReferenceOpenHashMap.this.n);
                return true;
            }
            K[] key = Object2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2ReferenceOpenHashMap.this.size - this.c), (long)((double)Object2ReferenceOpenHashMap.this.realSize() / (double)Object2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
