...
Hash {
    ...
    implements Reference2CharMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            if (Reference2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2CharOpenHashMap.this.n));
            }
            int pos = Reference2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2CharOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            ...
            if (Reference2CharOpenHashMap.this.containsNullKey) {
                entry.index = Reference2CharOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2CharOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2CharOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2CharOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2CharOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2CharOpenHashMap.this.size - this.c), (long)((double)Reference2CharOpenHashMap.this.realSize() / (double)Reference2CharOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
