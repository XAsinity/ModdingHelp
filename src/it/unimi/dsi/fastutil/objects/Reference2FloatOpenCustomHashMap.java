...
Hash {
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2FloatOpenCustomHashMap.this.n));
            }
            int pos = Reference2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2FloatOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.index = Reference2FloatOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Reference2FloatMap.Entry<K>>>
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2FloatOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Reference2FloatMap.Entry<K>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2FloatOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2FloatOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Reference2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2FloatOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2FloatOpenCustomHashMap.this.size - this.c), (long)((double)Reference2FloatOpenCustomHashMap.this.realSize() / (double)Reference2FloatOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
