...
Cloneable {
    ...
    public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2FloatRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2FloatRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2FloatRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2FloatRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2FloatSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
