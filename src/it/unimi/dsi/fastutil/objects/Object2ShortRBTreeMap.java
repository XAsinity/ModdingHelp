...
Cloneable {
    ...
    public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2ShortRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2ShortRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2ShortRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2ShortRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ShortSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2ShortRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2ShortRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
