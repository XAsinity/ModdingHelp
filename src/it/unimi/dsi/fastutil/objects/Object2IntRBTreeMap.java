...
Cloneable {
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2IntRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2IntRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2IntRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2IntRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2IntSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2IntRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2IntRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
