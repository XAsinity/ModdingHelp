...
Hash {
    ...
    implements Object2ShortMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2ShortOpenCustomHashMap.this.n));
            }
            int pos = Object2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ShortOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            ...
            if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                entry.index = Object2ShortOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2ShortOpenCustomHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2ShortOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2ShortOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Object2ShortOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2ShortOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2ShortOpenCustomHashMap.this.size - this.c), (long)((double)Object2ShortOpenCustomHashMap.this.realSize() / (double)Object2ShortOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
