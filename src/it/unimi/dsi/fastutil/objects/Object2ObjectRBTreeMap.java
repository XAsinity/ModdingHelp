...
Cloneable {
    ...
    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>(){
                ...
                {
                    this.comparator = Object2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2ObjectRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
                ...
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) {
                    return Object2ObjectRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
                    return Object2ObjectRBTreeMap.this.headMap(to.getKey()).object2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
                    return Object2ObjectRBTreeMap.this.tailMap(from.getKey()).object2ObjectEntrySet();
                }
            };
        }
        return this.entries;
    ...
    public Object2ObjectRBTreeMap<K, V> clone() {
        ...
        try {
            c = (Object2ObjectRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(Object k) {
            Entry e;
            Object kk = k;
            return this.in(kk) && (e = Object2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(K k, V v) {
            ...
            Object oldValue = Object2ObjectRBTreeMap.this.put(k, v);
        ...
        public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
