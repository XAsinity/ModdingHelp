...
Cloneable {
    ...
    public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2LongAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2LongAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2LongAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
