...
Cloneable {
    ...
    public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2CharRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2CharRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        public Object2CharSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2CharRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2CharRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
