...
Hash {
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            if (Reference2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2FloatOpenHashMap.this.n));
            }
            int pos = Reference2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2FloatOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            ...
            if (Reference2FloatOpenHashMap.this.containsNullKey) {
                entry.index = Reference2FloatOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2FloatOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2FloatOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2FloatOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2FloatOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2FloatOpenHashMap.this.size - this.c), (long)((double)Reference2FloatOpenHashMap.this.realSize() / (double)Reference2FloatOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
