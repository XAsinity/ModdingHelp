...
Hash {
    ...
    implements Object2ObjectMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
            if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2ObjectOpenCustomHashMap.this.n));
            }
            int pos = Object2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ObjectOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2ObjectOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Object2ObjectOpenCustomHashMap.this.realSize() / (double)Object2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
