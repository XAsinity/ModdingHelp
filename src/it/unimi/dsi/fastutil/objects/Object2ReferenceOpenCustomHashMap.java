...
Hash {
    ...
    implements Object2ReferenceMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2ReferenceOpenCustomHashMap.this.n));
            }
            int pos = Object2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ReferenceOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            ...
            if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
                entry.index = Object2ReferenceOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>>
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Object2ReferenceOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2ReferenceOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2ReferenceOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Object2ReferenceOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2ReferenceOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Object2ReferenceOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2ReferenceOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2ReferenceOpenCustomHashMap.this.size - this.c), (long)((double)Object2ReferenceOpenCustomHashMap.this.realSize() / (double)Object2ReferenceOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
