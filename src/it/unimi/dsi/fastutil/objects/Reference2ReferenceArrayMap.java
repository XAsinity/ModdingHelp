 ...
 *  it.unimi.dsi.fastutil.objects.Reference2ReferenceArrayMap$EntrySet.EntrySetSpliterator
 *  it.unimi.dsi.fastutil.objects.Reference2ReferenceArrayMap$KeySet.KeySetSpliterator
 *  it.unimi.dsi.fastutil.objects.Reference2ReferenceArrayMap$ValuesCollection.ValuesSpliterator
 */
...
Cloneable {
    ...
    implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Reference2ReferenceMap.Entry<K, V>>(){
                ...
                public void forEachRemaining(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action) {
                    ...
                    while (this.next < max) {
                        this.curr = this.next;
                        action.accept(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(Reference2ReferenceArrayMap.this.key[this.curr], Reference2ReferenceArrayMap.this.value[this.next++]));
                    }
                }
            };
        }
        ...
        public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action) {
            int max = Reference2ReferenceArrayMap.this.size;
            for (int i = 0; i < max; ++i) {
                action.accept(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(Reference2ReferenceArrayMap.this.key[i], Reference2ReferenceArrayMap.this.value[i]));
            }
        }
        ...
        public void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action) {
            ...
            int max = Reference2ReferenceArrayMap.this.size;
            for (int i = 0; i < max; ++i) {
                entry.key = Reference2ReferenceArrayMap.this.key[i];
                entry.value = Reference2ReferenceArrayMap.this.value[i];
                action.accept(entry);
            }
        }
        ...
        implements ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> {
            ...
            protected final Reference2ReferenceMap.Entry<K, V> get(int location) {
                return new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(Reference2ReferenceArrayMap.this.key[location], Reference2ReferenceArrayMap.this.value[location]);
            }
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>(){
                ...
                public void forEachRemaining(Consumer<? super K> action) {
                    int max = Reference2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
                        action.accept(Reference2ReferenceArrayMap.this.key[this.pos++]);
                    }
                }
            };
        }
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    int max = Reference2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
                        action.accept(Reference2ReferenceArrayMap.this.value[this.pos++]);
                    }
                }
            };
        }
