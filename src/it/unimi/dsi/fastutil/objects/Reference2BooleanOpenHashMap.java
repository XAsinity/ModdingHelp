...
Hash {
    ...
    public Reference2BooleanOpenHashMap<K> clone() {
        ...
        try {
            c = (Reference2BooleanOpenHashMap)super.clone();
        }
    ...
    implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2BooleanOpenHashMap.this.n));
            }
            int pos = Reference2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                entry.index = Reference2BooleanOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2BooleanOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2BooleanOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2BooleanOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2BooleanOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2BooleanOpenHashMap.this.size - this.c), (long)((double)Reference2BooleanOpenHashMap.this.realSize() / (double)Reference2BooleanOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
