...
Hash {
    ...
    implements Object2LongMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            if (Object2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2LongOpenHashMap.this.n));
            }
            int pos = Object2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongOpenHashMap.this.key[pos] == null) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2LongOpenHashMap.this.size - this.c), (long)((double)Object2LongOpenHashMap.this.realSize() / (double)Object2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
