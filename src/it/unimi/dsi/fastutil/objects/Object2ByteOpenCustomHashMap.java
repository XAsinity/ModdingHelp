...
Hash {
    ...
    implements Object2ByteMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2ByteOpenCustomHashMap.this.n));
            }
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ByteOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            ...
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.index = Object2ByteOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2ByteOpenCustomHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2ByteOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2ByteOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Object2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2ByteOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2ByteOpenCustomHashMap.this.size - this.c), (long)((double)Object2ByteOpenCustomHashMap.this.realSize() / (double)Object2ByteOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
