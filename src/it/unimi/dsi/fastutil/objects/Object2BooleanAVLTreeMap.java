...
Cloneable {
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2BooleanAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    implements Serializable {
        ...
        public Object2BooleanSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2BooleanAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2BooleanAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2BooleanAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
