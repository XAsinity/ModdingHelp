...
Hash {
    ...
    implements Reference2DoubleMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
            if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2DoubleOpenCustomHashMap.this.n));
            }
            int pos = Reference2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2DoubleOpenCustomHashMap.this.key[pos] == null) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2DoubleOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2DoubleOpenCustomHashMap.this.size - this.c), (long)((double)Reference2DoubleOpenCustomHashMap.this.realSize() / (double)Reference2DoubleOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
