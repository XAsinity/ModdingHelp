...
Cloneable {
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2ByteRBTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2ByteRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2ByteRBTreeMap<K> clone() {
        ...
        try {
            c = (Object2ByteRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2ByteSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2ByteRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2ByteRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
