...
Hash {
    ...
    implements Object2LongMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            if (Object2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2LongOpenCustomHashMap.this.n));
            }
            int pos = Object2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2LongOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
            ...
            if (Object2LongOpenCustomHashMap.this.containsNullKey) {
                entry.index = Object2LongOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2LongOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Object2LongMap.Entry<K>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2LongOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2LongOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Object2LongOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2LongOpenCustomHashMap.this.size - this.c), (long)((double)Object2LongOpenCustomHashMap.this.realSize() / (double)Object2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
