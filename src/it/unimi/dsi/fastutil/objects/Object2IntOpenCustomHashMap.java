...
Hash {
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2IntOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Object2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            ...
            return Math.min((long)(Object2IntOpenCustomHashMap.this.size - this.c), (long)((double)Object2IntOpenCustomHashMap.this.realSize() / (double)Object2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
