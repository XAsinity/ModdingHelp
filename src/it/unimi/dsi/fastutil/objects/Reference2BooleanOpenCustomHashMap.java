...
Hash {
    ...
    public Reference2BooleanOpenCustomHashMap<K> clone() {
        ...
        try {
            c = (Reference2BooleanOpenCustomHashMap)super.clone();
        }
    ...
    implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2BooleanOpenCustomHashMap.this.n));
            }
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.index = Reference2BooleanOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2BooleanOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Reference2BooleanMap.Entry<K>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2BooleanOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2BooleanOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Reference2BooleanOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2BooleanOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2BooleanOpenCustomHashMap.this.size - this.c), (long)((double)Reference2BooleanOpenCustomHashMap.this.realSize() / (double)Reference2BooleanOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
