...
Hash {
    ...
    implements Reference2LongMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
            if (Reference2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2LongOpenHashMap.this.n));
            }
            int pos = Reference2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2LongOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
            ...
            if (Reference2LongOpenHashMap.this.containsNullKey) {
                entry.index = Reference2LongOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2LongOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2LongOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2LongOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2LongOpenHashMap.this.size - this.c), (long)((double)Reference2LongOpenHashMap.this.realSize() / (double)Reference2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
