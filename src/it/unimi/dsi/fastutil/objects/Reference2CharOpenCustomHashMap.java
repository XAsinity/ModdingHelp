...
Hash {
    ...
    implements Reference2CharMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2CharOpenCustomHashMap.this.n));
            }
            int pos = Reference2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2CharOpenCustomHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            ...
            if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
                entry.index = Reference2CharOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Reference2CharMap.Entry<K>>>
    ...
    implements CharSpliterator {
        ...
        final void acceptOnIndex(CharConsumer action, int index) {
            action.accept(Reference2CharOpenCustomHashMap.this.value[index]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2CharOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Reference2CharMap.Entry<K>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2CharOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Reference2CharOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2CharOpenCustomHashMap.this.n);
                return true;
            }
            K[] key = Reference2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2CharOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2CharOpenCustomHashMap.this.size - this.c), (long)((double)Reference2CharOpenCustomHashMap.this.realSize() / (double)Reference2CharOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
