...
Hash {
    ...
    implements Object2CharMap.FastEntrySet<K> {
        ...
        public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
            if (Object2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Object2CharOpenHashMap.this.n));
            }
            int pos = Object2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2CharOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
            ...
            if (Object2CharOpenHashMap.this.containsNullKey) {
                entry.index = Object2CharOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Object2CharOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Object2CharOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Object2CharOpenHashMap.this.n);
                return true;
            }
            K[] key = Object2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Object2CharOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Object2CharOpenHashMap.this.size - this.c), (long)((double)Object2CharOpenHashMap.this.realSize() / (double)Object2CharOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
