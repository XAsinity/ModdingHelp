...
Hash {
    ...
    implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Reference2ReferenceOpenHashMap.this.n));
            }
            int pos = Reference2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ReferenceOpenHashMap.this.key[pos] == null) continue;
        ...
        public void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            ...
            if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
                entry.index = Reference2ReferenceOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Reference2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept(Reference2ReferenceOpenHashMap.this.key[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Reference2ReferenceOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Reference2ReferenceOpenHashMap.this.n);
                return true;
            }
            K[] key = Reference2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Reference2ReferenceOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Reference2ReferenceOpenHashMap.this.size - this.c), (long)((double)Reference2ReferenceOpenHashMap.this.realSize() / (double)Reference2ReferenceOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
