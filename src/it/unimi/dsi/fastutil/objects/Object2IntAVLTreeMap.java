...
Cloneable {
    ...
    public Object2IntAVLTreeMap(Map<? extends K, ? extends Integer> m) {
        this();
        this.putAll((Map<? extends K, Integer>)m);
    }

    public Object2IntAVLTreeMap(SortedMap<K, Integer> m) {
        this(m.comparator());
        this.putAll((Map<K, Integer>)m);
    }
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(){
                ...
                {
                    this.comparator = Object2IntAVLTreeMap.this.actualComparator == null ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey()) : (x, y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                }
    ...
    public Object2IntAVLTreeMap<K> clone() {
        ...
        try {
            c = (Object2IntAVLTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Object2IntSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                Object k = to = Object2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
            }
            if (!this.bottom) {
                Object k = from = Object2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.objects.Object2IntAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.objects.Object2IntAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
