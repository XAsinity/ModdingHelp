...
Hash {
    ...
    implements Char2ShortMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2ShortMap.Entry> consumer) {
            if (Char2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2ShortOpenHashMap.this.n));
            }
            int pos = Char2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ShortOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2ShortOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2ShortOpenHashMap.this.size - this.c), (long)((double)Char2ShortOpenHashMap.this.realSize() / (double)Char2ShortOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
