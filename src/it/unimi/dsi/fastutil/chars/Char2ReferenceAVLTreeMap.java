...
Cloneable {
    ...
    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Char2ReferenceAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2ReferenceAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
    ...
    implements Serializable {
        ...
        public V get(char k) {
            Entry e;
            char kk = k;
            return this.in(kk) && (e = Char2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(char k, V v) {
            ...
            Object oldValue = Char2ReferenceAVLTreeMap.this.put(k, v);
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.chars.Char2ReferenceAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.chars.Char2ReferenceAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
