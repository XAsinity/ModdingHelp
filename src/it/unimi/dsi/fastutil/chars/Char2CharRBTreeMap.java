    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(){
                ...
                {
                    this.comparator = Char2CharRBTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2CharRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
