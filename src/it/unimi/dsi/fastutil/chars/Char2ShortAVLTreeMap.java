...
Cloneable {
    ...
    public Char2ShortAVLTreeMap(SortedMap<Character, Short> m) {
        this(m.comparator());
        this.putAll((Map<? extends Character, ? extends Short>)m);
    }
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Char2ShortAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2ShortAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
