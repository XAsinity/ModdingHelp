...
Hash {
    ...
    implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2ObjectOpenCustomHashMap.this.n));
            }
            int pos = Char2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectOpenCustomHashMap.this.key[pos] == '\u0000') continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2ObjectOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Char2ObjectOpenCustomHashMap.this.realSize() / (double)Char2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
