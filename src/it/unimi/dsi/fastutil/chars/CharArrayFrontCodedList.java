...
RandomAccess {
    ...
    static int readInt(char[][] a, long pos) {
        int c0 = BigArrays.get(a, pos);
        return c0 < 32768 ? c0 : (c0 & Short.MAX_VALUE) << 16 | BigArrays.get(a, pos + 1L);
    }
        ...
        return new ObjectListIterator<char[]>(){
            ...
            public char[] next() {
                ...
                if (this.i % CharArrayFrontCodedList.this.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(CharArrayFrontCodedList.this.array, this.pos + (long)CharArrayFrontCodedList.count(length), this.s, 0, length);
                    ...
                    BigArrays.copyFromBig(CharArrayFrontCodedList.this.array, this.pos + (long)CharArrayFrontCodedList.count(length) + (long)CharArrayFrontCodedList.count(common), this.s, common, length);
