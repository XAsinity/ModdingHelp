...
Cloneable {
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Char2ObjectRBTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2ObjectRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
    ...
    public Char2ObjectRBTreeMap<V> clone() {
        ...
        try {
            c = (Char2ObjectRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public V get(char k) {
            Entry e;
            char kk = k;
            return this.in(kk) && (e = Char2ObjectRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(char k, V v) {
            ...
            Object oldValue = Char2ObjectRBTreeMap.this.put(k, v);
            return Char2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        public V remove(char k) {
            ...
            return Char2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
        }
