...
Hash {
    ...
    implements Char2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2LongOpenHashMap.this.n));
            }
            int pos = Char2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2LongOpenHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
            ...
            if (Char2LongOpenHashMap.this.containsNullKey) {
                entry.index = Char2LongOpenHashMap.this.n;
    ...
    implements LongSpliterator {
        ...
        final void acceptOnIndex(LongConsumer action, int index) {
            action.accept(Char2LongOpenHashMap.this.value[index]);
        }
    ...
    implements CharSpliterator {
        ...
        final void acceptOnIndex(CharConsumer action, int index) {
            action.accept(Char2LongOpenHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Char2LongMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Char2LongOpenHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Char2LongOpenHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Char2LongOpenHashMap.this.n);
                return true;
            }
            char[] key = Char2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2LongOpenHashMap.this.size - this.c), (long)((double)Char2LongOpenHashMap.this.realSize() / (double)Char2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
