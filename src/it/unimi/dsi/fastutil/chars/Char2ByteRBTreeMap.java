    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Char2ByteRBTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2ByteRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
