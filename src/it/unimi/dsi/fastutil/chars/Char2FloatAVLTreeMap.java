...
Cloneable {
    ...
    public Char2FloatAVLTreeMap(SortedMap<Character, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Character, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Char2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2FloatAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
