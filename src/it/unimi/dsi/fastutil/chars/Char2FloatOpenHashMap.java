...
Hash {
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2FloatOpenHashMap.this.n));
            }
            int pos = Char2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2FloatOpenHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            ...
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                entry.index = Char2FloatOpenHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Char2FloatMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Char2FloatMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Char2FloatOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Char2FloatOpenHashMap.this.n);
                return true;
            }
            char[] key = Char2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2FloatOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2FloatOpenHashMap.this.size - this.c), (long)((double)Char2FloatOpenHashMap.this.realSize() / (double)Char2FloatOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
