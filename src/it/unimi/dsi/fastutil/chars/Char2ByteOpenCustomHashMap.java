...
Hash {
    ...
    implements Char2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2ByteOpenCustomHashMap.this.n));
            }
            int pos = Char2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ByteOpenCustomHashMap.this.key[pos] == '\u0000') continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2ByteOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2ByteOpenCustomHashMap.this.size - this.c), (long)((double)Char2ByteOpenCustomHashMap.this.realSize() / (double)Char2ByteOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
