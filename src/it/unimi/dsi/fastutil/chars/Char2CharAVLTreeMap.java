...
Cloneable {
    ...
    public Char2CharAVLTreeMap(SortedMap<Character, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Character, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(){
                ...
                {
                    this.comparator = Char2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2CharAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
