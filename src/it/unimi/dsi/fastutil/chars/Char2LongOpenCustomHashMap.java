...
Hash {
    ...
    implements Char2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2LongOpenCustomHashMap.this.n));
            }
            int pos = Char2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2LongOpenCustomHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
            ...
            if (Char2LongOpenCustomHashMap.this.containsNullKey) {
                entry.index = Char2LongOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Char2LongOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Char2LongOpenCustomHashMap.this.n);
                return true;
            }
            char[] key = Char2LongOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2LongOpenCustomHashMap.this.size - this.c), (long)((double)Char2LongOpenCustomHashMap.this.realSize() / (double)Char2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
