...
Hash {
    ...
    implements Char2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2ReferenceOpenCustomHashMap.this.n));
            }
            int pos = Char2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ReferenceOpenCustomHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
                entry.index = Char2ReferenceOpenCustomHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Char2ReferenceOpenCustomHashMap.this.value[index]);
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Char2ReferenceOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Char2ReferenceOpenCustomHashMap.this.n);
                return true;
            }
            char[] key = Char2ReferenceOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2ReferenceOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2ReferenceOpenCustomHashMap.this.size - this.c), (long)((double)Char2ReferenceOpenCustomHashMap.this.realSize() / (double)Char2ReferenceOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
