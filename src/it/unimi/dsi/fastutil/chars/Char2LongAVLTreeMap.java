    ...
    public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>(){
                ...
                {
                    this.comparator = Char2LongAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2LongAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
