...
Cloneable {
    ...
    public Char2ByteAVLTreeMap(SortedMap<Character, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Character, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Char2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey()) : (x, y) -> Char2ByteAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                }
