...
Hash {
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
            if (Char2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2DoubleOpenHashMap.this.n));
            }
            int pos = Char2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2DoubleOpenHashMap.this.key[pos] == '\u0000') continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2DoubleOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2DoubleOpenHashMap.this.size - this.c), (long)((double)Char2DoubleOpenHashMap.this.realSize() / (double)Char2DoubleOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
