...
Hash {
    ...
    public CharSpliterator spliterator() {
        return CharSpliterators.asSpliterator(this.iterator(), Size64.sizeOf(this), 337);
    }
    ...
    implements CharListIterator {
        ...
        public void remove() {
            ...
            if (this.prev == -1) {
                ...
                int n = this.prev;
                CharLinkedOpenCustomHashSet.this.link[n] = CharLinkedOpenCustomHashSet.this.link[n] ^ (CharLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
            }
            if (this.next == -1) {
                CharLinkedOpenCustomHashSet.this.last = this.prev;
            } else {
                int n = this.next;
                CharLinkedOpenCustomHashSet.this.link[n] = CharLinkedOpenCustomHashSet.this.link[n] ^ (CharLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L;
            }
            int pos = this.curr;
            this.curr = -1;
