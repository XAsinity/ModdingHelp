...
Hash {
    ...
    implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Char2ObjectOpenHashMap.this.n));
            }
            int pos = Char2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectOpenHashMap.this.key[pos] == '\u0000') continue;
        ...
        public void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            ...
            if (Char2ObjectOpenHashMap.this.containsNullKey) {
                entry.index = Char2ObjectOpenHashMap.this.n;
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept(Char2ObjectOpenHashMap.this.value[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Char2ObjectMap.Entry<V>>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Char2ObjectOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Char2ObjectOpenHashMap.this.n);
                return true;
            }
            char[] key = Char2ObjectOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Char2ObjectOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Char2ObjectOpenHashMap.this.size - this.c), (long)((double)Char2ObjectOpenHashMap.this.realSize() / (double)Char2ObjectOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
