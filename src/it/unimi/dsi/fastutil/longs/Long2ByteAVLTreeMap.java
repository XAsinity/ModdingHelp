...
Cloneable {
    ...
    public Long2ByteAVLTreeMap(SortedMap<Long, Byte> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Byte>)m);
    }
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(){
                ...
                {
                    this.comparator = Long2ByteAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ByteAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
