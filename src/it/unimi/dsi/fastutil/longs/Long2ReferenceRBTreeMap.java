...
Cloneable {
    ...
    public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Long2ReferenceRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ReferenceRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
    ...
    implements Serializable {
        ...
        public V get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2ReferenceRBTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$SubmapIterator - discarding signature.
         */
