        ...
        return new ObjectListIterator<long[]>(){
            ...
            public long[] next() {
                ...
                if (this.i % LongArrayFrontCodedList.this.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(LongArrayFrontCodedList.this.array, this.pos + (long)LongArrayFrontCodedList.count(length), this.s, 0, length);
                    ...
                    BigArrays.copyFromBig(LongArrayFrontCodedList.this.array, this.pos + (long)LongArrayFrontCodedList.count(length) + (long)LongArrayFrontCodedList.count(common), this.s, common, length);
