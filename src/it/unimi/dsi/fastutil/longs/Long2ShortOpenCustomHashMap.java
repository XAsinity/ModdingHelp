...
Hash {
    ...
    implements Long2ShortMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2ShortMap.Entry> consumer) {
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2ShortOpenCustomHashMap.this.n));
            }
            int pos = Long2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ShortOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    extends MapSpliterator<Consumer<? super Long2ShortMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2ShortOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2ShortOpenCustomHashMap.this.size - this.c), (long)((double)Long2ShortOpenCustomHashMap.this.realSize() / (double)Long2ShortOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
