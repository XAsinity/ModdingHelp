...
Cloneable {
    ...
    public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(){
                ...
                {
                    this.comparator = Long2ReferenceAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ReferenceAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
    ...
    implements Serializable {
        ...
        public V get(long k) {
            Entry e;
            long kk = k;
            return this.in(kk) && (e = Long2ReferenceAVLTreeMap.this.findKey(kk)) != null ? e.value : this.defRetValue;
        }
        ...
        public V put(long k, V v) {
            ...
            Object oldValue = Long2ReferenceAVLTreeMap.this.put(k, v);
