...
Hash {
    ...
    implements Long2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Long2ReferenceMap.Entry<V>> consumer) {
            if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2ReferenceOpenCustomHashMap.this.n));
            }
            int pos = Long2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ReferenceOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2ReferenceOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2ReferenceOpenCustomHashMap.this.size - this.c), (long)((double)Long2ReferenceOpenCustomHashMap.this.realSize() / (double)Long2ReferenceOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
