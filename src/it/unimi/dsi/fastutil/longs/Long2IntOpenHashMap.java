...
Hash {
    ...
    implements Long2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2IntMap.Entry> consumer) {
            if (Long2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2IntOpenHashMap.this.n));
            }
            int pos = Long2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2IntOpenHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2IntMap.Entry> consumer) {
            ...
            if (Long2IntOpenHashMap.this.containsNullKey) {
                entry.index = Long2IntOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2IntOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2IntOpenHashMap.this.n);
                return true;
            }
            long[] key = Long2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2IntOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2IntOpenHashMap.this.size - this.c), (long)((double)Long2IntOpenHashMap.this.realSize() / (double)Long2IntOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
