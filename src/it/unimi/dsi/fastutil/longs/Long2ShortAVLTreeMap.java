...
Cloneable {
    ...
    public Long2ShortAVLTreeMap(SortedMap<Long, Short> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Short>)m);
    }
    ...
    public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Long2ShortAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ShortAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
