...
Hash {
    ...
    implements LongSpliterator {
        ...
        public long estimateSize() {
            ...
            return Math.min((long)(LongOpenCustomHashSet.this.size - this.c), (long)((double)LongOpenCustomHashSet.this.realSize() / (double)LongOpenCustomHashSet.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
