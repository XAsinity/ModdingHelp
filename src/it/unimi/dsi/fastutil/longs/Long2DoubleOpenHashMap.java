...
Hash {
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
            if (Long2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2DoubleOpenHashMap.this.n));
            }
            int pos = Long2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2DoubleOpenHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
            ...
            if (Long2DoubleOpenHashMap.this.containsNullKey) {
                entry.index = Long2DoubleOpenHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2DoubleOpenHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2DoubleOpenHashMap.this.n);
                return true;
            }
            long[] key = Long2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2DoubleOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2DoubleOpenHashMap.this.size - this.c), (long)((double)Long2DoubleOpenHashMap.this.realSize() / (double)Long2DoubleOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
