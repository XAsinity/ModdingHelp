    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Long2FloatRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2FloatRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
