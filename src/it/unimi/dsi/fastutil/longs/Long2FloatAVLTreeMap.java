...
Cloneable {
    ...
    public Long2FloatAVLTreeMap(SortedMap<Long, Float> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Float>)m);
    }
    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                ...
                {
                    this.comparator = Long2FloatAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
