    ...
    public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>(){
                ...
                {
                    this.comparator = Long2LongRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2LongRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
