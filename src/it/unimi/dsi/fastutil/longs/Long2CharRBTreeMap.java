    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(){
                ...
                {
                    this.comparator = Long2CharRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2CharRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
