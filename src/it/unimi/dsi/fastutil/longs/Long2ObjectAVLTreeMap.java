...
Cloneable {
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(){
                ...
                {
                    this.comparator = Long2ObjectAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ObjectAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
    ...
    implements Serializable {
        ...
        /*
         * Signature claims super is it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap.SubmapIterator, not it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$SubmapIterator - discarding signature.
         */
