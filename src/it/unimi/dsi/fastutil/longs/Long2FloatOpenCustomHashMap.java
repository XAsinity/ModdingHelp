...
Hash {
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2FloatOpenCustomHashMap.this.n));
            }
            int pos = Long2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2FloatOpenCustomHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            ...
            if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.index = Long2FloatOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2FloatOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2FloatOpenCustomHashMap.this.n);
                return true;
            }
            long[] key = Long2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2FloatOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2FloatOpenCustomHashMap.this.size - this.c), (long)((double)Long2FloatOpenCustomHashMap.this.realSize() / (double)Long2FloatOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
