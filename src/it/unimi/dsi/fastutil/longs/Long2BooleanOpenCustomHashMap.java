...
Hash {
    ...
    implements Long2BooleanMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2BooleanOpenCustomHashMap.this.n));
            }
            int pos = Long2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2BooleanOpenCustomHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
            ...
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.index = Long2BooleanOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Long2BooleanMap.Entry>>
    ...
    extends MapSpliterator<Consumer<? super Long2BooleanMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2BooleanOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2BooleanOpenCustomHashMap.this.n);
                return true;
            }
            long[] key = Long2BooleanOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2BooleanOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2BooleanOpenCustomHashMap.this.size - this.c), (long)((double)Long2BooleanOpenCustomHashMap.this.realSize() / (double)Long2BooleanOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
