...
Hash {
    ...
    implements Long2IntMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2IntMap.Entry> consumer) {
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2IntOpenCustomHashMap.this.n));
            }
            int pos = Long2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2IntOpenCustomHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2IntMap.Entry> consumer) {
            ...
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                entry.index = Long2IntOpenCustomHashMap.this.n;
    ...
    extends MapIterator<Consumer<? super Long2IntMap.Entry>>
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index) {
            action.accept(Long2IntOpenCustomHashMap.this.value[index]);
        }
    ...
    implements LongSpliterator {
        ...
        final void acceptOnIndex(LongConsumer action, int index) {
            action.accept(Long2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    extends MapSpliterator<Consumer<? super Long2IntMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2IntOpenCustomHashMap.this.n;
            this.c = 0;
            this.mustReturnNull = Long2IntOpenCustomHashMap.this.containsNullKey;
            this.hasSplit = false;
        }
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2IntOpenCustomHashMap.this.n);
                return true;
            }
            long[] key = Long2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2IntOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2IntOpenCustomHashMap.this.size - this.c), (long)((double)Long2IntOpenCustomHashMap.this.realSize() / (double)Long2IntOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
