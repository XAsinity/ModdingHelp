...
Cloneable {
    ...
    public Long2IntAVLTreeMap(SortedMap<Long, Integer> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Integer>)m);
    }
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(){
                ...
                {
                    this.comparator = Long2IntAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2IntAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
