    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Long2DoubleRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2DoubleRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
