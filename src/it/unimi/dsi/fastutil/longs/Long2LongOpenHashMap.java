...
Hash {
    ...
    implements Long2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
            if (Long2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2LongOpenHashMap.this.n));
            }
            int pos = Long2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2LongOpenHashMap.this.key[pos] == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2LongOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2LongOpenHashMap.this.size - this.c), (long)((double)Long2LongOpenHashMap.this.realSize() / (double)Long2LongOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
