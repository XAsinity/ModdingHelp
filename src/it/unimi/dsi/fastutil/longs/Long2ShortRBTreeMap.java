    ...
    public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>(){
                ...
                {
                    this.comparator = Long2ShortRBTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2ShortRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
