...
Cloneable {
    ...
    public Long2DoubleAVLTreeMap(SortedMap<Long, Double> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Double>)m);
    }
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(){
                ...
                {
                    this.comparator = Long2DoubleAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2DoubleAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
