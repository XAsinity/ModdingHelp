...
Hash {
    ...
    implements Long2LongMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
            if (Long2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2LongOpenCustomHashMap.this.n));
            }
            int pos = Long2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2LongOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    extends MapSpliterator<Consumer<? super Long2LongMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2LongOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2LongOpenCustomHashMap.this.size - this.c), (long)((double)Long2LongOpenCustomHashMap.this.realSize() / (double)Long2LongOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
