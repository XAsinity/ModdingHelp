...
Hash {
    ...
    implements Long2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2ByteOpenCustomHashMap.this.n));
            }
            int pos = Long2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ByteOpenCustomHashMap.this.key[pos] == 0L) continue;
    ...
    extends MapSpliterator<Consumer<? super Long2ByteMap.Entry>, EntrySpliterator>
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2ByteOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2ByteOpenCustomHashMap.this.size - this.c), (long)((double)Long2ByteOpenCustomHashMap.this.realSize() / (double)Long2ByteOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
