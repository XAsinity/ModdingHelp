...
Cloneable {
    ...
    public Long2CharAVLTreeMap(SortedMap<Long, Character> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Character>)m);
    }
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(){
                ...
                {
                    this.comparator = Long2CharAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2CharAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
