...
Cloneable {
    ...
    public Long2BooleanAVLTreeMap(SortedMap<Long, Boolean> m) {
        this(m.comparator());
        this.putAll((Map<? extends Long, ? extends Boolean>)m);
    }
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(){
                ...
                {
                    this.comparator = Long2BooleanAVLTreeMap.this.actualComparator == null ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey()) : (x, y) -> Long2BooleanAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                }
