...
Hash {
    ...
    implements Long2CharMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2CharMap.Entry> consumer) {
            if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2CharOpenCustomHashMap.this.n));
            }
            int pos = Long2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2CharOpenCustomHashMap.this.key[pos] == 0L) continue;
        ...
        public void fastForEach(Consumer<? super Long2CharMap.Entry> consumer) {
            ...
            if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                entry.index = Long2CharOpenCustomHashMap.this.n;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.max = Long2CharOpenCustomHashMap.this.n;
            this.c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                ++this.c;
                this.acceptOnIndex(action, Long2CharOpenCustomHashMap.this.n);
                return true;
            }
            long[] key = Long2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2CharOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2CharOpenCustomHashMap.this.size - this.c), (long)((double)Long2CharOpenCustomHashMap.this.realSize() / (double)Long2CharOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
