...
Hash {
    ...
    implements Long2ByteMap.FastEntrySet {
        ...
        public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
            if (Long2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Long2ByteOpenHashMap.this.n));
            }
            int pos = Long2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ByteOpenHashMap.this.key[pos] == 0L) continue;
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Long2ByteOpenHashMap.this.size - this.c;
            }
            return Math.min((long)(Long2ByteOpenHashMap.this.size - this.c), (long)((double)Long2ByteOpenHashMap.this.realSize() / (double)Long2ByteOpenHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
