...
import ch.randelshofer.fastdoubleparser.ParseDigitsTaskCharSequence;
...
extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(CharSequence str, int offset, int length) {
        try {
            ...
            boolean isNegative;
            int index;
            int endIndex = JavaBigDecimalFromCharSequence.checkBounds(str.length(), offset, length);
            ...
            if ((ch | 0x20) == 101) {
                ...
                } while ((digit = (char)((ch = JavaBigDecimalFromCharSequence.charAt(str, ++index, endIndex)) - 48)) < '\n');
