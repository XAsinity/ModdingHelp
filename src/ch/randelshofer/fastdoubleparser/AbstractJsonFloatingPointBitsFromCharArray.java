...
extends AbstractFloatValueParser {
    ...
    public final long parseNumber(char[] str, int offset, int length) {
        ...
        boolean isNegative;
        int index = offset;
        int endIndex = AbstractFloatValueParser.checkBounds(str.length, offset, length);
        ...
        if ((ch | 0x20) == 101) {
            ...
            } while ((digit = (char)((ch = AbstractJsonFloatingPointBitsFromCharArray.charAt(str, ++index, endIndex)) - 48)) < '\n');
