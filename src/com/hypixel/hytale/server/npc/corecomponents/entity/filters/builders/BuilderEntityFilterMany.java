...
public abstract class BuilderEntityFilterMany
extends BuilderEntityFilterWithToggle {
    ...
    public Builder<IEntityFilter> readConfig(@Nonnull JsonElement data) {
        this.requireArray(data, "Filters", this.objectListHelper, ArrayNotEmptyValidator.get(), BuilderDescriptorState.Stable, "List of filters", null, this.validationHelper);
        return this;
    }
    ...
    public boolean validate(String configName, @Nonnull NPCLoadTimeValidationHelper validationHelper, @Nonnull ExecutionContext context, Scope globalScope, @Nonnull List<String> errors) {
        ...
        return result &= this.objectListHelper.validate(configName, validationHelper, this.builderManager, context, globalScope, errors);
    }
}
