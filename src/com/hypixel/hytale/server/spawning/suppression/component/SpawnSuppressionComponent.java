...
implements Component<EntityStore> {
    public static final BuilderCodec<SpawnSuppressionComponent> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(SpawnSuppressionComponent.class, SpawnSuppressionComponent::new).append(new KeyedCodec<String>("SpawnSuppression", Codec.STRING), (suppressor, s) -> {
        suppressor.spawnSuppression = s;
    }, suppressor -> suppressor.spawnSuppression).add()).build();
