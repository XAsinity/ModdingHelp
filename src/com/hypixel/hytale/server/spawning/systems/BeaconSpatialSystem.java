...
extends SpatialSystem<EntityStore> {
    private static final Query<EntityStore> QUERY = Query.and(SpawnBeacon.getComponentType(), FloodFillPositionSelector.getComponentType(), TransformComponent.getComponentType());
