...
extends FileMaskCache<BlockPlacementMask> {
    @Nonnull
    private final Map<BlockPlacementMask, BlockPlacementMask> masks = new HashMap<BlockPlacementMask, BlockPlacementMask>();
    @Nonnull
    private final Map<BlockPlacementMask.BlockArrayEntry, BlockPlacementMask.BlockArrayEntry> entries = new HashMap<BlockPlacementMask.BlockArrayEntry, BlockPlacementMask.BlockArrayEntry>();
