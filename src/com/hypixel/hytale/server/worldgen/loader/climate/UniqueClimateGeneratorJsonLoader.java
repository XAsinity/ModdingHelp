...
import com.hypixel.hytale.server.worldgen.loader.climate.UniqueClimateJsonLoader;
import java.nio.file.Path;
import javax.annotation.Nonnull;

public class UniqueClimateGeneratorJsonLoader<K extends SeedResource>
extends JsonLoader<K, UniqueClimateGenerator> {
    @Nonnull
    ...
    public UniqueClimateGenerator load() {
        if (this.array.isEmpty()) {
            return UniqueClimateGenerator.EMPTY;
        }
        return new UniqueClimateGenerator(this.loadEntries());
    }
