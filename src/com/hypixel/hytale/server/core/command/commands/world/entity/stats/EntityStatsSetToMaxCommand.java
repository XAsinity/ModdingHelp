...
extends AbstractTargetEntityCommand {
    @Nonnull
    private final RequiredArg<String> entityStatNameArg = this.withRequiredArg("statName", "server.commands.entity.stats.settomax.statName.desc", ArgTypes.STRING);
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull ObjectList<Ref<EntityStore>> entities, @Nonnull World world, @Nonnull Store<EntityStore> store) {
        ...
        EntityStatsSetToMaxCommand.setEntityStatMax(context, entities, entityStatName, store);
    }
