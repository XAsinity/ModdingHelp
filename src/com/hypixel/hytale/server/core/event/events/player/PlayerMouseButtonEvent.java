...
implements ICancellable {
    ...
    public String toString() {
        return "PlayerMouseButtonEvent{clientUseTime=" + this.clientUseTime + ", itemInHand=" + String.valueOf(this.itemInHand) + ", targetBlock=" + String.valueOf(this.targetBlock) + ", targetEntity=" + String.valueOf(this.targetEntity) + ", screenPoint=" + String.valueOf(this.screenPoint) + ", mouseButton=" + String.valueOf(this.mouseButton) + ", cancelled=" + this.cancelled + "} " + super.toString();
    }
}
