...
implements ICancellable {
    ...
    public String toString() {
        return "PlayerInteractEvent{actionType=" + String.valueOf((Object)this.actionType) + ", clientUseTime=" + this.clientUseTime + ", itemInHand=" + String.valueOf(this.itemInHand) + ", targetBlock=" + String.valueOf(this.targetBlock) + ", targetEntity=" + String.valueOf(this.targetEntity) + ", cancelled=" + this.cancelled + "} " + super.toString();
    }
}
