...
implements JsonAssetWithMap<String, DefaultAssetMap<String, BuilderToolItemReferenceAsset>> {
    ...
    public static DefaultAssetMap<String, BuilderToolItemReferenceAsset> getAssetMap() {
        return BuilderToolItemReferenceAsset.getAssetStore().getAssetMap();
    }
    ...
    static {
        CODEC = ((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(BuilderToolItemReferenceAsset.class, BuilderToolItemReferenceAsset::new, Codec.STRING, (t, k) -> {
            t.id = k;
        }, t -> t.id, (asset, data) -> {
            asset.data = data;
        }, asset -> asset.data).append(new KeyedCodec<T[]>("BuilderToolItems", new ArrayCodec<String>(Codec.STRING, String[]::new)), (i, itemIds) -> {
            i.itemIds = itemIds;
        }, i -> i.itemIds).add()).build();
    }
}
