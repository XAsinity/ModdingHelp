...
implements NetworkSerializable<com.hypixel.hytale.protocol.ParticleAttractor> {
    public static final BuilderCodec<ParticleAttractor> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ParticleAttractor.class, ParticleAttractor::new).addField(new KeyedCodec<Vector3f>("Position", ProtocolCodecs.VECTOR3F), (particleAttractor, o) -> {
        particleAttractor.position = o;
    }, particleAttractor -> particleAttractor.position)).addField(new KeyedCodec<Vector3f>("RadialAxis", ProtocolCodecs.VECTOR3F), (particleAttractor, o) -> {
        particleAttractor.radialAxis = o;
    }, particleAttractor -> particleAttractor.radialAxis)).append(new KeyedCodec<Float>("TrailPositionMultiplier", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.trailPositionMultiplier = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.trailPositionMultiplier)).addValidator(Validators.range(Float.valueOf(0.0f), Float.valueOf(1.0f))).add()).addField(new KeyedCodec<Float>("Radius", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.radius = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.radius))).addField(new KeyedCodec<Float>("RadialAcceleration", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.radialAcceleration = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.radialAcceleration))).addField(new KeyedCodec<Float>("RadialTangentAcceleration", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.radialTangentAcceleration = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.radialTangentAcceleration))).addField(new KeyedCodec<Vector3f>("LinearAcceleration", ProtocolCodecs.VECTOR3F), (particleAttractor, o) -> {
        particleAttractor.linearAcceleration = o;
    }, particleAttractor -> particleAttractor.linearAcceleration)).addField(new KeyedCodec<Float>("RadialImpulse", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.radialImpulse = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.radialImpulse))).addField(new KeyedCodec<Float>("RadialTangentImpulse", Codec.FLOAT), (particleAttractor, f) -> {
        particleAttractor.radialTangentImpulse = f.floatValue();
    }, particleAttractor -> Float.valueOf(particleAttractor.radialTangentImpulse))).addField(new KeyedCodec<Vector3f>("LinearImpulse", ProtocolCodecs.VECTOR3F), (particleAttractor, o) -> {
        particleAttractor.linearImpulse = o;
    }, particleAttractor -> particleAttractor.linearImpulse)).addField(new KeyedCodec<Vector3f>("DampingMultiplier", ProtocolCodecs.VECTOR3F), (particleAttractor, o) -> {
        particleAttractor.dampingMultiplier = o;
    }, particleAttractor -> particleAttractor.dampingMultiplier)).build();
