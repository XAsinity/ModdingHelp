...
public class PhysicsDropType {
    public static final BuilderCodec<PhysicsDropType> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PhysicsDropType.class, PhysicsDropType::new).append(new KeyedCodec<String>("ItemId", Codec.STRING), (softBlock, o) -> {
        softBlock.itemId = o;
    ...
    }, softBlock -> softBlock.dropListId).addValidatorLate(() -> ItemDropList.VALIDATOR_CACHE.getValidator().late()).add()).build();
