...
public class EmptyItemDropContainer
extends ItemDropContainer {
    public static final BuilderCodec<EmptyItemDropContainer> CODEC = BuilderCodec.builder(EmptyItemDropContainer.class, EmptyItemDropContainer::new, ItemDropContainer.DEFAULT_CODEC).build();
