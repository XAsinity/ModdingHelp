...
NetworkSerializable<com.hypixel.hytale.protocol.TagPattern> {
    public static final AssetCodecMapCodec<String, TagPattern> CODEC = new AssetCodecMapCodec<String, TagPattern>("Op", Codec.STRING, (t, k) -> {
        t.id = k;
    }, t -> t.id, (t, data) -> {
        t.data = data;
    }, t -> t.data);
    ...
    public static IndexedLookupTableAssetMap<String, TagPattern> getAssetMap() {
        return TagPattern.getAssetStore().getAssetMap();
    }
