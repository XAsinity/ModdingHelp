...
implements NetworkSerializable<com.hypixel.hytale.protocol.BlockSelectorToolData> {
    public static final BuilderCodec<BlockSelectorToolData> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(BlockSelectorToolData.class, BlockSelectorToolData::new).append(new KeyedCodec<Double>("DurabilityLossOnUse", Codec.DOUBLE), (data, x) -> {
        data.durabilityLossOnUse = x.floatValue();
    }, data -> data.durabilityLossOnUse).add()).build();
