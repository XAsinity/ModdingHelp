...
public class PatchStyle {
    public static final BuilderCodec<PatchStyle> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PatchStyle.class, PatchStyle::new).addField(new KeyedCodec<String>("TexturePath", ValueCodec.STRING), (p, t) -> {
        p.texturePath = t;
    }, p -> p.texturePath)).addField(new KeyedCodec<Integer>("Border", ValueCodec.INTEGER), (p, t) -> {
        p.border = t;
    }, p -> p.border)).addField(new KeyedCodec<Integer>("HorizonzalBorder", ValueCodec.INTEGER), (p, t) -> {
        p.horizontalBorder = t;
    }, p -> p.horizontalBorder)).addField(new KeyedCodec<Integer>("VerticalBorder", ValueCodec.INTEGER), (p, t) -> {
        p.verticalBorder = t;
    }, p -> p.verticalBorder)).addField(new KeyedCodec<String>("Color", ValueCodec.STRING), (p, t) -> {
        p.color = t;
    }, p -> p.color)).addField(new KeyedCodec<Area>("Area", new ValueCodec<Area>(Area.CODEC)), (p, t) -> {
        p.area = t;
    }, p -> p.area)).build();
