...
extends Condition {
    @Nonnull
    public static final BuilderCodec<SprintingCondition> CODEC = BuilderCodec.builder(SprintingCondition.class, SprintingCondition::new, Condition.BASE_CODEC).build();
