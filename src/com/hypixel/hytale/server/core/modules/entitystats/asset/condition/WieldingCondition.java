...
extends Condition {
    @Nonnull
    public static final BuilderCodec<WieldingCondition> CODEC = BuilderCodec.builder(WieldingCondition.class, WieldingCondition::new, Condition.BASE_CODEC).build();
