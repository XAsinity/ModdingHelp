...
implements Component<EntityStore> {
    public static final BuilderCodec<FromWorldGen> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(FromWorldGen.class, FromWorldGen::new).append(new KeyedCodec<Integer>("WorldGenId", Codec.INTEGER), (fromWorldGen, i) -> {
        fromWorldGen.worldGenId = i;
    }, fromWorldGen -> fromWorldGen.worldGenId).add()).build();
