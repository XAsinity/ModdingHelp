...
extends SpatialSystem<EntityStore> {
    public static final Query<EntityStore> QUERY = Query.and(TransformComponent.getComponentType(), Query.not(Intangible.getComponentType()), Query.not(Player.getComponentType()));
