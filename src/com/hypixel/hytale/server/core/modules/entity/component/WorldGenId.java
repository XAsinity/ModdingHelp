...
implements Component<EntityStore> {
    ...
    public static final BuilderCodec<WorldGenId> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(WorldGenId.class, WorldGenId::new).append(new KeyedCodec<Integer>("WorldGenId", Codec.INTEGER), (worldGenId, i) -> {
        worldGenId.worldGenId = i;
    }, worldGenId -> worldGenId.worldGenId).add()).build();
