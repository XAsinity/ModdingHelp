...
extends SimpleBlockInteraction {
    ...
    public int serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.tags != null) {
            ...
            for (BlockMatcher item : (BlockMatcher[])this.tags) {
    ...
    public BlockConditionInteraction clone() {
        ...
        copy.matchers = this.matchers != null ? (BlockMatcher[])Arrays.stream(this.matchers).map(e -> e.clone()).toArray(BlockMatcher[]::new) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BlockConditionInteraction)) {
            return false;
        }
