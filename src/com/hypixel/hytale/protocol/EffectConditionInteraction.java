...
extends SimpleInteraction {
    ...
    public static EffectConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 0x20) != 0) {
            ...
            for (i = 0; i < entityEffectsCount; ++i) {
    ...
    public int serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.entityEffects != null) {
            ...
            for (Object item : (Object)this.entityEffects) {
                buf.writeIntLE((int)item);
            }
        } else {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 0x20) != 0) {
            ...
            pos = offset + 45 + entityEffectsOffset;
            if (pos >= buffer.writerIndex()) {
            ...
            pos += VarInt.length(buffer, pos);
            if ((pos += entityEffectsCount * 4) > buffer.writerIndex()) {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode((Object)this.match);
