...
extends SimpleInteraction {
    ...
    public static IncrementCooldownInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        boolean bl = obj.cooldownIncrementInterrupt = buf.getByte(offset + 31) != 0;
        if ((nullBits & 1) != 0) {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 0x20) != 0) {
            ...
            pos = offset + 56 + cooldownIdOffset;
            if (pos >= buffer.writerIndex()) {
            ...
            pos += VarInt.length(buffer, pos);
            if ((pos += cooldownIdLen) > buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof IncrementCooldownInteraction)) {
            return false;
        }
