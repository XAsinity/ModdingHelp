...
public class GradientNoiseProperty
implements NoiseProperty {
    ...
    public double get(int seed, double x, double y) {
        ...
        return switch (this.mode.ordinal()) {
            ...
            case 1 -> GradientNoiseProperty.getAngle(dx, dy);
            case 2 -> GradientNoiseProperty.getAbsAngle(dx, dy);
            case 0 -> GradientNoiseProperty.getMagnitude(dx, dy, this.invNormalize);
        };
    }
    ...
    protected static double getAngle(double dx, double dy) {
        ...
        return GradientNoiseProperty.convertRange(angle);
    }
    ...
    protected static float convertRange(float angle) {
        return (angle += 0.125f) > 1.0f ? angle - 1.0f : angle;
    }
