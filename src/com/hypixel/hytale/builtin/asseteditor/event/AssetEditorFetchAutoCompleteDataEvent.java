...
implements IAsyncEvent<String> {
    ...
    public String toString() {
        return "AssetEditorFetchAutoCompleteDataEvent{editorClient=" + String.valueOf(this.editorClient) + ", dataSet='" + this.dataSet + "', query='" + this.query + "', results=" + Arrays.toString(this.results) + "}";
    }
}
