...
extends AbstractTargetPlayerCommand {
    ...
    @Nonnull
    private final RequiredArg<ReputationGroup> reputationGroupIdArg = this.withRequiredArg("reputationGroupId", "server.commands.reputation.set.reputationGroupId.desc", REPUTATION_GROUP_ARG_TYPE);
    @Nonnull
