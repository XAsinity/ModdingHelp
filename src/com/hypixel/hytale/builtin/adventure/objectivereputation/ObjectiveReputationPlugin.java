...
import com.hypixel.hytale.builtin.adventure.objectivereputation.ReputationCompletion;
...
extends JavaPlugin {
    ...
    protected void setup() {
        instance = this;
        ObjectiveRewardHistoryData.CODEC.register("Reputation", (Class<ObjectiveRewardHistoryData>)ReputationObjectiveRewardHistoryData.class, (Codec<ObjectiveRewardHistoryData>)ReputationObjectiveRewardHistoryData.CODEC);
