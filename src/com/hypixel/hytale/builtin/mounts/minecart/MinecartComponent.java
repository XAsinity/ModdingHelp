...
implements Component<EntityStore> {
    public static final BuilderCodec<MinecartComponent> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MinecartComponent.class, MinecartComponent::new).append(new KeyedCodec<String>("SourceItem", Codec.STRING), (o, v) -> {
        o.sourceItem = v;
    }, o -> o.sourceItem).add()).build();
