...
public class MacroCommandParameter {
    public static final BuilderCodec<MacroCommandParameter> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(MacroCommandParameter.class, MacroCommandParameter::new).append(new KeyedCodec<String>("Name", Codec.STRING, true), (macroParameter, name) -> {
        ...
        macroParameter.description = description;
    }, macroParameter -> macroParameter.description).add()).append(new KeyedCodec<ParameterRequirement>("Requirement", new EnumCodec<ParameterRequirement>(ParameterRequirement.class), true), (macroParameter, requirement) -> {
        macroParameter.requirement = requirement;
    }, macroParameter -> macroParameter.requirement).add()).append(new KeyedCodec<ArgumentTypeEnum>("ArgType", new EnumCodec<ArgumentTypeEnum>(ArgumentTypeEnum.class)), (macroParameter, argumentType) -> {
        macroParameter.argumentType = argumentType;
    }, macroParameter -> macroParameter.argumentType).add()).append(new KeyedCodec<String>("DefaultValue", Codec.STRING), (macroParameter, defaultValue) -> {
        macroParameter.defaultValue = defaultValue;
    }, macroParameter -> macroParameter.defaultValue).add()).append(new KeyedCodec<String>("DefaultValueDescription", Codec.STRING), (macroParameter, defaultValueDescription) -> {
        macroParameter.defaultValueDescription = defaultValueDescription;
    }, macroParameter -> macroParameter.defaultValueDescription).add()).build();
    private String name;
