...
extends SequenceBrushOperation {
    public static final BuilderCodec<SaveIndexOperation> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(SaveIndexOperation.class, SaveIndexOperation::new).append(new KeyedCodec<String>("StoredIndexName", Codec.STRING), (op, val) -> {
        op.variableNameArg = val;
    }, op -> op.variableNameArg).documentation("The name to store the current execution index at").add()).documentation("Mark this spot in the stack in order to loop or jump to it")).build();
    @Nonnull
