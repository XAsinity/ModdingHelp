...
extends SequenceBrushOperation {
    public static final BuilderCodec<ShapeOperation> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ShapeOperation.class, ShapeOperation::new).append(new KeyedCodec<BrushShape>("Shape", new EnumCodec<BrushShape>(BrushShape.class)), (op, val) -> {
