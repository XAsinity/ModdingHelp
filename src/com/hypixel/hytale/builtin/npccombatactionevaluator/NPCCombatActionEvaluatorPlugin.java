...
extends JavaPlugin {
    ...
    protected void setup() {
        ...
        AssetRegistry.register(((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)((HytaleAssetStore.Builder)HytaleAssetStore.builder(CombatActionOption.class, new IndexedLookupTableAssetMap(CombatActionOption[]::new)).setPath("NPC/DecisionMaking/CombatActions")).setCodec((AssetCodec)CombatActionOption.CODEC)).setKeyFunction(CombatActionOption::getId)).setReplaceOnRemove(CombatActionOption::getNothingFor)).loadsAfter(Item.class, Condition.class, RootInteraction.class)).loadsBefore(BalanceAsset.class)).build());
