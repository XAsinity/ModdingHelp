...
extends AbstractWorldCommand {
    @Nonnull
    private final EntityWrappedArg entityIdArg = this.withOptionalArg("entityId", "server.commands.npcpath.update.observationAngle.entityId.desc", ArgTypes.ENTITY_ID);
    @Nonnull
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull World world, @Nonnull Store<EntityStore> store) {
        ...
        marker.setObservationAngle(angleDegrees.floatValue() * ((float)Math.PI / 180));
