...
extends Schema {
    public static final BuilderCodec<StringSchema> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(StringSchema.class, StringSchema::new, Schema.BASE_CODEC).addField(new KeyedCodec<String>("pattern", Codec.STRING, false, true), (o, i) -> {
        o.pattern = i;
    }, o -> o.pattern)).addField(new KeyedCodec<T[]>("enum", Codec.STRING_ARRAY, false, true), (o, i) -> {
        o.enum_ = i;
    }, o -> o.enum_)).addField(new KeyedCodec<String>("const", Codec.STRING, false, true), (o, i) -> {
        o.const_ = i;
    }, o -> o.const_)).addField(new KeyedCodec<String>("default", Codec.STRING, false, true), (o, i) -> {
        o.default_ = i;
    }, o -> o.default_)).addField(new KeyedCodec<Integer>("minLength", Codec.INTEGER, false, true), (o, i) -> {
        o.minLength = i;
    }, o -> o.minLength)).addField(new KeyedCodec<Integer>("maxLength", Codec.INTEGER, false, true), (o, i) -> {
        o.maxLength = i;
    }, o -> o.maxLength)).addField(new KeyedCodec<CommonAsset>("hytaleCommonAsset", CommonAsset.CODEC, false, true), (o, i) -> {
        o.hytaleCommonAsset = i;
    }, o -> o.hytaleCommonAsset)).addField(new KeyedCodec<String>("hytaleCosmeticAsset", Codec.STRING, false, true), (o, i) -> {
        o.hytaleCosmeticAsset = i;
    }, o -> o.hytaleCosmeticAsset)).build();
    ...
    public static class CommonAsset {
        public static final BuilderCodec<CommonAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CommonAsset.class, CommonAsset::new).addField(new KeyedCodec<T[]>("requiredRoots", Codec.STRING_ARRAY, false, true), (o, i) -> {
            o.requiredRoots = i;
        }, o -> o.requiredRoots)).addField(new KeyedCodec<String>("requiredExtension", Codec.STRING, false, true), (o, i) -> {
            o.requiredExtension = i;
        }, o -> o.requiredExtension)).addField(new KeyedCodec<Boolean>("isUIAsset", Codec.BOOLEAN, false, true), (o, i) -> {
            o.isUIAsset = i;
        }, o -> o.isUIAsset)).build();
