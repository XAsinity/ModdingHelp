...
import com.hypixel.fastutil.bytes.Byte2ObjectOperator;
...
public class Byte2ObjectConcurrentHashMap<V> {
    ...
    public Byte2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, byte emptyValue) {
        ...
        this.sizeCtl = cap = initialCapacity >= 0x20000000 ? 0x40000000 : Byte2ObjectConcurrentHashMap.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
        this.EMPTY = emptyValue;
    }
    ...
    public Byte2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, byte emptyValue) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 0x40000000 : Byte2ObjectConcurrentHashMap.tableSizeFor((int)size);
        this.EMPTY = emptyValue;
    }
    ...
    public V get(byte key) {
        ...
        int h = Byte2ObjectConcurrentHashMap.spread(Byte.hashCode(key));
        Node<V>[] tab = this.table;
        if (this.table != null && (n = tab.length) > 0 && (e = Byte2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) != null) {
            byte ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
        ...
        block14: {
            ...
            do {
                ...
                while (true) {
                    ...
                    p = Byte2ObjectConcurrentHashMap.tabAt(t, i);
                    if (p != null && p.hash < 0) {
    ...
    protected final V putVal(byte key, V value, boolean onlyIfAbsent) {
        ...
        block20: {
            ...
            int hash = Byte2ObjectConcurrentHashMap.spread(Byte.hashCode(key));
            binCount = 0;
            Node<V>[] tab = this.table;
            while (true) {
                int n;
                ...
                i = n - 1 & hash;
                Node<V> f = Byte2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Byte2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, hash, key, value, null))) continue;
                    break block20;
                }
                int fh = f.hash;
                if (fh == -1) {
                ...
                synchronized (node) {
                    block21: {
                        if (Byte2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<V> e = f;
                                while (true) {
    ...
    public void putAll(Byte2ObjectConcurrentHashMap<? extends V> m) {
        ...
        for (Byte2ObjectMap.Entry entry : m.byte2ObjectEntrySet()) {
            this.putVal(entry.getByteKey(), entry.getValue(), false);
        }
    }
    ...
    protected final V replaceNode(byte key, V value, Object cv) {
        ...
        int hash = Byte2ObjectConcurrentHashMap.spread(Byte.hashCode(key));
        Node<V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f = Byte2ObjectConcurrentHashMap.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f);
                continue;
                            ...
                            if (e.hash == hash && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (cv == null || cv == ev || ev != null && cv.equals(ev)) {
                                    ...
                                    if (value != null) {
                                        ...
                                        Byte2ObjectConcurrentHashMap.setTabAt(tab, i, e.next);
                                    }
                                }
                                break;
                            }
                        ...
                        if (r != null && (p = r.findTreeNode(hash, key, null)) != null) {
                            ...
                            if (cv == null || cv == pv || pv != null && cv.equals(pv)) {
                                ...
                                if (value != null) {
                                    ...
                                    Byte2ObjectConcurrentHashMap.setTabAt(tab, i, this.untreeify(t.first));
                                }
                            }
                        }
                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (Byte2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    ...
                    Byte2ObjectConcurrentHashMap.setTabAt(tab, i++, null);
                }
            }
        }
        if (delta != 0L) {
        ...
        block31: {
            ...
            while (true) {
                ...
                if (f == null) {
                    ...
                    synchronized (node) {
                        if (Byte2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            binCount = 1;
                            ...
                            try {
                                ...
                                Byte2ObjectConcurrentHashMap.setTabAt(tab, i, node2);
                            }
                        }
                    }
                            ...
                            if (e.hash == h && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (val != null) {
                                    ...
                                    if (pred != null) {
                                        ...
                                        Byte2ObjectConcurrentHashMap.setTabAt(tab, i, en);
                                    }
                                }
                            } else {
                                pred = e;
                    ...
                    synchronized (reservationNode) {
                        if (Byte2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            ...
                            try {
                                ...
                                Byte2ObjectConcurrentHashMap.setTabAt(tab, i, node);
                            }
                        }
                    }
                    if (binCount == 0) continue;
    ...
    public V merge(byte key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        block27: {
            ...
            while (true) {
                ...
                Node<V> f = Byte2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Byte2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, h, key, value, null))) continue;
                    delta = 1;
                    val = value;
                    break block27;
                }
    ...
    public static ByteSet newKeySet() {
        return new KeySetView<Boolean>(new Byte2ObjectConcurrentHashMap(), Boolean.TRUE);
    }
    ...
    protected final void addCount(long x, int check) {
        ...
        if (check >= 0) {
            ...
            while (s >= (long)(sc = this.sizeCtl)) {
                ...
                int rs = Byte2ObjectConcurrentHashMap.resizeStamp(n);
                if (sc < 0) {
    ...
    protected final Node<V>[] helpTransfer(Node<V>[] tab, Node<V> f) {
        if (tab != null && f instanceof ForwardingNode) {
            ...
            if (((ForwardingNode)f).nextTable != null) {
                int sc;
                int rs = Byte2ObjectConcurrentHashMap.resizeStamp(tab.length);
    ...
    protected final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 0x20000000 ? 0x40000000 : Byte2ObjectConcurrentHashMap.tableSizeFor(size + (size >>> 1) + 1);
        while ((sc = this.sizeCtl) >= 0) {
            ...
            int rs = Byte2ObjectConcurrentHashMap.resizeStamp(n2);
            if (sc < 0) {
                if (sc >>> RESIZE_STAMP_SHIFT != rs || sc == rs + 1 || sc == rs + MAX_RESIZERS) break;
                Node<V>[] nt = this.nextTable;
                if (this.nextTable == null || this.transferIndex <= 0) break;
    ...
    protected final void transfer(Node<V>[] tab, Node<V>[] nextTab) {
        ...
        while (true) {
            ...
            if (i < 0 || i >= n || i + n >= nextn) {
                ...
                int sc = this.sizeCtl;
                if (!U.compareAndSwapInt(this, SIZECTL, sc, sc - 1)) continue;
                if (sc - 2 != Byte2ObjectConcurrentHashMap.resizeStamp(n) << RESIZE_STAMP_SHIFT) {
                    return;
                }
                advance = true;
                finishing = true;
            ...
            TreeBin f = Byte2ObjectConcurrentHashMap.tabAt(tab, i);
            if (f == null) {
                advance = Byte2ObjectConcurrentHashMap.casTabAt(tab, i, null, fwd);
                continue;
            }
            int fh = f.hash;
            if (fh == -1) {
            ...
            synchronized (treeBin) {
                if (Byte2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    if (fh >= 0) {
                        ...
                        Byte2ObjectConcurrentHashMap.setTabAt(nextTab, i, ln);
                        Byte2ObjectConcurrentHashMap.setTabAt(nextTab, i + n, hn);
                        Byte2ObjectConcurrentHashMap.setTabAt(tab, i, fwd);
                        advance = true;
                    } else if (f instanceof TreeBin) {
                        TreeBin ln;
                        TreeBin t = f;
    ...
    protected final void treeifyBin(Node<V>[] tab, int index) {
        if (tab != null) {
            ...
            if (n < 64) {
                ...
                Node<V> b = Byte2ObjectConcurrentHashMap.tabAt(tab, index);
                if (b != null && b.hash >= 0) {
                    Node<V> node = b;
                    synchronized (node) {
                        if (Byte2ObjectConcurrentHashMap.tabAt(tab, index) == b) {
                            TreeNode hd = null;
                            TreeNode tl = null;
                            Node<V> e = b;
                            while (e != null) {
                            ...
                            Byte2ObjectConcurrentHashMap.setTabAt(tab, index, new TreeBin(this.EMPTY, hd));
                        }
                    }
                }
            }
    ...
    public V valueMatching(Predicate<V> predicate) {
        ...
        block0: while (next != null || !b) {
            ...
            while (true) {
                ...
                e = Byte2ObjectConcurrentHashMap.tabAt(t, i);
                if (e != null && e.hash < 0) {
    ...
    static {
        try {
            ...
            U = (Unsafe)f.get(null);
            Class<Byte2ObjectConcurrentHashMap> k = Byte2ObjectConcurrentHashMap.class;
    ...
    implements Entry<V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!empty && this.key != ((Entry)o).getByteKey()) {
                    return false;
                }
    ...
    extends Node<V> {
        ...
        protected Node<V> find(int h, byte k) {
            ...
            block0: while (true) {
                Node<V> e;
                int n;
                if (k == this.EMPTY || tab == null || (n = tab.length) == 0 || (e = Byte2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) == null) {
                    return null;
                }
                do {
                    byte ek;
    ...
    Serializable {
        ...
        public final ObjectIterator<V> iterator() {
            Byte2ObjectConcurrentHashMap m = this.map;
            Node<V>[] t = m.table;
            int f = m.table == null ? 0 : t.length;
    ...
    extends CollectionView<V, Byte2ObjectMap.Entry<V>>
    ...
    @FunctionalInterface
    public static interface ByteObjConsumer<V> {
        public void accept(byte var1, V var2);
    }

    @FunctionalInterface
    public static interface ByteBiObjConsumer<V, X> {
        public void accept(byte var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface ByteTriObjConsumer<V, X, Y> {
        public void accept(byte var1, V var2, X var3, Y var4);
    }

    @FunctionalInterface
    public static interface ByteObjByteConsumer<V> {
        public void accept(byte var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface ByteObjShortConsumer<V> {
        public void accept(byte var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface ByteObjIntConsumer<V> {
        public void accept(byte var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface ByteObjLongConsumer<V> {
        public void accept(byte var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface ByteObjFloatConsumer<V> {
        public void accept(byte var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface ByteObjDoubleConsumer<V> {
        public void accept(byte var1, V var2, double var3);
    }

    @FunctionalInterface
    public static interface ByteBiObjByteConsumer<V, X> {
        public void accept(byte var1, V var2, byte var3, X var4);
    }

    @FunctionalInterface
    public static interface ByteBiObjShortConsumer<V, X> {
        public void accept(byte var1, V var2, short var3, X var4);
    }

    @FunctionalInterface
    public static interface ByteBiObjIntConsumer<V, X> {
        public void accept(byte var1, V var2, int var3, X var4);
    }

    @FunctionalInterface
    public static interface ByteBiObjLongConsumer<V, X> {
        public void accept(byte var1, V var2, long var3, X var5);
    }

    @FunctionalInterface
    public static interface ByteBiObjFloatConsumer<V, X> {
        public void accept(byte var1, V var2, float var3, X var4);
    }

    @FunctionalInterface
    public static interface ByteBiObjDoubleConsumer<V, X> {
        public void accept(byte var1, V var2, double var3, X var5);
    }
    ...
    public static interface ByteFunction<R> {
        public R apply(byte var1);
    }

    @FunctionalInterface
    public static interface ByteObjFunction<V, J> {
        public J apply(byte var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            ByteObjConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            ByteObjFunction transformer = this.transformer;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            ...
            ByteObjFunction searchFunction = this.searchFunction;
    ...
    @FunctionalInterface
    public static interface ByteBiObjFunction<V, X, J> {
        public J apply(byte var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface ByteObjByteFunction<V, J> {
        public J apply(byte var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface ByteObjShortFunction<V, J> {
        public J apply(byte var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface ByteObjIntFunction<V, J> {
        public J apply(byte var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface ByteObjLongFunction<V, J> {
        public J apply(byte var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface ByteObjFloatFunction<V, J> {
        public J apply(byte var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface ByteObjDoubleFunction<V, J> {
        public J apply(byte var1, V var2, double var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToDoubleByteObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToDoubleByteObjFunction<V> {
        public double applyAsDouble(byte var1, V var2);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToLongByteObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToLongByteObjFunction<V> {
        public long applyAsLong(byte var1, V var2);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToIntByteObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToIntByteObjFunction<V> {
        public int applyAsInt(byte var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            ByteFunction<U> transformer = this.transformer;
            if (transformer != null && (action = this.action) != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            AtomicReference<U> result;
            ByteFunction<U> searchFunction = this.searchFunction;
            if (searchFunction != null && (result = this.result) != null) {
                int f;
                int h;
                int i = this.baseIndex;
    ...
    extends ByteReturningBulkTask2<V> {
        public final byte EMPTY;
        ...
        @Override
        public final void compute() {
            ByteReduceTaskOperator reducer = this.reducer;
            if (reducer != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ByteReduceTaskOperator {
        public byte reduce(byte var1, byte var2, byte var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            DoubleBinaryOperator reducer;
            ByteToDoubleFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ByteToDoubleFunction {
        public double applyAsDouble(byte var1);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            LongBinaryOperator reducer;
            ByteToLongFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ByteToLongFunction {
        public long applyAsLong(byte var1);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            IntBinaryOperator reducer;
            ByteToIntFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ByteToIntFunction {
        public int applyAsInt(byte var1);
    }
    ...
    extends Byte2ObjectMap.Entry<V> {
        public boolean isEmpty();
    ...
    protected static abstract class ByteReturningBulkTask2<V>
    ...
    implements ByteSpliterator {
        ...
        public boolean tryAdvance(Consumer<? super Byte> action) {
            if (action instanceof ByteConsumer) {
                return this.tryAdvance((ByteConsumer)action);
            }
            return this.tryAdvance((byte value) -> action.accept(value));
        }
    ...
    implements Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!this.empty && this.key != ((Entry)o).getByteKey()) {
                    return false;
                }
                return this.val.equals(((Entry)o).getValue());
            }
