...
import com.hypixel.fastutil.doubles.Double2ObjectOperator;
...
public class Double2ObjectConcurrentHashMap<V> {
    ...
    public Double2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, double emptyValue) {
        ...
        this.sizeCtl = cap = initialCapacity >= 0x20000000 ? 0x40000000 : Double2ObjectConcurrentHashMap.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
        this.EMPTY = emptyValue;
    }
    ...
    public Double2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, double emptyValue) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 0x40000000 : Double2ObjectConcurrentHashMap.tableSizeFor((int)size);
        this.EMPTY = emptyValue;
    }
    ...
    public V get(double key) {
        ...
        int h = Double2ObjectConcurrentHashMap.spread(Double.hashCode(key));
        Node<V>[] tab = this.table;
        if (this.table != null && (n = tab.length) > 0 && (e = Double2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) != null) {
            double ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
        ...
        block14: {
            ...
            do {
                ...
                while (true) {
                    ...
                    p = Double2ObjectConcurrentHashMap.tabAt(t, i);
                    if (p != null && p.hash < 0) {
    ...
    protected final V putVal(double key, V value, boolean onlyIfAbsent) {
        ...
        block20: {
            ...
            int hash = Double2ObjectConcurrentHashMap.spread(Double.hashCode(key));
            binCount = 0;
            Node<V>[] tab = this.table;
            while (true) {
                int n;
                ...
                i = n - 1 & hash;
                Node<V> f = Double2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Double2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, hash, key, value, null))) continue;
                    break block20;
                }
                int fh = f.hash;
                if (fh == -1) {
                ...
                synchronized (node) {
                    block21: {
                        if (Double2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<V> e = f;
                                while (true) {
    ...
    public void putAll(Double2ObjectConcurrentHashMap<? extends V> m) {
        ...
        for (Double2ObjectMap.Entry entry : m.double2ObjectEntrySet()) {
            this.putVal(entry.getDoubleKey(), entry.getValue(), false);
        }
    }
    ...
    protected final V replaceNode(double key, V value, Object cv) {
        ...
        int hash = Double2ObjectConcurrentHashMap.spread(Double.hashCode(key));
        Node<V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f = Double2ObjectConcurrentHashMap.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f);
                continue;
                            ...
                            if (e.hash == hash && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (cv == null || cv == ev || ev != null && cv.equals(ev)) {
                                    ...
                                    if (value != null) {
                                        ...
                                        Double2ObjectConcurrentHashMap.setTabAt(tab, i, e.next);
                                    }
                                }
                                break;
                            }
                        ...
                        if (r != null && (p = r.findTreeNode(hash, key, null)) != null) {
                            ...
                            if (cv == null || cv == pv || pv != null && cv.equals(pv)) {
                                ...
                                if (value != null) {
                                    ...
                                    Double2ObjectConcurrentHashMap.setTabAt(tab, i, this.untreeify(t.first));
                                }
                            }
                        }
                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (Double2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    ...
                    Double2ObjectConcurrentHashMap.setTabAt(tab, i++, null);
                }
            }
        }
        if (delta != 0L) {
        ...
        block31: {
            ...
            while (true) {
                ...
                if (f == null) {
                    ...
                    synchronized (node) {
                        if (Double2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            binCount = 1;
                            ...
                            try {
                                ...
                                Double2ObjectConcurrentHashMap.setTabAt(tab, i, node2);
                            }
                        }
                    }
                            ...
                            if (e.hash == h && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (val != null) {
                                    ...
                                    if (pred != null) {
                                        ...
                                        Double2ObjectConcurrentHashMap.setTabAt(tab, i, en);
                                    }
                                }
                            } else {
                                pred = e;
                    ...
                    synchronized (reservationNode) {
                        if (Double2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            ...
                            try {
                                ...
                                Double2ObjectConcurrentHashMap.setTabAt(tab, i, node);
                            }
                        }
                    }
                    if (binCount == 0) continue;
    ...
    public V merge(double key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        block27: {
            ...
            while (true) {
                ...
                Node<V> f = Double2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Double2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, h, key, value, null))) continue;
                    delta = 1;
                    val = value;
                    break block27;
                }
    ...
    public static DoubleSet newKeySet() {
        return new KeySetView<Boolean>(new Double2ObjectConcurrentHashMap(), Boolean.TRUE);
    }
    ...
    protected final void addCount(long x, int check) {
        ...
        if (check >= 0) {
            ...
            while (s >= (long)(sc = this.sizeCtl)) {
                ...
                int rs = Double2ObjectConcurrentHashMap.resizeStamp(n);
                if (sc < 0) {
    ...
    protected final Node<V>[] helpTransfer(Node<V>[] tab, Node<V> f) {
        if (tab != null && f instanceof ForwardingNode) {
            ...
            if (((ForwardingNode)f).nextTable != null) {
                int sc;
                int rs = Double2ObjectConcurrentHashMap.resizeStamp(tab.length);
    ...
    protected final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 0x20000000 ? 0x40000000 : Double2ObjectConcurrentHashMap.tableSizeFor(size + (size >>> 1) + 1);
        while ((sc = this.sizeCtl) >= 0) {
            ...
            int rs = Double2ObjectConcurrentHashMap.resizeStamp(n2);
            if (sc < 0) {
                if (sc >>> RESIZE_STAMP_SHIFT != rs || sc == rs + 1 || sc == rs + MAX_RESIZERS) break;
                Node<V>[] nt = this.nextTable;
                if (this.nextTable == null || this.transferIndex <= 0) break;
    ...
    protected final void transfer(Node<V>[] tab, Node<V>[] nextTab) {
        ...
        while (true) {
            ...
            if (i < 0 || i >= n || i + n >= nextn) {
                ...
                int sc = this.sizeCtl;
                if (!U.compareAndSwapInt(this, SIZECTL, sc, sc - 1)) continue;
                if (sc - 2 != Double2ObjectConcurrentHashMap.resizeStamp(n) << RESIZE_STAMP_SHIFT) {
                    return;
                }
                advance = true;
                finishing = true;
            ...
            TreeBin f = Double2ObjectConcurrentHashMap.tabAt(tab, i);
            if (f == null) {
                advance = Double2ObjectConcurrentHashMap.casTabAt(tab, i, null, fwd);
                continue;
            }
            int fh = f.hash;
            if (fh == -1) {
            ...
            synchronized (treeBin) {
                if (Double2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    if (fh >= 0) {
                        ...
                        Double2ObjectConcurrentHashMap.setTabAt(nextTab, i, ln);
                        Double2ObjectConcurrentHashMap.setTabAt(nextTab, i + n, hn);
                        Double2ObjectConcurrentHashMap.setTabAt(tab, i, fwd);
                        advance = true;
                    } else if (f instanceof TreeBin) {
                        TreeBin ln;
                        TreeBin t = f;
    ...
    protected final void treeifyBin(Node<V>[] tab, int index) {
        if (tab != null) {
            ...
            if (n < 64) {
                ...
                Node<V> b = Double2ObjectConcurrentHashMap.tabAt(tab, index);
                if (b != null && b.hash >= 0) {
                    Node<V> node = b;
                    synchronized (node) {
                        if (Double2ObjectConcurrentHashMap.tabAt(tab, index) == b) {
                            TreeNode hd = null;
                            TreeNode tl = null;
                            Node<V> e = b;
                            while (e != null) {
                            ...
                            Double2ObjectConcurrentHashMap.setTabAt(tab, index, new TreeBin(this.EMPTY, hd));
                        }
                    }
                }
            }
    ...
    public V valueMatching(Predicate<V> predicate) {
        ...
        block0: while (next != null || !b) {
            ...
            while (true) {
                ...
                e = Double2ObjectConcurrentHashMap.tabAt(t, i);
                if (e != null && e.hash < 0) {
    ...
    static {
        try {
            ...
            U = (Unsafe)f.get(null);
            Class<Double2ObjectConcurrentHashMap> k = Double2ObjectConcurrentHashMap.class;
    ...
    implements Entry<V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!empty && this.key != ((Entry)o).getDoubleKey()) {
                    return false;
                }
    ...
    extends Node<V> {
        ...
        protected Node<V> find(int h, double k) {
            ...
            block0: while (true) {
                Node<V> e;
                int n;
                if (k == this.EMPTY || tab == null || (n = tab.length) == 0 || (e = Double2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) == null) {
                    return null;
                }
                do {
                    double ek;
    ...
    Serializable {
        ...
        public final ObjectIterator<V> iterator() {
            Double2ObjectConcurrentHashMap m = this.map;
            Node<V>[] t = m.table;
            int f = m.table == null ? 0 : t.length;
    ...
    extends CollectionView<V, Double2ObjectMap.Entry<V>>
    ...
    @FunctionalInterface
    public static interface DoubleObjConsumer<V> {
        public void accept(double var1, V var3);
    }

    @FunctionalInterface
    public static interface DoubleBiObjConsumer<V, X> {
        public void accept(double var1, V var3, X var4);
    }

    @FunctionalInterface
    public static interface DoubleTriObjConsumer<V, X, Y> {
        public void accept(double var1, V var3, X var4, Y var5);
    }

    @FunctionalInterface
    public static interface DoubleObjByteConsumer<V> {
        public void accept(double var1, V var3, byte var4);
    }

    @FunctionalInterface
    public static interface DoubleObjShortConsumer<V> {
        public void accept(double var1, V var3, short var4);
    }

    @FunctionalInterface
    public static interface DoubleObjIntConsumer<V> {
        public void accept(double var1, V var3, int var4);
    }

    @FunctionalInterface
    public static interface DoubleObjLongConsumer<V> {
        public void accept(double var1, V var3, long var4);
    }

    @FunctionalInterface
    public static interface DoubleObjFloatConsumer<V> {
        public void accept(double var1, V var3, float var4);
    }

    @FunctionalInterface
    public static interface DoubleObjDoubleConsumer<V> {
        public void accept(double var1, V var3, double var4);
    }

    @FunctionalInterface
    public static interface DoubleBiObjByteConsumer<V, X> {
        public void accept(double var1, V var3, byte var4, X var5);
    }

    @FunctionalInterface
    public static interface DoubleBiObjShortConsumer<V, X> {
        public void accept(double var1, V var3, short var4, X var5);
    }

    @FunctionalInterface
    public static interface DoubleBiObjIntConsumer<V, X> {
        public void accept(double var1, V var3, int var4, X var5);
    }

    @FunctionalInterface
    public static interface DoubleBiObjLongConsumer<V, X> {
        public void accept(double var1, V var3, long var4, X var6);
    }

    @FunctionalInterface
    public static interface DoubleBiObjFloatConsumer<V, X> {
        public void accept(double var1, V var3, float var4, X var5);
    }

    @FunctionalInterface
    public static interface DoubleBiObjDoubleConsumer<V, X> {
        public void accept(double var1, V var3, double var4, X var6);
    }
    ...
    @FunctionalInterface
    public static interface DoubleObjFunction<V, J> {
        public J apply(double var1, V var3);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            DoubleObjConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            DoubleObjFunction transformer = this.transformer;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            ...
            DoubleObjFunction searchFunction = this.searchFunction;
    ...
    @FunctionalInterface
    public static interface DoubleBiObjFunction<V, X, J> {
        public J apply(double var1, V var3, X var4);
    }

    @FunctionalInterface
    public static interface DoubleObjByteFunction<V, J> {
        public J apply(double var1, V var3, byte var4);
    }

    @FunctionalInterface
    public static interface DoubleObjShortFunction<V, J> {
        public J apply(double var1, V var3, short var4);
    }

    @FunctionalInterface
    public static interface DoubleObjIntFunction<V, J> {
        public J apply(double var1, V var3, int var4);
    }

    @FunctionalInterface
    public static interface DoubleObjLongFunction<V, J> {
        public J apply(double var1, V var3, long var4);
    }

    @FunctionalInterface
    public static interface DoubleObjFloatFunction<V, J> {
        public J apply(double var1, V var3, float var4);
    }

    @FunctionalInterface
    public static interface DoubleObjDoubleFunction<V, J> {
        public J apply(double var1, V var3, double var4);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToDoubleDoubleObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToDoubleDoubleObjFunction<V> {
        public double applyAsDouble(double var1, V var3);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToLongDoubleObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToLongDoubleObjFunction<V> {
        public long applyAsLong(double var1, V var3);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToIntDoubleObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToIntDoubleObjFunction<V> {
        public int applyAsInt(double var1, V var3);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            DoubleFunction<U> transformer = this.transformer;
            if (transformer != null && (action = this.action) != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            AtomicReference<U> result;
            DoubleFunction<U> searchFunction = this.searchFunction;
            if (searchFunction != null && (result = this.result) != null) {
                int f;
                int h;
                int i = this.baseIndex;
    ...
    extends DoubleReturningBulkTask2<V> {
        public final double EMPTY;
        ...
        @Override
        public final void compute() {
            DoubleReduceTaskOperator reducer = this.reducer;
            if (reducer != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface DoubleReduceTaskOperator {
        public double reduce(double var1, double var3, double var5);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            DoubleBinaryOperator reducer;
            DoubleToDoubleFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            LongBinaryOperator reducer;
            DoubleToLongFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            IntBinaryOperator reducer;
            DoubleToIntFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends Double2ObjectMap.Entry<V> {
        public boolean isEmpty();
    ...
    protected static abstract class DoubleReturningBulkTask2<V>
    extends BulkTask<V, Double> {
        public double result;
    ...
    implements DoubleSpliterator {
        ...
        public boolean tryAdvance(Consumer<? super Double> action) {
            if (action instanceof DoubleConsumer) {
                return this.tryAdvance((DoubleConsumer)((Object)action));
            }
            return this.tryAdvance((double value) -> action.accept(value));
        }
    ...
    implements Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!this.empty && this.key != ((Entry)o).getDoubleKey()) {
                    return false;
                }
                return this.val.equals(((Entry)o).getValue());
            }
