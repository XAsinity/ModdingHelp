...
import com.hypixel.fastutil.longs.Long2ObjectOperator;
...
public class Long2ObjectConcurrentHashMap<V> {
    ...
    public Long2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, long emptyValue) {
        ...
        this.sizeCtl = cap = initialCapacity >= 0x20000000 ? 0x40000000 : Long2ObjectConcurrentHashMap.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
        this.EMPTY = emptyValue;
    }
    ...
    public Long2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, long emptyValue) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 0x40000000 : Long2ObjectConcurrentHashMap.tableSizeFor((int)size);
        this.EMPTY = emptyValue;
    }
    ...
    public V get(long key) {
        ...
        int h = Long2ObjectConcurrentHashMap.spread(Long.hashCode(key));
        Node<V>[] tab = this.table;
        if (this.table != null && (n = tab.length) > 0 && (e = Long2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) != null) {
            long ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
        ...
        block14: {
            ...
            do {
                ...
                while (true) {
                    ...
                    p = Long2ObjectConcurrentHashMap.tabAt(t, i);
                    if (p != null && p.hash < 0) {
    ...
    protected final V putVal(long key, V value, boolean onlyIfAbsent) {
        ...
        block20: {
            ...
            int hash = Long2ObjectConcurrentHashMap.spread(Long.hashCode(key));
            binCount = 0;
            Node<V>[] tab = this.table;
            while (true) {
                int n;
                ...
                i = n - 1 & hash;
                Node<V> f = Long2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Long2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, hash, key, value, null))) continue;
                    break block20;
                }
                int fh = f.hash;
                if (fh == -1) {
                ...
                synchronized (node) {
                    block21: {
                        if (Long2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<V> e = f;
                                while (true) {
    ...
    public void putAll(Long2ObjectConcurrentHashMap<? extends V> m) {
        ...
        for (Long2ObjectMap.Entry entry : m.long2ObjectEntrySet()) {
            this.putVal(entry.getLongKey(), entry.getValue(), false);
        }
    }
    ...
    protected final V replaceNode(long key, V value, Object cv) {
        ...
        int hash = Long2ObjectConcurrentHashMap.spread(Long.hashCode(key));
        Node<V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f = Long2ObjectConcurrentHashMap.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f);
                continue;
                            ...
                            if (e.hash == hash && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (cv == null || cv == ev || ev != null && cv.equals(ev)) {
                                    ...
                                    if (value != null) {
                                        ...
                                        Long2ObjectConcurrentHashMap.setTabAt(tab, i, e.next);
                                    }
                                }
                                break;
                            }
                        ...
                        if (r != null && (p = r.findTreeNode(hash, key, null)) != null) {
                            ...
                            if (cv == null || cv == pv || pv != null && cv.equals(pv)) {
                                ...
                                if (value != null) {
                                    ...
                                    Long2ObjectConcurrentHashMap.setTabAt(tab, i, this.untreeify(t.first));
                                }
                            }
                        }
                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (Long2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    ...
                    Long2ObjectConcurrentHashMap.setTabAt(tab, i++, null);
                }
            }
        }
        if (delta != 0L) {
        ...
        block31: {
            ...
            while (true) {
                ...
                if (f == null) {
                    ...
                    synchronized (node) {
                        if (Long2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            binCount = 1;
                            ...
                            try {
                                ...
                                Long2ObjectConcurrentHashMap.setTabAt(tab, i, node2);
                            }
                        }
                    }
                            ...
                            if (e.hash == h && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (val != null) {
                                    ...
                                    if (pred != null) {
                                        ...
                                        Long2ObjectConcurrentHashMap.setTabAt(tab, i, en);
                                    }
                                }
                            } else {
                                pred = e;
                    ...
                    synchronized (reservationNode) {
                        if (Long2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            ...
                            try {
                                ...
                                Long2ObjectConcurrentHashMap.setTabAt(tab, i, node);
                            }
                        }
                    }
                    if (binCount == 0) continue;
    ...
    public V merge(long key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        block27: {
            ...
            while (true) {
                ...
                Node<V> f = Long2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Long2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, h, key, value, null))) continue;
                    delta = 1;
                    val = value;
                    break block27;
                }
    ...
    public static LongSet newKeySet() {
        return new KeySetView<Boolean>(new Long2ObjectConcurrentHashMap(), Boolean.TRUE);
    }
    ...
    protected final void addCount(long x, int check) {
        ...
        if (check >= 0) {
            ...
            while (s >= (long)(sc = this.sizeCtl)) {
                ...
                int rs = Long2ObjectConcurrentHashMap.resizeStamp(n);
                if (sc < 0) {
    ...
    protected final Node<V>[] helpTransfer(Node<V>[] tab, Node<V> f) {
        if (tab != null && f instanceof ForwardingNode) {
            ...
            if (((ForwardingNode)f).nextTable != null) {
                int sc;
                int rs = Long2ObjectConcurrentHashMap.resizeStamp(tab.length);
    ...
    protected final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 0x20000000 ? 0x40000000 : Long2ObjectConcurrentHashMap.tableSizeFor(size + (size >>> 1) + 1);
        while ((sc = this.sizeCtl) >= 0) {
            ...
            int rs = Long2ObjectConcurrentHashMap.resizeStamp(n2);
            if (sc < 0) {
                if (sc >>> RESIZE_STAMP_SHIFT != rs || sc == rs + 1 || sc == rs + MAX_RESIZERS) break;
                Node<V>[] nt = this.nextTable;
                if (this.nextTable == null || this.transferIndex <= 0) break;
    ...
    protected final void transfer(Node<V>[] tab, Node<V>[] nextTab) {
        ...
        while (true) {
            ...
            if (i < 0 || i >= n || i + n >= nextn) {
                ...
                int sc = this.sizeCtl;
                if (!U.compareAndSwapInt(this, SIZECTL, sc, sc - 1)) continue;
                if (sc - 2 != Long2ObjectConcurrentHashMap.resizeStamp(n) << RESIZE_STAMP_SHIFT) {
                    return;
                }
                advance = true;
                finishing = true;
            ...
            TreeBin f = Long2ObjectConcurrentHashMap.tabAt(tab, i);
            if (f == null) {
                advance = Long2ObjectConcurrentHashMap.casTabAt(tab, i, null, fwd);
                continue;
            }
            int fh = f.hash;
            if (fh == -1) {
            ...
            synchronized (treeBin) {
                if (Long2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    if (fh >= 0) {
                        ...
                        Long2ObjectConcurrentHashMap.setTabAt(nextTab, i, ln);
                        Long2ObjectConcurrentHashMap.setTabAt(nextTab, i + n, hn);
                        Long2ObjectConcurrentHashMap.setTabAt(tab, i, fwd);
                        advance = true;
                    } else if (f instanceof TreeBin) {
                        TreeBin ln;
                        TreeBin t = f;
    ...
    protected final void treeifyBin(Node<V>[] tab, int index) {
        if (tab != null) {
            ...
            if (n < 64) {
                ...
                Node<V> b = Long2ObjectConcurrentHashMap.tabAt(tab, index);
                if (b != null && b.hash >= 0) {
                    Node<V> node = b;
                    synchronized (node) {
                        if (Long2ObjectConcurrentHashMap.tabAt(tab, index) == b) {
                            TreeNode hd = null;
                            TreeNode tl = null;
                            Node<V> e = b;
                            while (e != null) {
                            ...
                            Long2ObjectConcurrentHashMap.setTabAt(tab, index, new TreeBin(this.EMPTY, hd));
                        }
                    }
                }
            }
    ...
    public V valueMatching(Predicate<V> predicate) {
        ...
        block0: while (next != null || !b) {
            ...
            while (true) {
                ...
                e = Long2ObjectConcurrentHashMap.tabAt(t, i);
                if (e != null && e.hash < 0) {
    ...
    static {
        try {
            ...
            U = (Unsafe)f.get(null);
            Class<Long2ObjectConcurrentHashMap> k = Long2ObjectConcurrentHashMap.class;
    ...
    implements Entry<V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!empty && this.key != ((Entry)o).getLongKey()) {
                    return false;
                }
    ...
    extends Node<V> {
        ...
        protected Node<V> find(int h, long k) {
            ...
            block0: while (true) {
                Node<V> e;
                int n;
                if (k == this.EMPTY || tab == null || (n = tab.length) == 0 || (e = Long2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) == null) {
                    return null;
                }
                do {
                    long ek;
    ...
    Serializable {
        ...
        public final ObjectIterator<V> iterator() {
            Long2ObjectConcurrentHashMap m = this.map;
            Node<V>[] t = m.table;
            int f = m.table == null ? 0 : t.length;
    ...
    extends CollectionView<V, Long2ObjectMap.Entry<V>>
    ...
    @FunctionalInterface
    public static interface LongObjConsumer<V> {
        public void accept(long var1, V var3);
    }

    @FunctionalInterface
    public static interface LongBiObjConsumer<V, X> {
        public void accept(long var1, V var3, X var4);
    }

    @FunctionalInterface
    public static interface LongTriObjConsumer<V, X, Y> {
        public void accept(long var1, V var3, X var4, Y var5);
    }

    @FunctionalInterface
    public static interface LongObjByteConsumer<V> {
        public void accept(long var1, V var3, byte var4);
    }

    @FunctionalInterface
    public static interface LongObjShortConsumer<V> {
        public void accept(long var1, V var3, short var4);
    }

    @FunctionalInterface
    public static interface LongObjIntConsumer<V> {
        public void accept(long var1, V var3, int var4);
    }

    @FunctionalInterface
    public static interface LongObjLongConsumer<V> {
        public void accept(long var1, V var3, long var4);
    }

    @FunctionalInterface
    public static interface LongObjFloatConsumer<V> {
        public void accept(long var1, V var3, float var4);
    }

    @FunctionalInterface
    public static interface LongObjDoubleConsumer<V> {
        public void accept(long var1, V var3, double var4);
    }

    @FunctionalInterface
    public static interface LongBiObjByteConsumer<V, X> {
        public void accept(long var1, V var3, byte var4, X var5);
    }

    @FunctionalInterface
    public static interface LongBiObjShortConsumer<V, X> {
        public void accept(long var1, V var3, short var4, X var5);
    }

    @FunctionalInterface
    public static interface LongBiObjIntConsumer<V, X> {
        public void accept(long var1, V var3, int var4, X var5);
    }

    @FunctionalInterface
    public static interface LongBiObjLongConsumer<V, X> {
        public void accept(long var1, V var3, long var4, X var6);
    }

    @FunctionalInterface
    public static interface LongBiObjFloatConsumer<V, X> {
        public void accept(long var1, V var3, float var4, X var5);
    }

    @FunctionalInterface
    public static interface LongBiObjDoubleConsumer<V, X> {
        public void accept(long var1, V var3, double var4, X var6);
    }
    ...
    @FunctionalInterface
    public static interface LongObjFunction<V, J> {
        public J apply(long var1, V var3);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            LongObjConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            LongObjFunction transformer = this.transformer;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            ...
            LongObjFunction searchFunction = this.searchFunction;
    ...
    @FunctionalInterface
    public static interface LongBiObjFunction<V, X, J> {
        public J apply(long var1, V var3, X var4);
    }

    @FunctionalInterface
    public static interface LongObjByteFunction<V, J> {
        public J apply(long var1, V var3, byte var4);
    }

    @FunctionalInterface
    public static interface LongObjShortFunction<V, J> {
        public J apply(long var1, V var3, short var4);
    }

    @FunctionalInterface
    public static interface LongObjIntFunction<V, J> {
        public J apply(long var1, V var3, int var4);
    }

    @FunctionalInterface
    public static interface LongObjLongFunction<V, J> {
        public J apply(long var1, V var3, long var4);
    }

    @FunctionalInterface
    public static interface LongObjFloatFunction<V, J> {
        public J apply(long var1, V var3, float var4);
    }

    @FunctionalInterface
    public static interface LongObjDoubleFunction<V, J> {
        public J apply(long var1, V var3, double var4);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToDoubleLongObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToDoubleLongObjFunction<V> {
        public double applyAsDouble(long var1, V var3);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToLongLongObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToLongLongObjFunction<V> {
        public long applyAsLong(long var1, V var3);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToIntLongObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToIntLongObjFunction<V> {
        public int applyAsInt(long var1, V var3);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            LongFunction<U> transformer = this.transformer;
            if (transformer != null && (action = this.action) != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            AtomicReference<U> result;
            LongFunction<U> searchFunction = this.searchFunction;
            if (searchFunction != null && (result = this.result) != null) {
                int f;
                int h;
                int i = this.baseIndex;
    ...
    extends LongReturningBulkTask2<V> {
        public final long EMPTY;
        ...
        @Override
        public final void compute() {
            LongReduceTaskOperator reducer = this.reducer;
            if (reducer != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface LongReduceTaskOperator {
        public long reduce(long var1, long var3, long var5);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            DoubleBinaryOperator reducer;
            LongToDoubleFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            LongBinaryOperator reducer;
            LongToLongFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface LongToLongFunction {
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            IntBinaryOperator reducer;
            LongToIntFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends Long2ObjectMap.Entry<V> {
        public boolean isEmpty();
    ...
    protected static abstract class LongReturningBulkTask2<V>
    extends BulkTask<V, Long> {
        public long result;
    ...
    implements LongSpliterator {
        ...
        public boolean tryAdvance(Consumer<? super Long> action) {
            if (action instanceof LongConsumer) {
                return this.tryAdvance((LongConsumer)((Object)action));
            }
            return this.tryAdvance((long value) -> action.accept(value));
        }
    ...
    implements Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!this.empty && this.key != ((Entry)o).getLongKey()) {
                    return false;
                }
                return this.val.equals(((Entry)o).getValue());
            }
