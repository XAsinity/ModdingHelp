...
import com.hypixel.fastutil.ints.Int2ObjectOperator;
...
public class Int2ObjectConcurrentHashMap<V> {
    ...
    public Int2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, int emptyValue) {
        ...
        this.sizeCtl = cap = initialCapacity >= 0x20000000 ? 0x40000000 : Int2ObjectConcurrentHashMap.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
        this.EMPTY = emptyValue;
    }
    ...
    public Int2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, int emptyValue) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 0x40000000 : Int2ObjectConcurrentHashMap.tableSizeFor((int)size);
        this.EMPTY = emptyValue;
    }
    ...
    public V get(int key) {
        ...
        int h = Int2ObjectConcurrentHashMap.spread(Integer.hashCode(key));
        Node<V>[] tab = this.table;
        if (this.table != null && (n = tab.length) > 0 && (e = Int2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) != null) {
            int ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
        ...
        block14: {
            ...
            do {
                ...
                while (true) {
                    ...
                    p = Int2ObjectConcurrentHashMap.tabAt(t, i);
                    if (p != null && p.hash < 0) {
    ...
    protected final V putVal(int key, V value, boolean onlyIfAbsent) {
        ...
        block20: {
            ...
            int hash = Int2ObjectConcurrentHashMap.spread(Integer.hashCode(key));
            binCount = 0;
            Node<V>[] tab = this.table;
            while (true) {
                int n;
                ...
                i = n - 1 & hash;
                Node<V> f = Int2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Int2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, hash, key, value, null))) continue;
                    break block20;
                }
                int fh = f.hash;
                if (fh == -1) {
                ...
                synchronized (node) {
                    block21: {
                        if (Int2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<V> e = f;
                                while (true) {
    ...
    public void putAll(Int2ObjectConcurrentHashMap<? extends V> m) {
        ...
        for (Int2ObjectMap.Entry entry : m.int2ObjectEntrySet()) {
            this.putVal(entry.getIntKey(), entry.getValue(), false);
        }
    }
    ...
    protected final V replaceNode(int key, V value, Object cv) {
        ...
        int hash = Int2ObjectConcurrentHashMap.spread(Integer.hashCode(key));
        Node<V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f = Int2ObjectConcurrentHashMap.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f);
                continue;
                            ...
                            if (e.hash == hash && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (cv == null || cv == ev || ev != null && cv.equals(ev)) {
                                    ...
                                    if (value != null) {
                                        ...
                                        Int2ObjectConcurrentHashMap.setTabAt(tab, i, e.next);
                                    }
                                }
                                break;
                            }
                        ...
                        if (r != null && (p = r.findTreeNode(hash, key, null)) != null) {
                            ...
                            if (cv == null || cv == pv || pv != null && cv.equals(pv)) {
                                ...
                                if (value != null) {
                                    ...
                                    Int2ObjectConcurrentHashMap.setTabAt(tab, i, this.untreeify(t.first));
                                }
                            }
                        }
                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (Int2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    ...
                    Int2ObjectConcurrentHashMap.setTabAt(tab, i++, null);
                }
            }
        }
        if (delta != 0L) {
        ...
        block31: {
            ...
            while (true) {
                ...
                if (f == null) {
                    ...
                    synchronized (node) {
                        if (Int2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            binCount = 1;
                            ...
                            try {
                                ...
                                Int2ObjectConcurrentHashMap.setTabAt(tab, i, node2);
                            }
                        }
                    }
                            ...
                            if (e.hash == h && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (val != null) {
                                    ...
                                    if (pred != null) {
                                        ...
                                        Int2ObjectConcurrentHashMap.setTabAt(tab, i, en);
                                    }
                                }
                            } else {
                                pred = e;
                    ...
                    synchronized (reservationNode) {
                        if (Int2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            ...
                            try {
                                ...
                                Int2ObjectConcurrentHashMap.setTabAt(tab, i, node);
                            }
                        }
                    }
                    if (binCount == 0) continue;
    ...
    public V merge(int key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        block27: {
            ...
            while (true) {
                ...
                Node<V> f = Int2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Int2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, h, key, value, null))) continue;
                    delta = 1;
                    val = value;
                    break block27;
                }
    ...
    public static IntSet newKeySet() {
        return new KeySetView<Boolean>(new Int2ObjectConcurrentHashMap(), Boolean.TRUE);
    }
    ...
    protected final void addCount(long x, int check) {
        ...
        if (check >= 0) {
            ...
            while (s >= (long)(sc = this.sizeCtl)) {
                ...
                int rs = Int2ObjectConcurrentHashMap.resizeStamp(n);
                if (sc < 0) {
    ...
    protected final Node<V>[] helpTransfer(Node<V>[] tab, Node<V> f) {
        if (tab != null && f instanceof ForwardingNode) {
            ...
            if (((ForwardingNode)f).nextTable != null) {
                int sc;
                int rs = Int2ObjectConcurrentHashMap.resizeStamp(tab.length);
    ...
    protected final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 0x20000000 ? 0x40000000 : Int2ObjectConcurrentHashMap.tableSizeFor(size + (size >>> 1) + 1);
        while ((sc = this.sizeCtl) >= 0) {
            ...
            int rs = Int2ObjectConcurrentHashMap.resizeStamp(n2);
            if (sc < 0) {
                if (sc >>> RESIZE_STAMP_SHIFT != rs || sc == rs + 1 || sc == rs + MAX_RESIZERS) break;
                Node<V>[] nt = this.nextTable;
                if (this.nextTable == null || this.transferIndex <= 0) break;
    ...
    protected final void transfer(Node<V>[] tab, Node<V>[] nextTab) {
        ...
        while (true) {
            ...
            if (i < 0 || i >= n || i + n >= nextn) {
                ...
                int sc = this.sizeCtl;
                if (!U.compareAndSwapInt(this, SIZECTL, sc, sc - 1)) continue;
                if (sc - 2 != Int2ObjectConcurrentHashMap.resizeStamp(n) << RESIZE_STAMP_SHIFT) {
                    return;
                }
                advance = true;
                finishing = true;
            ...
            TreeBin f = Int2ObjectConcurrentHashMap.tabAt(tab, i);
            if (f == null) {
                advance = Int2ObjectConcurrentHashMap.casTabAt(tab, i, null, fwd);
                continue;
            }
            int fh = f.hash;
            if (fh == -1) {
            ...
            synchronized (treeBin) {
                if (Int2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    if (fh >= 0) {
                        ...
                        Int2ObjectConcurrentHashMap.setTabAt(nextTab, i, ln);
                        Int2ObjectConcurrentHashMap.setTabAt(nextTab, i + n, hn);
                        Int2ObjectConcurrentHashMap.setTabAt(tab, i, fwd);
                        advance = true;
                    } else if (f instanceof TreeBin) {
                        TreeBin ln;
                        TreeBin t = f;
    ...
    protected final void treeifyBin(Node<V>[] tab, int index) {
        if (tab != null) {
            ...
            if (n < 64) {
                ...
                Node<V> b = Int2ObjectConcurrentHashMap.tabAt(tab, index);
                if (b != null && b.hash >= 0) {
                    Node<V> node = b;
                    synchronized (node) {
                        if (Int2ObjectConcurrentHashMap.tabAt(tab, index) == b) {
                            TreeNode hd = null;
                            TreeNode tl = null;
                            Node<V> e = b;
                            while (e != null) {
                            ...
                            Int2ObjectConcurrentHashMap.setTabAt(tab, index, new TreeBin(this.EMPTY, hd));
                        }
                    }
                }
            }
    ...
    public V valueMatching(Predicate<V> predicate) {
        ...
        block0: while (next != null || !b) {
            ...
            while (true) {
                ...
                e = Int2ObjectConcurrentHashMap.tabAt(t, i);
                if (e != null && e.hash < 0) {
    ...
    static {
        try {
            ...
            U = (Unsafe)f.get(null);
            Class<Int2ObjectConcurrentHashMap> k = Int2ObjectConcurrentHashMap.class;
    ...
    implements Entry<V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!empty && this.key != ((Entry)o).getIntKey()) {
                    return false;
                }
    ...
    extends Node<V> {
        ...
        protected Node<V> find(int h, int k) {
            ...
            block0: while (true) {
                Node<V> e;
                int n;
                if (k == this.EMPTY || tab == null || (n = tab.length) == 0 || (e = Int2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) == null) {
                    return null;
                }
                do {
                    int ek;
    ...
    extends CollectionView<V, Int2ObjectMap.Entry<V>>
    ...
    @FunctionalInterface
    public static interface IntObjConsumer<V> {
        public void accept(int var1, V var2);
    }

    @FunctionalInterface
    public static interface IntBiObjConsumer<V, X> {
        public void accept(int var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface IntTriObjConsumer<V, X, Y> {
        public void accept(int var1, V var2, X var3, Y var4);
    }

    @FunctionalInterface
    public static interface IntObjByteConsumer<V> {
        public void accept(int var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface IntObjShortConsumer<V> {
        public void accept(int var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface IntObjIntConsumer<V> {
        public void accept(int var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface IntObjLongConsumer<V> {
        public void accept(int var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface IntObjFloatConsumer<V> {
        public void accept(int var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface IntObjDoubleConsumer<V> {
        public void accept(int var1, V var2, double var3);
    }

    @FunctionalInterface
    public static interface IntBiObjByteConsumer<V, X> {
        public void accept(int var1, V var2, byte var3, X var4);
    }

    @FunctionalInterface
    public static interface IntBiObjShortConsumer<V, X> {
        public void accept(int var1, V var2, short var3, X var4);
    }

    @FunctionalInterface
    public static interface IntBiObjIntConsumer<V, X> {
        public void accept(int var1, V var2, int var3, X var4);
    }

    @FunctionalInterface
    public static interface IntBiObjLongConsumer<V, X> {
        public void accept(int var1, V var2, long var3, X var5);
    }

    @FunctionalInterface
    public static interface IntBiObjFloatConsumer<V, X> {
        public void accept(int var1, V var2, float var3, X var4);
    }

    @FunctionalInterface
    public static interface IntBiObjDoubleConsumer<V, X> {
        public void accept(int var1, V var2, double var3, X var5);
    }
    ...
    @FunctionalInterface
    public static interface IntObjFunction<V, J> {
        public J apply(int var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            IntObjConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            IntObjFunction transformer = this.transformer;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            ...
            IntObjFunction searchFunction = this.searchFunction;
    ...
    @FunctionalInterface
    public static interface IntBiObjFunction<V, X, J> {
        public J apply(int var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface IntObjByteFunction<V, J> {
        public J apply(int var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface IntObjShortFunction<V, J> {
        public J apply(int var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface IntObjIntFunction<V, J> {
        public J apply(int var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface IntObjLongFunction<V, J> {
        public J apply(int var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface IntObjFloatFunction<V, J> {
        public J apply(int var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface IntObjDoubleFunction<V, J> {
        public J apply(int var1, V var2, double var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToDoubleIntObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToDoubleIntObjFunction<V> {
        public double applyAsDouble(int var1, V var2);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToLongIntObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToLongIntObjFunction<V> {
        public long applyAsLong(int var1, V var2);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToIntIntObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToIntIntObjFunction<V> {
        public int applyAsInt(int var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            IntFunction<U> transformer = this.transformer;
            if (transformer != null && (action = this.action) != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            AtomicReference<U> result;
            IntFunction<U> searchFunction = this.searchFunction;
            if (searchFunction != null && (result = this.result) != null) {
                int f;
                int h;
                int i = this.baseIndex;
    ...
    extends IntegerReturningBulkTask2<V> {
        public final int EMPTY;
        ...
        @Override
        public final void compute() {
            IntegerReduceTaskOperator reducer = this.reducer;
            if (reducer != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface IntegerReduceTaskOperator {
        public int reduce(int var1, int var2, int var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            DoubleBinaryOperator reducer;
            IntToDoubleFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            LongBinaryOperator reducer;
            IntToLongFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            IntBinaryOperator reducer;
            IntToIntFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    protected static abstract class IntegerReturningBulkTask2<V>
    extends BulkTask<V, Integer> {
        public int result;
    ...
    implements IntSpliterator {
        ...
        public boolean tryAdvance(Consumer<? super Integer> action) {
            ...
            return this.tryAdvance((int value) -> action.accept(value));
        }
    ...
    implements Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!this.empty && this.key != ((Entry)o).getIntKey()) {
                    return false;
                }
                return this.val.equals(((Entry)o).getValue());
            }
