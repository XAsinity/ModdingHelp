...
import com.hypixel.fastutil.floats.Float2ObjectOperator;
...
public class Float2ObjectConcurrentHashMap<V> {
    ...
    public Float2ObjectConcurrentHashMap(int initialCapacity, boolean nonce, float emptyValue) {
        ...
        this.sizeCtl = cap = initialCapacity >= 0x20000000 ? 0x40000000 : Float2ObjectConcurrentHashMap.tableSizeFor(initialCapacity + (initialCapacity >>> 1) + 1);
        this.EMPTY = emptyValue;
    }
    ...
    public Float2ObjectConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, float emptyValue) {
        ...
        this.sizeCtl = cap = (size = (long)(1.0 + (double)((float)initialCapacity / loadFactor))) >= 0x40000000L ? 0x40000000 : Float2ObjectConcurrentHashMap.tableSizeFor((int)size);
        this.EMPTY = emptyValue;
    }
    ...
    public V get(float key) {
        ...
        int h = Float2ObjectConcurrentHashMap.spread(Float.hashCode(key));
        Node<V>[] tab = this.table;
        if (this.table != null && (n = tab.length) > 0 && (e = Float2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) != null) {
            float ek;
            int eh = e.hash;
            if (eh == h) {
                ek = e.key;
        ...
        block14: {
            ...
            do {
                ...
                while (true) {
                    ...
                    p = Float2ObjectConcurrentHashMap.tabAt(t, i);
                    if (p != null && p.hash < 0) {
    ...
    protected final V putVal(float key, V value, boolean onlyIfAbsent) {
        ...
        block20: {
            ...
            int hash = Float2ObjectConcurrentHashMap.spread(Float.hashCode(key));
            binCount = 0;
            Node<V>[] tab = this.table;
            while (true) {
                int n;
                ...
                i = n - 1 & hash;
                Node<V> f = Float2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Float2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, hash, key, value, null))) continue;
                    break block20;
                }
                int fh = f.hash;
                if (fh == -1) {
                ...
                synchronized (node) {
                    block21: {
                        if (Float2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<V> e = f;
                                while (true) {
    ...
    public void putAll(Map<? extends Float, ? extends V> m) {
        ...
        for (Map.Entry<Float, V> e : m.entrySet()) {
            this.putVal(e.getKey().floatValue(), e.getValue(), false);
        }
    }
    ...
    public void putAll(Float2ObjectConcurrentHashMap<? extends V> m) {
        ...
        for (Float2ObjectMap.Entry entry : m.float2ObjectEntrySet()) {
            this.putVal(entry.getFloatKey(), entry.getValue(), false);
        }
    }
    ...
    @Deprecated
    public V remove(Float key) {
        return this.replaceNode(key.floatValue(), null, null);
    }
    ...
    protected final V replaceNode(float key, V value, Object cv) {
        ...
        int hash = Float2ObjectConcurrentHashMap.spread(Float.hashCode(key));
        Node<V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f = Float2ObjectConcurrentHashMap.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f);
                continue;
                            ...
                            if (e.hash == hash && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (cv == null || cv == ev || ev != null && cv.equals(ev)) {
                                    ...
                                    if (value != null) {
                                        ...
                                        Float2ObjectConcurrentHashMap.setTabAt(tab, i, e.next);
                                    }
                                }
                                break;
                            }
                        ...
                        if (r != null && (p = r.findTreeNode(hash, key, null)) != null) {
                            ...
                            if (cv == null || cv == pv || pv != null && cv.equals(pv)) {
                                ...
                                if (value != null) {
                                    ...
                                    Float2ObjectConcurrentHashMap.setTabAt(tab, i, this.untreeify(t.first));
                                }
                            }
                        }
                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (Float2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    ...
                    Float2ObjectConcurrentHashMap.setTabAt(tab, i++, null);
                }
            }
        }
        if (delta != 0L) {
        ...
        block31: {
            ...
            while (true) {
                ...
                if (f == null) {
                    ...
                    synchronized (node) {
                        if (Float2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            binCount = 1;
                            ...
                            try {
                                ...
                                Float2ObjectConcurrentHashMap.setTabAt(tab, i, node2);
                            }
                        }
                    }
                            ...
                            if (e.hash == h && ((ek = e.key) == key || ek != this.EMPTY && key == ek)) {
                                ...
                                if (val != null) {
                                    ...
                                    if (pred != null) {
                                        ...
                                        Float2ObjectConcurrentHashMap.setTabAt(tab, i, en);
                                    }
                                }
                            } else {
                                pred = e;
                    ...
                    synchronized (reservationNode) {
                        if (Float2ObjectConcurrentHashMap.casTabAt(tab, i, null, r)) {
                            ...
                            try {
                                ...
                                Float2ObjectConcurrentHashMap.setTabAt(tab, i, node);
                            }
                        }
                    }
                    if (binCount == 0) continue;
    ...
    public V merge(float key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        block27: {
            ...
            while (true) {
                ...
                Node<V> f = Float2ObjectConcurrentHashMap.tabAt(tab, i);
                if (f == null) {
                    if (!Float2ObjectConcurrentHashMap.casTabAt(tab, i, null, new Node<V>(this.EMPTY, h, key, value, null))) continue;
                    delta = 1;
                    val = value;
                    break block27;
                }
    ...
    public static FloatSet newKeySet() {
        return new KeySetView<Boolean>(new Float2ObjectConcurrentHashMap(), Boolean.TRUE);
    }
    ...
    protected final void addCount(long x, int check) {
        ...
        if (check >= 0) {
            ...
            while (s >= (long)(sc = this.sizeCtl)) {
                ...
                int rs = Float2ObjectConcurrentHashMap.resizeStamp(n);
                if (sc < 0) {
    ...
    protected final Node<V>[] helpTransfer(Node<V>[] tab, Node<V> f) {
        if (tab != null && f instanceof ForwardingNode) {
            ...
            if (((ForwardingNode)f).nextTable != null) {
                int sc;
                int rs = Float2ObjectConcurrentHashMap.resizeStamp(tab.length);
    ...
    protected final void tryPresize(int size) {
        int sc;
        int c;
        int n = c = size >= 0x20000000 ? 0x40000000 : Float2ObjectConcurrentHashMap.tableSizeFor(size + (size >>> 1) + 1);
        while ((sc = this.sizeCtl) >= 0) {
            ...
            int rs = Float2ObjectConcurrentHashMap.resizeStamp(n2);
            if (sc < 0) {
                if (sc >>> RESIZE_STAMP_SHIFT != rs || sc == rs + 1 || sc == rs + MAX_RESIZERS) break;
                Node<V>[] nt = this.nextTable;
                if (this.nextTable == null || this.transferIndex <= 0) break;
    ...
    protected final void transfer(Node<V>[] tab, Node<V>[] nextTab) {
        ...
        while (true) {
            ...
            if (i < 0 || i >= n || i + n >= nextn) {
                ...
                int sc = this.sizeCtl;
                if (!U.compareAndSwapInt(this, SIZECTL, sc, sc - 1)) continue;
                if (sc - 2 != Float2ObjectConcurrentHashMap.resizeStamp(n) << RESIZE_STAMP_SHIFT) {
                    return;
                }
                advance = true;
                finishing = true;
            ...
            TreeBin f = Float2ObjectConcurrentHashMap.tabAt(tab, i);
            if (f == null) {
                advance = Float2ObjectConcurrentHashMap.casTabAt(tab, i, null, fwd);
                continue;
            }
            int fh = f.hash;
            if (fh == -1) {
            ...
            synchronized (treeBin) {
                if (Float2ObjectConcurrentHashMap.tabAt(tab, i) == f) {
                    if (fh >= 0) {
                        ...
                        Float2ObjectConcurrentHashMap.setTabAt(nextTab, i, ln);
                        Float2ObjectConcurrentHashMap.setTabAt(nextTab, i + n, hn);
                        Float2ObjectConcurrentHashMap.setTabAt(tab, i, fwd);
                        advance = true;
                    } else if (f instanceof TreeBin) {
                        TreeBin ln;
                        TreeBin t = f;
    ...
    protected final void treeifyBin(Node<V>[] tab, int index) {
        if (tab != null) {
            ...
            if (n < 64) {
                ...
                Node<V> b = Float2ObjectConcurrentHashMap.tabAt(tab, index);
                if (b != null && b.hash >= 0) {
                    Node<V> node = b;
                    synchronized (node) {
                        if (Float2ObjectConcurrentHashMap.tabAt(tab, index) == b) {
                            TreeNode hd = null;
                            TreeNode tl = null;
                            Node<V> e = b;
                            while (e != null) {
                            ...
                            Float2ObjectConcurrentHashMap.setTabAt(tab, index, new TreeBin(this.EMPTY, hd));
                        }
                    }
                }
            }
    ...
    public V valueMatching(Predicate<V> predicate) {
        ...
        block0: while (next != null || !b) {
            ...
            while (true) {
                ...
                e = Float2ObjectConcurrentHashMap.tabAt(t, i);
                if (e != null && e.hash < 0) {
    ...
    static {
        try {
            ...
            U = (Unsafe)f.get(null);
            Class<Float2ObjectConcurrentHashMap> k = Float2ObjectConcurrentHashMap.class;
    ...
    implements Entry<V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!empty && this.key != ((Entry)o).getFloatKey()) {
                    return false;
                }
    ...
    extends Node<V> {
        ...
        protected Node<V> find(int h, float k) {
            ...
            block0: while (true) {
                Node<V> e;
                int n;
                if (k == this.EMPTY || tab == null || (n = tab.length) == 0 || (e = Float2ObjectConcurrentHashMap.tabAt(tab, n - 1 & h)) == null) {
                    return null;
                }
                do {
                    float ek;
    ...
    implements FloatSet {
        ...
        public int hashCode() {
            ...
            while (iter.hasNext()) {
                h += Float.hashCode(iter.nextFloat());
            }
            return h;
        }
        ...
        public Object[] toArray() {
            ...
            for (i = 0; i < out.length && iter.hasNext(); ++i) {
                out[i] = Float.valueOf(iter.nextFloat());
            }
            if (out.length > i + 1) {
                out[i] = Float.valueOf(this.map.EMPTY);
            }
            return out;
        }
        ...
        public Object[] toArray(Object[] dest) {
            ...
            if (dest.length > i + 1) {
                dest[i] = Float.valueOf(this.map.EMPTY);
            }
            return dest;
        }
        ...
        public boolean containsAll(FloatCollection collection) {
            ...
            while (iter.hasNext()) {
                float element = iter.next().floatValue();
        ...
        public boolean retainAll(Collection<?> collection) {
            ...
            FloatIterator iter = this.iterator();
            while (iter.hasNext()) {
                if (collection.contains(Float.valueOf(iter.next().floatValue()))) continue;
                iter.remove();
                modified = true;
            }
            return modified;
        ...
        public boolean retainAll(float[] array) {
            ...
            FloatIterator iter = this.iterator();
            while (iter.hasNext()) {
                if (Arrays.binarySearch(array, iter.next().floatValue()) >= 0) continue;
                iter.remove();
                modified = true;
            }
            return modified;
    ...
    Serializable {
        ...
        public final ObjectIterator<V> iterator() {
            Float2ObjectConcurrentHashMap m = this.map;
            Node<V>[] t = m.table;
            int f = m.table == null ? 0 : t.length;
    ...
    extends CollectionView<V, Float2ObjectMap.Entry<V>>
    implements ObjectSet<Float2ObjectMap.Entry<V>>,
    Serializable {
        public static final long serialVersionUID = 2249069246763182397L;
    ...
    @FunctionalInterface
    public static interface FloatObjConsumer<V> {
        public void accept(float var1, V var2);
    }

    @FunctionalInterface
    public static interface FloatBiObjConsumer<V, X> {
        public void accept(float var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface FloatTriObjConsumer<V, X, Y> {
        public void accept(float var1, V var2, X var3, Y var4);
    }

    @FunctionalInterface
    public static interface FloatObjByteConsumer<V> {
        public void accept(float var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface FloatObjShortConsumer<V> {
        public void accept(float var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface FloatObjIntConsumer<V> {
        public void accept(float var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface FloatObjLongConsumer<V> {
        public void accept(float var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface FloatObjFloatConsumer<V> {
        public void accept(float var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface FloatObjDoubleConsumer<V> {
        public void accept(float var1, V var2, double var3);
    }

    @FunctionalInterface
    public static interface FloatBiObjByteConsumer<V, X> {
        public void accept(float var1, V var2, byte var3, X var4);
    }

    @FunctionalInterface
    public static interface FloatBiObjShortConsumer<V, X> {
        public void accept(float var1, V var2, short var3, X var4);
    }

    @FunctionalInterface
    public static interface FloatBiObjIntConsumer<V, X> {
        public void accept(float var1, V var2, int var3, X var4);
    }

    @FunctionalInterface
    public static interface FloatBiObjLongConsumer<V, X> {
        public void accept(float var1, V var2, long var3, X var5);
    }

    @FunctionalInterface
    public static interface FloatBiObjFloatConsumer<V, X> {
        public void accept(float var1, V var2, float var3, X var4);
    }

    @FunctionalInterface
    public static interface FloatBiObjDoubleConsumer<V, X> {
        public void accept(float var1, V var2, double var3, X var5);
    }
    ...
    @FunctionalInterface
    public static interface FloatObjFunction<V, J> {
        public J apply(float var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            FloatObjConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            FloatObjFunction transformer = this.transformer;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            ...
            FloatObjFunction searchFunction = this.searchFunction;
    ...
    @FunctionalInterface
    public static interface FloatBiObjFunction<V, X, J> {
        public J apply(float var1, V var2, X var3);
    }

    @FunctionalInterface
    public static interface FloatObjByteFunction<V, J> {
        public J apply(float var1, V var2, byte var3);
    }

    @FunctionalInterface
    public static interface FloatObjShortFunction<V, J> {
        public J apply(float var1, V var2, short var3);
    }

    @FunctionalInterface
    public static interface FloatObjIntFunction<V, J> {
        public J apply(float var1, V var2, int var3);
    }

    @FunctionalInterface
    public static interface FloatObjLongFunction<V, J> {
        public J apply(float var1, V var2, long var3);
    }

    @FunctionalInterface
    public static interface FloatObjFloatFunction<V, J> {
        public J apply(float var1, V var2, float var3);
    }

    @FunctionalInterface
    public static interface FloatObjDoubleFunction<V, J> {
        public J apply(float var1, V var2, double var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToDoubleFloatObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToDoubleFloatObjFunction<V> {
        public double applyAsDouble(float var1, V var2);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToLongFloatObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToLongFloatObjFunction<V> {
        public long applyAsLong(float var1, V var2);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            ...
            ToIntFloatObjFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface ToIntFloatObjFunction<V> {
        public int applyAsInt(float var1, V var2);
    }
    ...
    extends BulkTask<V, Void> {
        ...
        @Override
        public final void compute() {
            FloatConsumer action = this.action;
            if (action != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, Void> {
        ...
        public final void compute() {
            Consumer<U> action;
            FloatFunction<U> transformer = this.transformer;
            if (transformer != null && (action = this.action) != null) {
                Node p;
                int f;
                int h;
    ...
    extends BulkTask<V, U> {
        ...
        public final void compute() {
            AtomicReference<U> result;
            FloatFunction<U> searchFunction = this.searchFunction;
            if (searchFunction != null && (result = this.result) != null) {
                int f;
                int h;
                int i = this.baseIndex;
    ...
    extends FloatReturningBulkTask2<V> {
        public final float EMPTY;
        ...
        @Override
        public final void compute() {
            FloatReduceTaskOperator reducer = this.reducer;
            if (reducer != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface FloatReduceTaskOperator {
        public float reduce(float var1, float var2, float var3);
    }
    ...
    extends DoubleReturningBulkTask<V> {
        ...
        public final void compute() {
            DoubleBinaryOperator reducer;
            FloatToDoubleFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface FloatToDoubleFunction {
        public double applyAsDouble(float var1);
    }
    ...
    extends LongReturningBulkTask<V> {
        ...
        public final void compute() {
            LongBinaryOperator reducer;
            FloatToLongFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface FloatToLongFunction {
        public long applyAsLong(float var1);
    }
    ...
    extends IntReturningBulkTask<V> {
        ...
        public final void compute() {
            IntBinaryOperator reducer;
            FloatToIntFunction transformer = this.transformer;
            if (transformer != null && (reducer = this.reducer) != null) {
                Node p;
                int f;
                int h;
    ...
    @FunctionalInterface
    public static interface FloatToIntFunction {
    ...
    extends Float2ObjectMap.Entry<V> {
        public boolean isEmpty();
    ...
    protected static abstract class FloatReturningBulkTask2<V>
    extends BulkTask<V, Float> {
        public float result;
    ...
    implements FloatSpliterator {
        ...
        public boolean tryAdvance(Consumer<? super Float> action) {
            if (action instanceof FloatConsumer) {
                return this.tryAdvance((FloatConsumer)action);
            }
            return this.tryAdvance((float value) -> action.accept(Float.valueOf(value)));
        }
    ...
    implements Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Entry) {
                ...
                if (!this.empty && this.key != ((Entry)o).getFloatKey()) {
                    return false;
                }
                return this.val.equals(((Entry)o).getValue());
            }
