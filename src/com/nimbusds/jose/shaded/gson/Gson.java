...
public final class Gson {
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
        ...
        if (candidate == null) {
            throw new IllegalArgumentException("GSON (2.13.1) cannot handle " + type);
        }
        if (isInitialAdapterRequest) {
    ...
    public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
        ...
        try {
            ...
            throw new AssertionError("AssertionError (GSON 2.13.1): " + ((Throwable)((Object)e)).getMessage(), (Throwable)((Object)e));
        }
        finally {
    ...
    public <T> T fromJson(String json, Class<T> classOfT) throws JsonSyntaxException {
        return this.fromJson(json, TypeToken.get(classOfT));
    }
    ...
    public <T> T fromJson(JsonReader reader, TypeToken<T> typeOfT) throws JsonIOException, JsonSyntaxException {
        ...
        try {
            ...
            Class<T> expectedTypeWrapped = Primitives.wrap(typeOfT.getRawType());
