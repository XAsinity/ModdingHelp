...
public final class JWKParameterNames {
    ...
    public static final Set<String> PUBLIC = new HashSet<String>(Arrays.asList("kty", "use", "key_ops", "alg", "kid", "x5u", "x5c", "x5t", "x5t#S256", "exp", "nbf", "iat", "revoked", "crv", "x", "y", "n", "e", "crv", "x"));
