...
public enum DateTimeFormat {
    ...
    static {
        HashMap<Character, DateTimeFormat> map = new HashMap<Character, DateTimeFormat>();
        for (DateTimeFormat dtf : DateTimeFormat.values()) {
            if (map.put(Character.valueOf(dtf.formatChar), dtf) == null) continue;
            throw new IllegalStateException("duplicate format character: " + (Object)((Object)dtf));
        }
