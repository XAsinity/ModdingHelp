...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject object) throws JsonIOException {
        try {
            ...
            throw new JsonIOException("Failed making " + description + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type." + ReflectionHelper.getInaccessibleTroubleshootingSuffix(exception), exception);
        }
    }
