...
extends GeneratedFile {
    ...
    static {
        ...
        internal_static_google_protobuf_Api_descriptor = ApiProto.getDescriptor().getMessageType(0);
        internal_static_google_protobuf_Api_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_protobuf_Api_descriptor, new String[]{"Name", "Methods", "Options", "Version", "SourceContext", "Mixins", "Syntax", "Edition"});
        internal_static_google_protobuf_Method_descriptor = ApiProto.getDescriptor().getMessageType(1);
        internal_static_google_protobuf_Method_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_protobuf_Method_descriptor, new String[]{"Name", "RequestTypeUrl", "RequestStreaming", "ResponseTypeUrl", "ResponseStreaming", "Options", "Syntax", "Edition"});
        internal_static_google_protobuf_Mixin_descriptor = ApiProto.getDescriptor().getMessageType(2);
