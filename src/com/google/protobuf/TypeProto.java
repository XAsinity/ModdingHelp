...
extends GeneratedFile {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 33, 0, "", "TypeProto");
        ...
        internal_static_google_protobuf_Type_descriptor = TypeProto.getDescriptor().getMessageType(0);
        ...
        internal_static_google_protobuf_Field_descriptor = TypeProto.getDescriptor().getMessageType(1);
        ...
        internal_static_google_protobuf_Enum_descriptor = TypeProto.getDescriptor().getMessageType(2);
        ...
        internal_static_google_protobuf_EnumValue_descriptor = TypeProto.getDescriptor().getMessageType(3);
        ...
        internal_static_google_protobuf_Option_descriptor = TypeProto.getDescriptor().getMessageType(4);
