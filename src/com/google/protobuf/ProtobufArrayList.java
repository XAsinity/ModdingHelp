...
implements RandomAccess {
    ...
    private static final ProtobufArrayList<Object> EMPTY_LIST = new ProtobufArrayList<Object>(EMPTY_ARRAY, 0, false);
    private E[] array;
    private int size;
    ...
    public ProtobufArrayList<E> mutableCopyWithCapacity(int capacity) {
        ...
        Object[] newArray = capacity == 0 ? EMPTY_ARRAY : Arrays.copyOf(this.array, capacity);
        return new ProtobufArrayList<Object>(newArray, this.size, true);
    }
    ...
    public boolean add(E element) {
        ...
        if (this.size == this.array.length) {
            int length = ProtobufArrayList.growSize(this.array.length);
    ...
    void ensureCapacity(int minCapacity) {
        ...
        while (n < minCapacity) {
            n = ProtobufArrayList.growSize(n);
        }
