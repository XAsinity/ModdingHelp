...
extends ByteOutput {
    ...
    public static int computeGroupSize(int fieldNumber, MessageLite value) {
        return CodedOutputStream.computeTagSize(fieldNumber) * 2 + value.getSerializedSize();
    }
    ...
    extends CodedOutputStream {
        ...
        public final void write(byte value) throws IOException {
            ...
            try {
                ...
                throw new OutOfSpaceException(position, this.limit, 1, (Throwable)e);
            }
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            ...
            try {
                while (true) {
                    ...
                    this.buffer[position++] = (byte)(value | 0x80);
                    value >>>= 7;
                }
            }
            catch (IndexOutOfBoundsException e) {
        ...
        public final void writeFixed32NoTag(int value) throws IOException {
            ...
            try {
                ...
                throw new OutOfSpaceException(position, this.limit, 4, (Throwable)e);
            }
                ...
                if (HAS_UNSAFE_ARRAY_OPERATIONS && this.spaceLeft() >= 10) {
                    while (true) {
                        if ((value & 0xFFFFFFFFFFFFFF80L) == 0L) {
                            UnsafeUtil.putByte(this.buffer, (long)position++, (byte)value);
                            break block7;
                        }
                        UnsafeUtil.putByte(this.buffer, (long)position++, (byte)((int)value | 0x80));
                        value >>>= 7;
                    }
                }
                try {
                    while (true) {
                        ...
                        this.buffer[position++] = (byte)((int)value | 0x80);
                        value >>>= 7;
                    }
                }
                catch (IndexOutOfBoundsException e) {
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            ...
            try {
                ...
                throw new OutOfSpaceException(position, this.limit, 8, (Throwable)e);
            }
        ...
        public final void write(byte[] value, int offset, int length) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, length, (Throwable)e);
            }
            this.position += length;
        }
    ...
    extends CodedOutputStream {
            ...
            block6: {
                ...
                while (true) {
                    if (position >= this.limit) {
                        throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", position, this.limit, 1));
                    }
                    if ((value & 0xFFFFFF80) == 0) {
                        UnsafeUtil.putByte(position++, (byte)value);
                        break;
        ...
        public void writeFixed32NoTag(int value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, 4, (Throwable)e);
            }
            this.position += 4L;
        }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            ...
            block6: {
                ...
                while (true) {
                    if (position >= this.limit) {
                        throw new OutOfSpaceException(position, this.limit, 1);
                    }
                    if ((value & 0xFFFFFFFFFFFFFF80L) == 0L) {
                        UnsafeUtil.putByte(position++, (byte)value);
                        break;
        ...
        public void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, 8, (Throwable)e);
            }
            this.position += 8L;
        }
