...
class MacConfigurationV1 {
    private static final InternalConfiguration INTERNAL_CONFIGURATION = MacConfigurationV1.create();
    ...
    private static InternalConfiguration create() {
        try {
            ...
            builder.registerPrimitiveConstructor(PrimitiveConstructor.create(MacConfigurationV1::createAesCmac, AesCmacKey.class, Mac.class));
            builder.registerPrimitiveConstructor(PrimitiveConstructor.create(PrfMac::create, HmacKey.class, Mac.class));
            builder.registerPrimitiveConstructor(PrimitiveConstructor.create(MacConfigurationV1::createChunkedAesCmac, AesCmacKey.class, ChunkedMac.class));
