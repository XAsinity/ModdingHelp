...
implements StreamingPrf {
    ...
    private static String getJavaxHmacName(Enums.HashType hashType) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException("No getJavaxHmacName for given hash " + (Object)((Object)hashType) + " known");
    }
    ...
    public static StreamingPrf create(HkdfPrfKey key) throws GeneralSecurityException {
        ...
        return new HkdfStreamingPrf(HASH_TYPE_CONVERTER.toProtoEnum(key.getParameters().getHashType()), key.getKeyBytes().toByteArray(InsecureSecretKeyAccess.get()), saltFromKey == null ? new byte[]{} : saltFromKey.toByteArray());
    }
