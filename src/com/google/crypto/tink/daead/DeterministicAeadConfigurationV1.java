...
class DeterministicAeadConfigurationV1 {
    private static final InternalConfiguration INTERNAL_CONFIGURATION = DeterministicAeadConfigurationV1.create();
    ...
    private static InternalConfiguration create() {
        try {
            ...
            builder.registerPrimitiveConstructor(PrimitiveConstructor.create(DeterministicAeadConfigurationV1::createAesSiv, AesSivKey.class, DeterministicAead.class));
