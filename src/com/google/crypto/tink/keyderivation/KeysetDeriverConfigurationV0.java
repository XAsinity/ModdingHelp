...
class KeysetDeriverConfigurationV0 {
    private static final InternalConfiguration INTERNAL_CONFIGURATION = KeysetDeriverConfigurationV0.create();
    private static final PrimitiveRegistry PRF_REGISTRY = KeysetDeriverConfigurationV0.createPrfRegistry();
    ...
    private static InternalConfiguration create() {
        try {
            ...
            builder.registerPrimitiveConstructor(PrimitiveConstructor.create(KeysetDeriverConfigurationV0::createHkdfPrfBasedKeyDeriver, PrfBasedKeyDerivationKey.class, KeyDeriver.class));
