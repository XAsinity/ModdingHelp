...
public final class HmacPrfKeyManager {
    ...
    private static final KeyManager<Prf> legacyKeyManager = LegacyKeyManagerImpl.create(HmacPrfKeyManager.getKeyType(), Prf.class, KeyData.KeyMaterialType.SYMMETRIC, com.google.crypto.tink.proto.HmacPrfKey.parser());
