...
public final class PrfKeyTemplates {
    public static final KeyTemplate HKDF_SHA256 = PrfKeyTemplates.createHkdfKeyTemplate();
    public static final KeyTemplate HMAC_SHA256_PRF = PrfKeyTemplates.createHmacTemplate(32, HashType.SHA256);
    public static final KeyTemplate HMAC_SHA512_PRF = PrfKeyTemplates.createHmacTemplate(64, HashType.SHA512);
    public static final KeyTemplate AES_CMAC_PRF = PrfKeyTemplates.createAes256CmacTemplate();
