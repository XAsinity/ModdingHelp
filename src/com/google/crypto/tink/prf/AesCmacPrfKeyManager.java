...
public final class AesCmacPrfKeyManager {
    private static final PrimitiveConstructor<AesCmacPrfKey, Prf> PRF_PRIMITIVE_CONSTRUCTOR = PrimitiveConstructor.create(AesCmacPrfKeyManager::createPrimitive, AesCmacPrfKey.class, Prf.class);
    private static final KeyManager<Prf> legacyKeyManager = LegacyKeyManagerImpl.create(AesCmacPrfKeyManager.getKeyType(), Prf.class, KeyData.KeyMaterialType.SYMMETRIC, com.google.crypto.tink.proto.AesCmacPrfKey.parser());
    ...
    private static Prf createPrimitive(AesCmacPrfKey key) throws GeneralSecurityException {
        AesCmacPrfKeyManager.validate(key.getParameters());
    ...
    private static AesCmacPrfKey newKey(AesCmacPrfParameters parameters, @Nullable Integer idRequirement) throws GeneralSecurityException {
        ...
        AesCmacPrfKeyManager.validate(parameters);
