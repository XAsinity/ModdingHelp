...
public final class HpkePrivateKeyManager {
    private static final PrimitiveConstructor<HpkePrivateKey, HybridDecrypt> HYBRID_DECRYPT_PRIMITIVE_CONSTRUCTOR = PrimitiveConstructor.create(HpkeDecrypt::create, HpkePrivateKey.class, HybridDecrypt.class);
    private static final PrimitiveConstructor<HpkePublicKey, HybridEncrypt> HYBRID_ENCRYPT_PRIMITIVE_CONSTRUCTOR = PrimitiveConstructor.create(HpkeEncrypt::create, HpkePublicKey.class, HybridEncrypt.class);
    private static final PrivateKeyManager<HybridDecrypt> legacyPrivateKeyManager = LegacyKeyManagerImpl.createPrivateKeyManager(HpkePrivateKeyManager.getKeyType(), HybridDecrypt.class, com.google.crypto.tink.proto.HpkePrivateKey.parser());
    ...
    public static void registerPair(boolean newKeyAllowed) throws GeneralSecurityException {
        ...
        MutableParametersRegistry.globalInstance().putAll(HpkePrivateKeyManager.namedParameters());
    ...
    private static Map<String, Parameters> namedParameters() throws GeneralSecurityException {
        HashMap<String, HpkeParameters> result = new HashMap<String, HpkeParameters>();
