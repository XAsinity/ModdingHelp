...
extends SignaturePrivateKey {
    ...
    public static Ed25519PrivateKey create(Ed25519PublicKey publicKey, SecretBytes privateKeyBytes) throws GeneralSecurityException {
        ...
        if (!Arrays.equals(publicKeyBytes, expectedPublicKeyBytes = Ed25519.scalarMultWithBaseToBytes(Ed25519.getHashedScalar(secretSeed = privateKeyBytes.toByteArray(InsecureSecretKeyAccess.get()))))) {
