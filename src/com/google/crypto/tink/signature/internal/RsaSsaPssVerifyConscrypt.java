...
implements PublicKeyVerify {
    ...
    public static PublicKeyVerify create(RsaSsaPssPublicKey key) throws GeneralSecurityException {
        ...
        return RsaSsaPssVerifyConscrypt.createWithProvider(key, conscrypt);
    }
    ...
    public static PublicKeyVerify createWithProvider(RsaSsaPssPublicKey key, Provider conscrypt) throws GeneralSecurityException {
        ...
        return new RsaSsaPssVerifyConscrypt(publicKey, params.getSigHashType(), params.getMgf1HashType(), params.getSaltLengthBytes(), key.getOutputPrefix().toByteArray(), key.getParameters().getVariant().equals(RsaSsaPssParameters.Variant.LEGACY) ? legacyMessageSuffix : EMPTY, conscrypt);
    }
