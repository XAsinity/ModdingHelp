...
extends GeneratedFile {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", Config.class.getName());
        ...
        internal_static_google_crypto_tink_KeyTypeEntry_descriptor = Config.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_RegistryConfig_descriptor = Config.getDescriptor().getMessageTypes().get(1);
