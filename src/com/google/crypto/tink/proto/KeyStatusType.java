...
public enum KeyStatusType implements ProtocolMessageEnum
{
    ...
    public static KeyStatusType valueOf(int value) {
        return KeyStatusType.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return KeyStatusType.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return KeyStatusType.getDescriptor();
    }
    ...
    public static KeyStatusType valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != KeyStatusType.getDescriptor()) {
