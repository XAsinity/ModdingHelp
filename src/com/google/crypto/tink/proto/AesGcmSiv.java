...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesGcmSiv.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_AesGcmSivKeyFormat_descriptor = AesGcmSiv.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesGcmSivKey_descriptor = AesGcmSiv.getDescriptor().getMessageTypes().get(1);
