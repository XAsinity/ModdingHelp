...
import com.google.crypto.tink.proto.XAesGcmKeyOrBuilder;
...
implements XAesGcmKeyOrBuilder {
    ...
    private static final Parser<XAesGcmKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + XAesGcmKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<XAesGcmKey>(){
