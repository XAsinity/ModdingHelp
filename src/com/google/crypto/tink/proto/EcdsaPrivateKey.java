...
import com.google.crypto.tink.proto.EcdsaPrivateKeyOrBuilder;
...
implements EcdsaPrivateKeyOrBuilder {
    ...
    private static final Parser<EcdsaPrivateKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + EcdsaPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<EcdsaPrivateKey>(){
