...
import com.google.crypto.tink.proto.RsaSsaPssPrivateKeyOrBuilder;
...
implements RsaSsaPssPrivateKeyOrBuilder {
    ...
    private static final Parser<RsaSsaPssPrivateKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + RsaSsaPssPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<RsaSsaPssPrivateKey>(){
