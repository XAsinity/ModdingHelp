...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        KmsEnvelope.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", KmsEnvelope.class.getName());
        ...
        internal_static_google_crypto_tink_KmsEnvelopeAeadKeyFormat_descriptor = KmsEnvelope.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_KmsEnvelopeAeadKey_descriptor = KmsEnvelope.getDescriptor().getMessageTypes().get(1);
