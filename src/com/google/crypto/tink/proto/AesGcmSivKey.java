...
implements AesGcmSivKeyOrBuilder {
    ...
    private static final Parser<AesGcmSivKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AesGcmSivKey)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesGcmSivKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<AesGcmSivKey>(){
