...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesSiv.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesSiv.class.getName());
        ...
        internal_static_google_crypto_tink_AesSivKeyFormat_descriptor = AesSiv.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesSivKey_descriptor = AesSiv.getDescriptor().getMessageTypes().get(1);
