...
import com.google.crypto.tink.proto.HpkeKeyFormatOrBuilder;
...
public final class HpkeKeyFormat
...
implements HpkeKeyFormatOrBuilder {
    ...
    private static final Parser<HpkeKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HpkeKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HpkeKeyFormat.getDescriptor().hashCode();
        if (this.hasParams()) {
            hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return HpkeKeyFormat.newBuilder();
    }
    ...
    static {
        ...
        PARSER = new AbstractParser<HpkeKeyFormat>(){
