...
import com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKeyOrBuilder;
...
implements RsaSsaPkcs1PrivateKeyOrBuilder {
    ...
    private static final Parser<RsaSsaPkcs1PrivateKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + RsaSsaPkcs1PrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", RsaSsaPkcs1PrivateKey.class.getName());
        DEFAULT_INSTANCE = new RsaSsaPkcs1PrivateKey();
        PARSER = new AbstractParser<RsaSsaPkcs1PrivateKey>(){
    ...
    implements RsaSsaPkcs1PrivateKeyOrBuilder {
        ...
        private SingleFieldBuilder<RsaSsaPkcs1PublicKey, RsaSsaPkcs1PublicKey.Builder, RsaSsaPkcs1PublicKeyOrBuilder> internalGetPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
