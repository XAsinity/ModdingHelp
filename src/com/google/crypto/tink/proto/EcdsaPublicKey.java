...
implements EcdsaPublicKeyOrBuilder {
    ...
    private static final Parser<EcdsaPublicKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + EcdsaPublicKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", EcdsaPublicKey.class.getName());
        DEFAULT_INSTANCE = new EcdsaPublicKey();
        PARSER = new AbstractParser<EcdsaPublicKey>(){
