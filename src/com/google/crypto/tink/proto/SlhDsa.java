...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        SlhDsa.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_SlhDsaParams_descriptor = SlhDsa.getDescriptor().getMessageTypes().get(0);
        internal_static_google_crypto_tink_SlhDsaParams_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_SlhDsaParams_descriptor, new String[]{"KeySize", "HashType", "SigType"});
        internal_static_google_crypto_tink_SlhDsaKeyFormat_descriptor = SlhDsa.getDescriptor().getMessageTypes().get(1);
        internal_static_google_crypto_tink_SlhDsaKeyFormat_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_SlhDsaKeyFormat_descriptor, new String[]{"Version", "Params"});
        internal_static_google_crypto_tink_SlhDsaPublicKey_descriptor = SlhDsa.getDescriptor().getMessageTypes().get(2);
        internal_static_google_crypto_tink_SlhDsaPublicKey_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_SlhDsaPublicKey_descriptor, new String[]{"Version", "KeyValue", "Params"});
        internal_static_google_crypto_tink_SlhDsaPrivateKey_descriptor = SlhDsa.getDescriptor().getMessageTypes().get(3);
        internal_static_google_crypto_tink_SlhDsaPrivateKey_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_SlhDsaPrivateKey_descriptor, new String[]{"Version", "KeyValue", "PublicKey"});
