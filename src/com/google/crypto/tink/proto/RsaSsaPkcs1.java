...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        RsaSsaPkcs1.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", RsaSsaPkcs1.class.getName());
        ...
        internal_static_google_crypto_tink_RsaSsaPkcs1Params_descriptor = RsaSsaPkcs1.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_RsaSsaPkcs1PublicKey_descriptor = RsaSsaPkcs1.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_RsaSsaPkcs1PrivateKey_descriptor = RsaSsaPkcs1.getDescriptor().getMessageTypes().get(2);
        ...
        internal_static_google_crypto_tink_RsaSsaPkcs1KeyFormat_descriptor = RsaSsaPkcs1.getDescriptor().getMessageTypes().get(3);
