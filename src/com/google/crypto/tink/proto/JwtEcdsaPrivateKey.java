...
import com.google.crypto.tink.proto.JwtEcdsaPrivateKeyOrBuilder;
...
implements JwtEcdsaPrivateKeyOrBuilder {
    ...
    private static final Parser<JwtEcdsaPrivateKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + JwtEcdsaPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<JwtEcdsaPrivateKey>(){
