...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        JwtEcdsa.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", JwtEcdsa.class.getName());
        ...
        internal_static_google_crypto_tink_JwtEcdsaPublicKey_descriptor = JwtEcdsa.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtEcdsaPublicKey_CustomKid_descriptor = internal_static_google_crypto_tink_JwtEcdsaPublicKey_descriptor.getNestedTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtEcdsaPrivateKey_descriptor = JwtEcdsa.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_JwtEcdsaKeyFormat_descriptor = JwtEcdsa.getDescriptor().getMessageTypes().get(2);
