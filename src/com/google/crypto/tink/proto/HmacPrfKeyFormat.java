...
import com.google.crypto.tink.proto.HmacPrf;
import com.google.crypto.tink.proto.HmacPrfKeyFormatOrBuilder;
...
public final class HmacPrfKeyFormat
extends GeneratedMessage
implements HmacPrfKeyFormatOrBuilder {
    ...
    private static final Parser<HmacPrfKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HmacPrfKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HmacPrfKeyFormat.getDescriptor().hashCode();
        if (this.hasParams()) {
            hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return HmacPrfKeyFormat.newBuilder();
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HmacPrfKeyFormat.class.getName());
        DEFAULT_INSTANCE = new HmacPrfKeyFormat();
        PARSER = new AbstractParser<HmacPrfKeyFormat>(){
