...
import com.google.crypto.tink.proto.RsaSsaPssKeyFormatOrBuilder;
...
public final class RsaSsaPssKeyFormat
extends GeneratedMessage
implements RsaSsaPssKeyFormatOrBuilder {
    ...
    private static final Parser<RsaSsaPssKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RsaSsaPssKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + RsaSsaPssKeyFormat.getDescriptor().hashCode();
        if (this.hasParams()) {
            hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<RsaSsaPssKeyFormat>(){
