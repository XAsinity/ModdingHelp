...
public enum JwtRsaSsaPkcs1Algorithm implements ProtocolMessageEnum
{
    ...
    public static JwtRsaSsaPkcs1Algorithm valueOf(int value) {
        return JwtRsaSsaPkcs1Algorithm.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return JwtRsaSsaPkcs1Algorithm.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return JwtRsaSsaPkcs1Algorithm.getDescriptor();
    }
    ...
    public static JwtRsaSsaPkcs1Algorithm valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != JwtRsaSsaPkcs1Algorithm.getDescriptor()) {
    ...
    static {
        ...
        VALUES = JwtRsaSsaPkcs1Algorithm.values();
    }
}
