...
import com.google.crypto.tink.proto.JwtRsaSsaPssPrivateKeyOrBuilder;
...
implements JwtRsaSsaPssPrivateKeyOrBuilder {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + JwtRsaSsaPssPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
