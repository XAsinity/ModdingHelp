...
import com.google.crypto.tink.proto.Ed25519KeyFormatOrBuilder;
...
public final class Ed25519KeyFormat
...
implements Ed25519KeyFormatOrBuilder {
    ...
    private static final Parser<Ed25519KeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Ed25519KeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Ed25519KeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return Ed25519KeyFormat.newBuilder();
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", Ed25519KeyFormat.class.getName());
        DEFAULT_INSTANCE = new Ed25519KeyFormat();
        PARSER = new AbstractParser<Ed25519KeyFormat>(){
