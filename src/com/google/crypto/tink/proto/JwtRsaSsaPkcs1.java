...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        JwtRsaSsaPkcs1.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", JwtRsaSsaPkcs1.class.getName());
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPkcs1PublicKey_descriptor = JwtRsaSsaPkcs1.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPkcs1PublicKey_CustomKid_descriptor = internal_static_google_crypto_tink_JwtRsaSsaPkcs1PublicKey_descriptor.getNestedTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPkcs1PrivateKey_descriptor = JwtRsaSsaPkcs1.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPkcs1KeyFormat_descriptor = JwtRsaSsaPkcs1.getDescriptor().getMessageTypes().get(2);
