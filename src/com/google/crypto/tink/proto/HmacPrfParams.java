...
public final class HmacPrfParams
...
implements HmacPrfParamsOrBuilder {
    ...
    private static final Parser<HmacPrfParams> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HmacPrfParams)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HmacPrfParams.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return HmacPrfParams.newBuilder();
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HmacPrfParams.class.getName());
        DEFAULT_INSTANCE = new HmacPrfParams();
        PARSER = new AbstractParser<HmacPrfParams>(){
