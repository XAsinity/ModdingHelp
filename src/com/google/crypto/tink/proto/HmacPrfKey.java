...
import com.google.crypto.tink.proto.HmacPrfKeyOrBuilder;
...
implements HmacPrfKeyOrBuilder {
    ...
    private static final Parser<HmacPrfKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HmacPrfKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HmacPrfKey.class.getName());
        DEFAULT_INSTANCE = new HmacPrfKey();
        PARSER = new AbstractParser<HmacPrfKey>(){
