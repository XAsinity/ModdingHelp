...
import com.google.crypto.tink.proto.JwtRsaSsaPssKeyFormatOrBuilder;
...
public final class JwtRsaSsaPssKeyFormat
extends GeneratedMessage
implements JwtRsaSsaPssKeyFormatOrBuilder {
    ...
    private static final Parser<JwtRsaSsaPssKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JwtRsaSsaPssKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + JwtRsaSsaPssKeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<JwtRsaSsaPssKeyFormat>(){
