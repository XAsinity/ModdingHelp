...
public enum EllipticCurveType implements ProtocolMessageEnum
{
    ...
    public static EllipticCurveType valueOf(int value) {
        return EllipticCurveType.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return EllipticCurveType.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return EllipticCurveType.getDescriptor();
    }
    ...
    public static EllipticCurveType valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != EllipticCurveType.getDescriptor()) {
    ...
    static {
        ...
        VALUES = EllipticCurveType.values();
    }
}
