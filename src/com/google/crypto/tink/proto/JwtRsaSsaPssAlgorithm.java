...
public enum JwtRsaSsaPssAlgorithm implements ProtocolMessageEnum
{
    ...
    public static JwtRsaSsaPssAlgorithm valueOf(int value) {
        return JwtRsaSsaPssAlgorithm.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return JwtRsaSsaPssAlgorithm.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return JwtRsaSsaPssAlgorithm.getDescriptor();
    }
    ...
    public static JwtRsaSsaPssAlgorithm valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != JwtRsaSsaPssAlgorithm.getDescriptor()) {
    ...
    static {
        ...
        VALUES = JwtRsaSsaPssAlgorithm.values();
    }
}
