...
implements HmacKeyOrBuilder {
    ...
    private static final Parser<HmacKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HmacKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HmacKey.class.getName());
        DEFAULT_INSTANCE = new HmacKey();
        PARSER = new AbstractParser<HmacKey>(){
