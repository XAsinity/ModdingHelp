...
public final class AesCmacKeyFormat
extends GeneratedMessage
implements AesCmacKeyFormatOrBuilder {
    ...
    private static final Parser<AesCmacKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AesCmacKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesCmacKeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<AesCmacKeyFormat>(){
