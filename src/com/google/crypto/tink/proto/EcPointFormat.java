...
public enum EcPointFormat implements ProtocolMessageEnum
{
    ...
    public static EcPointFormat valueOf(int value) {
        return EcPointFormat.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return EcPointFormat.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return EcPointFormat.getDescriptor();
    }
    ...
    public static EcPointFormat valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != EcPointFormat.getDescriptor()) {
