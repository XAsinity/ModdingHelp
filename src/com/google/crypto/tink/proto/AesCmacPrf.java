...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesCmacPrf.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_AesCmacPrfKey_descriptor = AesCmacPrf.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesCmacPrfKeyFormat_descriptor = AesCmacPrf.getDescriptor().getMessageTypes().get(1);
