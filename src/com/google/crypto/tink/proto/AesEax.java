...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesEax.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesEax.class.getName());
        ...
        internal_static_google_crypto_tink_AesEaxParams_descriptor = AesEax.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesEaxKeyFormat_descriptor = AesEax.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_AesEaxKey_descriptor = AesEax.getDescriptor().getMessageTypes().get(2);
