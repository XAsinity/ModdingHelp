...
implements AesGcmHkdfStreamingKeyFormatOrBuilder {
    ...
    private static final Parser<AesGcmHkdfStreamingKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AesGcmHkdfStreamingKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesGcmHkdfStreamingKeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 3;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesGcmHkdfStreamingKeyFormat.class.getName());
        DEFAULT_INSTANCE = new AesGcmHkdfStreamingKeyFormat();
        PARSER = new AbstractParser<AesGcmHkdfStreamingKeyFormat>(){
