...
implements AesEaxKeyOrBuilder {
    ...
    private static final Parser<AesEaxKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesEaxKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesEaxKey.class.getName());
        DEFAULT_INSTANCE = new AesEaxKey();
        PARSER = new AbstractParser<AesEaxKey>(){
