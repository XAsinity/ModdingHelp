...
import com.google.crypto.tink.proto.MlDsaPrivateKeyOrBuilder;
...
implements MlDsaPrivateKeyOrBuilder {
    ...
    private static final Parser<MlDsaPrivateKey> PARSER;
    ...
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return MlDsa.internal_static_google_crypto_tink_MlDsaPrivateKey_fieldAccessorTable.ensureFieldAccessorsInitialized(MlDsaPrivateKey.class, Builder.class);
    }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MlDsaPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return MlDsaPrivateKey.newBuilder();
    }
    ...
    static {
        ...
        DEFAULT_INSTANCE = new MlDsaPrivateKey();
        PARSER = new AbstractParser<MlDsaPrivateKey>(){
            ...
            public MlDsaPrivateKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                Builder builder = MlDsaPrivateKey.newBuilder();
                try {
    ...
    implements MlDsaPrivateKeyOrBuilder {
        ...
        public Builder mergeFrom(MlDsaPrivateKey other) {
