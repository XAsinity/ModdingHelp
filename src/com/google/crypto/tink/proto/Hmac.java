...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        Hmac.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_HmacParams_descriptor = Hmac.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_HmacKey_descriptor = Hmac.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_HmacKeyFormat_descriptor = Hmac.getDescriptor().getMessageTypes().get(2);
