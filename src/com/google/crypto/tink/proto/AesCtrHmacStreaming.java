...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesCtrHmacStreaming.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[]{Common.getDescriptor(), Hmac.getDescriptor()});
        internal_static_google_crypto_tink_AesCtrHmacStreamingParams_descriptor = AesCtrHmacStreaming.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesCtrHmacStreamingKeyFormat_descriptor = AesCtrHmacStreaming.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_AesCtrHmacStreamingKey_descriptor = AesCtrHmacStreaming.getDescriptor().getMessageTypes().get(2);
