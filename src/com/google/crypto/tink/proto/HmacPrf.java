...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        HmacPrf.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HmacPrf.class.getName());
        ...
        internal_static_google_crypto_tink_HmacPrfParams_descriptor = HmacPrf.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_HmacPrfKey_descriptor = HmacPrf.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_HmacPrfKeyFormat_descriptor = HmacPrf.getDescriptor().getMessageTypes().get(2);
