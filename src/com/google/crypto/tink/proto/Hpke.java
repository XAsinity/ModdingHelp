...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        Hpke.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_HpkeParams_descriptor = Hpke.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_HpkePublicKey_descriptor = Hpke.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_HpkePrivateKey_descriptor = Hpke.getDescriptor().getMessageTypes().get(2);
        ...
        internal_static_google_crypto_tink_HpkeKeyFormat_descriptor = Hpke.getDescriptor().getMessageTypes().get(3);
