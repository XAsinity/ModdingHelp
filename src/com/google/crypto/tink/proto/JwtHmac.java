...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        JwtHmac.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_JwtHmacKey_descriptor = JwtHmac.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtHmacKey_CustomKid_descriptor = internal_static_google_crypto_tink_JwtHmacKey_descriptor.getNestedTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtHmacKeyFormat_descriptor = JwtHmac.getDescriptor().getMessageTypes().get(1);
