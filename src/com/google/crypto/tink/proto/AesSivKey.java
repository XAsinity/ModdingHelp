...
implements AesSivKeyOrBuilder {
    ...
    private static final Parser<AesSivKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesSivKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesSivKey.class.getName());
        DEFAULT_INSTANCE = new AesSivKey();
        PARSER = new AbstractParser<AesSivKey>(){
