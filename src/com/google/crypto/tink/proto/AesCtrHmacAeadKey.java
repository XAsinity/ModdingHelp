...
implements AesCtrHmacAeadKeyOrBuilder {
    ...
    private static final Parser<AesCtrHmacAeadKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.hasAesCtrKey() != other.hasAesCtrKey()) {
            return false;
        }
        if (this.hasAesCtrKey() && !this.getAesCtrKey().equals(other.getAesCtrKey())) {
            return false;
        }
        if (this.hasHmacKey() != other.hasHmacKey()) {
            return false;
        }
        if (this.hasHmacKey() && !this.getHmacKey().equals(other.getHmacKey())) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesCtrHmacAeadKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<AesCtrHmacAeadKey>(){
