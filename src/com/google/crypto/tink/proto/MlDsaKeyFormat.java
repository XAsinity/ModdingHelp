...
import com.google.crypto.tink.proto.MlDsaKeyFormatOrBuilder;
...
public final class MlDsaKeyFormat
extends GeneratedMessage
implements MlDsaKeyFormatOrBuilder {
    ...
    private static final MlDsaKeyFormat DEFAULT_INSTANCE;
    private static final Parser<MlDsaKeyFormat> PARSER;
    ...
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return MlDsa.internal_static_google_crypto_tink_MlDsaKeyFormat_fieldAccessorTable.ensureFieldAccessorsInitialized(MlDsaKeyFormat.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MlDsaKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MlDsaKeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return MlDsaKeyFormat.newBuilder();
    }
    ...
    static {
        ...
        DEFAULT_INSTANCE = new MlDsaKeyFormat();
        PARSER = new AbstractParser<MlDsaKeyFormat>(){
            ...
            public MlDsaKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                Builder builder = MlDsaKeyFormat.newBuilder();
                try {
