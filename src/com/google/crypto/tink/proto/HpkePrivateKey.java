...
import com.google.crypto.tink.proto.HpkePrivateKeyOrBuilder;
...
implements HpkePrivateKeyOrBuilder {
    ...
    private static final Parser<HpkePrivateKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HpkePrivateKey)) {
        ...
        if (!this.getPrivateKey().equals(other.getPrivateKey())) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HpkePrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<HpkePrivateKey>(){
