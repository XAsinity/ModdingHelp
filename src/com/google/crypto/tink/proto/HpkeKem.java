...
public enum HpkeKem implements ProtocolMessageEnum
{
    ...
    public static HpkeKem valueOf(int value) {
        return HpkeKem.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return HpkeKem.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return HpkeKem.getDescriptor();
    }
    ...
    public static HpkeKem valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != HpkeKem.getDescriptor()) {
