...
import com.google.crypto.tink.proto.HkdfPrfKeyFormatOrBuilder;
...
public final class HkdfPrfKeyFormat
extends GeneratedMessage
implements HkdfPrfKeyFormatOrBuilder {
    ...
    private static final Parser<HkdfPrfKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HkdfPrfKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HkdfPrfKeyFormat.getDescriptor().hashCode();
        if (this.hasParams()) {
            hash = 37 * hash + 1;
    ...
    public Builder newBuilderForType() {
        return HkdfPrfKeyFormat.newBuilder();
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", HkdfPrfKeyFormat.class.getName());
        DEFAULT_INSTANCE = new HkdfPrfKeyFormat();
        PARSER = new AbstractParser<HkdfPrfKeyFormat>(){
