...
implements KmsAeadKeyOrBuilder {
    ...
    private static final Parser<KmsAeadKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + KmsAeadKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", KmsAeadKey.class.getName());
        DEFAULT_INSTANCE = new KmsAeadKey();
        PARSER = new AbstractParser<KmsAeadKey>(){
