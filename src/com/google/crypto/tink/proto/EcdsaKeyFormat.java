...
public final class EcdsaKeyFormat
extends GeneratedMessage
implements EcdsaKeyFormatOrBuilder {
    ...
    private static final Parser<EcdsaKeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EcdsaKeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + EcdsaKeyFormat.getDescriptor().hashCode();
        if (this.hasParams()) {
            hash = 37 * hash + 2;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", EcdsaKeyFormat.class.getName());
        DEFAULT_INSTANCE = new EcdsaKeyFormat();
        PARSER = new AbstractParser<EcdsaKeyFormat>(){
