...
import com.google.crypto.tink.proto.JwtRsaSsaPkcs1KeyFormatOrBuilder;
...
public final class JwtRsaSsaPkcs1KeyFormat
extends GeneratedMessage
implements JwtRsaSsaPkcs1KeyFormatOrBuilder {
    ...
    private static final Parser<JwtRsaSsaPkcs1KeyFormat> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JwtRsaSsaPkcs1KeyFormat)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + JwtRsaSsaPkcs1KeyFormat.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", JwtRsaSsaPkcs1KeyFormat.class.getName());
        DEFAULT_INSTANCE = new JwtRsaSsaPkcs1KeyFormat();
        PARSER = new AbstractParser<JwtRsaSsaPkcs1KeyFormat>(){
