...
implements Ed25519PublicKeyOrBuilder {
    ...
    private static final Parser<Ed25519PublicKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Ed25519PublicKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", Ed25519PublicKey.class.getName());
        DEFAULT_INSTANCE = new Ed25519PublicKey();
        PARSER = new AbstractParser<Ed25519PublicKey>(){
