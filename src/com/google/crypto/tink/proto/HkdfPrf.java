...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        HkdfPrf.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_HkdfPrfParams_descriptor = HkdfPrf.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_HkdfPrfKey_descriptor = HkdfPrf.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_HkdfPrfKeyFormat_descriptor = HkdfPrf.getDescriptor().getMessageTypes().get(2);
