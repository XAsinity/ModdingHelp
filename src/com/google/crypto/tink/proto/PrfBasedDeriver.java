...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        PrfBasedDeriver.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_PrfBasedDeriverParams_descriptor = PrfBasedDeriver.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_PrfBasedDeriverKeyFormat_descriptor = PrfBasedDeriver.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_PrfBasedDeriverKey_descriptor = PrfBasedDeriver.getDescriptor().getMessageTypes().get(2);
