...
import com.google.crypto.tink.proto.JwtRsaSsaPkcs1;
import com.google.crypto.tink.proto.JwtRsaSsaPkcs1PrivateKeyOrBuilder;
...
implements JwtRsaSsaPkcs1PrivateKeyOrBuilder {
    ...
    private static final Parser<JwtRsaSsaPkcs1PrivateKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JwtRsaSsaPkcs1PrivateKey)) {
        ...
        if (!this.getD().equals(other.getD())) {
            return false;
        }
        if (!this.getP().equals(other.getP())) {
            return false;
        }
        if (!this.getQ().equals(other.getQ())) {
            return false;
        }
        if (!this.getDp().equals(other.getDp())) {
            return false;
        }
        if (!this.getDq().equals(other.getDq())) {
            return false;
        }
        if (!this.getCrt().equals(other.getCrt())) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + JwtRsaSsaPkcs1PrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", JwtRsaSsaPkcs1PrivateKey.class.getName());
        DEFAULT_INSTANCE = new JwtRsaSsaPkcs1PrivateKey();
        PARSER = new AbstractParser<JwtRsaSsaPkcs1PrivateKey>(){
    ...
    implements JwtRsaSsaPkcs1PrivateKeyOrBuilder {
        ...
        private SingleFieldBuilder<JwtRsaSsaPkcs1PublicKey, JwtRsaSsaPkcs1PublicKey.Builder, JwtRsaSsaPkcs1PublicKeyOrBuilder> internalGetPublicKeyFieldBuilder() {
            if (this.publicKeyBuilder_ == null) {
