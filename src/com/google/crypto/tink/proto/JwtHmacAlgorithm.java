...
public enum JwtHmacAlgorithm implements ProtocolMessageEnum
{
    ...
    public static JwtHmacAlgorithm valueOf(int value) {
        return JwtHmacAlgorithm.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return JwtHmacAlgorithm.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return JwtHmacAlgorithm.getDescriptor();
    }
    ...
    public static JwtHmacAlgorithm valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != JwtHmacAlgorithm.getDescriptor()) {
    ...
    static {
        ...
        VALUES = JwtHmacAlgorithm.values();
    }
}
