...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        XAesGcm.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_XAesGcmParams_descriptor = XAesGcm.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_XAesGcmKeyFormat_descriptor = XAesGcm.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_XAesGcmKey_descriptor = XAesGcm.getDescriptor().getMessageTypes().get(2);
