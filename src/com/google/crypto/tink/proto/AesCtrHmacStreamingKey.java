...
implements AesCtrHmacStreamingKeyOrBuilder {
    ...
    private static final Parser<AesCtrHmacStreamingKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AesCtrHmacStreamingKey)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesCtrHmacStreamingKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<AesCtrHmacStreamingKey>(){
