...
implements AesCmacKeyOrBuilder {
    ...
    private static final Parser<AesCmacKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AesCmacKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", AesCmacKey.class.getName());
        DEFAULT_INSTANCE = new AesCmacKey();
        PARSER = new AbstractParser<AesCmacKey>(){
