...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        EciesAeadHkdf.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", EciesAeadHkdf.class.getName());
        ...
        descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[]{Common.getDescriptor(), Tink.getDescriptor()});
        internal_static_google_crypto_tink_EciesHkdfKemParams_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_EciesAeadDemParams_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_EciesAeadHkdfParams_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(2);
        ...
        internal_static_google_crypto_tink_EciesAeadHkdfPublicKey_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(3);
        ...
        internal_static_google_crypto_tink_EciesAeadHkdfPrivateKey_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(4);
        ...
        internal_static_google_crypto_tink_EciesAeadHkdfKeyFormat_descriptor = EciesAeadHkdf.getDescriptor().getMessageTypes().get(5);
