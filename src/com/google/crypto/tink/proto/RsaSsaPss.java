...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        RsaSsaPss.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_RsaSsaPssParams_descriptor = RsaSsaPss.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_RsaSsaPssPublicKey_descriptor = RsaSsaPss.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_RsaSsaPssPrivateKey_descriptor = RsaSsaPss.getDescriptor().getMessageTypes().get(2);
        ...
        internal_static_google_crypto_tink_RsaSsaPssKeyFormat_descriptor = RsaSsaPss.getDescriptor().getMessageTypes().get(3);
