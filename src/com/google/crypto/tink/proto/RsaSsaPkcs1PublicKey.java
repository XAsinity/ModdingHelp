...
implements RsaSsaPkcs1PublicKeyOrBuilder {
    ...
    private static final Parser<RsaSsaPkcs1PublicKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RsaSsaPkcs1PublicKey)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + RsaSsaPkcs1PublicKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", RsaSsaPkcs1PublicKey.class.getName());
        DEFAULT_INSTANCE = new RsaSsaPkcs1PublicKey();
        PARSER = new AbstractParser<RsaSsaPkcs1PublicKey>(){
