...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesCtrHmacAead.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[]{AesCtr.getDescriptor(), Hmac.getDescriptor()});
        internal_static_google_crypto_tink_AesCtrHmacAeadKeyFormat_descriptor = AesCtrHmacAead.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesCtrHmacAeadKey_descriptor = AesCtrHmacAead.getDescriptor().getMessageTypes().get(1);
