...
import com.google.crypto.tink.proto.EciesAeadHkdfPrivateKeyOrBuilder;
...
public final class EciesAeadHkdfPrivateKey
...
implements EciesAeadHkdfPrivateKeyOrBuilder {
    ...
    private static final Parser<EciesAeadHkdfPrivateKey> PARSER;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EciesAeadHkdfPrivateKey)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + EciesAeadHkdfPrivateKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<EciesAeadHkdfPrivateKey>(){
