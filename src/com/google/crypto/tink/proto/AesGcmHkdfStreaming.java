...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesGcmHkdfStreaming.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_AesGcmHkdfStreamingParams_descriptor = AesGcmHkdfStreaming.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesGcmHkdfStreamingKeyFormat_descriptor = AesGcmHkdfStreaming.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_AesGcmHkdfStreamingKey_descriptor = AesGcmHkdfStreaming.getDescriptor().getMessageTypes().get(2);
