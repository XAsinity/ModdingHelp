...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        JwtRsaSsaPss.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 32, 1, "", JwtRsaSsaPss.class.getName());
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPssPublicKey_descriptor = JwtRsaSsaPss.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPssPublicKey_CustomKid_descriptor = internal_static_google_crypto_tink_JwtRsaSsaPssPublicKey_descriptor.getNestedTypes().get(0);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPssPrivateKey_descriptor = JwtRsaSsaPss.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_JwtRsaSsaPssKeyFormat_descriptor = JwtRsaSsaPss.getDescriptor().getMessageTypes().get(2);
