...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        AesCmac.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_AesCmacParams_descriptor = AesCmac.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_AesCmacKey_descriptor = AesCmac.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_crypto_tink_AesCmacKeyFormat_descriptor = AesCmac.getDescriptor().getMessageTypes().get(2);
