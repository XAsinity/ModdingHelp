...
public enum OutputPrefixType implements ProtocolMessageEnum
{
    ...
    public static OutputPrefixType valueOf(int value) {
        return OutputPrefixType.forNumber(value);
    }
    ...
    public final Descriptors.EnumValueDescriptor getValueDescriptor() {
        ...
        return OutputPrefixType.getDescriptor().getValues().get(this.ordinal());
    }

    @Override
    public final Descriptors.EnumDescriptor getDescriptorForType() {
        return OutputPrefixType.getDescriptor();
    }
    ...
    public static OutputPrefixType valueOf(Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != OutputPrefixType.getDescriptor()) {
    ...
    static {
        ...
        VALUES = OutputPrefixType.values();
    }
}
