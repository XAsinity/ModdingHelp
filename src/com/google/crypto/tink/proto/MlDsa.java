...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        MlDsa.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_MlDsaParams_descriptor = MlDsa.getDescriptor().getMessageTypes().get(0);
        internal_static_google_crypto_tink_MlDsaParams_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_MlDsaParams_descriptor, new String[]{"MlDsaInstance"});
        internal_static_google_crypto_tink_MlDsaKeyFormat_descriptor = MlDsa.getDescriptor().getMessageTypes().get(1);
        internal_static_google_crypto_tink_MlDsaKeyFormat_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_MlDsaKeyFormat_descriptor, new String[]{"Version", "Params"});
        internal_static_google_crypto_tink_MlDsaPublicKey_descriptor = MlDsa.getDescriptor().getMessageTypes().get(2);
        internal_static_google_crypto_tink_MlDsaPublicKey_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_MlDsaPublicKey_descriptor, new String[]{"Version", "KeyValue", "Params"});
        internal_static_google_crypto_tink_MlDsaPrivateKey_descriptor = MlDsa.getDescriptor().getMessageTypes().get(3);
        internal_static_google_crypto_tink_MlDsaPrivateKey_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_google_crypto_tink_MlDsaPrivateKey_descriptor, new String[]{"Version", "KeyValue", "PublicKey"});
