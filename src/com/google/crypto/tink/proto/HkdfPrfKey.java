...
import com.google.crypto.tink.proto.HkdfPrfKeyOrBuilder;
...
implements HkdfPrfKeyOrBuilder {
    ...
    private static final Parser<HkdfPrfKey> PARSER;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + HkdfPrfKey.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    static {
        ...
        PARSER = new AbstractParser<HkdfPrfKey>(){
