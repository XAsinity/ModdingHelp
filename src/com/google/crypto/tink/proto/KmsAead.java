...
extends GeneratedFile {
    ...
    public static void registerAllExtensions(ExtensionRegistry registry) {
        KmsAead.registerAllExtensions((ExtensionRegistryLite)registry);
    }
    ...
    static {
        ...
        internal_static_google_crypto_tink_KmsAeadKeyFormat_descriptor = KmsAead.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_crypto_tink_KmsAeadKey_descriptor = KmsAead.getDescriptor().getMessageTypes().get(1);
