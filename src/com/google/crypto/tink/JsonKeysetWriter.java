...
implements KeysetWriter {
    ...
    public static KeysetWriter withFile(File file) throws IOException {
        return JsonKeysetWriter.withOutputStream(new FileOutputStream(file));
    }
    ...
    public static KeysetWriter withPath(String path) throws IOException {
        return JsonKeysetWriter.withOutputStream(new FileOutputStream(new File(path)));
    }
    ...
    public static KeysetWriter withPath(Path path) throws IOException {
        return JsonKeysetWriter.withOutputStream(new FileOutputStream(path.toFile()));
    }
