...
import io.netty.handler.codec.http3.Http3PushStreamServerInitializer;
...
public final class Http3ServerPushStreamManager {
    ...
    private Http3PushStreamServerInitializer pushStreamInitializer(final long pushId, final @Nullable ChannelHandler handler) {
