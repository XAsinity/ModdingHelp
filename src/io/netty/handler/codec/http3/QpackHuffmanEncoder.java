...
final class QpackHuffmanEncoder {
    ...
    implements ByteProcessor {
        ...
        public boolean process(byte value) {
            this.len += (long)QpackHuffmanEncoder.this.lengths[value & 0xFF];
            return true;
        }
    ...
    implements ByteProcessor {
        ...
        public boolean process(byte value) {
            int b = value & 0xFF;
            byte nbits = QpackHuffmanEncoder.this.lengths[b];
            this.current <<= nbits;
            this.current |= (long)QpackHuffmanEncoder.this.codes[b];
            this.n += nbits;
            while (this.n >= 8) {
                this.n -= 8;
