...
implements ChannelOutboundHandler {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        if (this.closeSent != null) {
            ...
            ctx.write(msg).addListener((GenericFutureListener)new PromiseNotifier(false, this.closeSent));
        } else {
    ...
    private void applyCloseSentTimeout(ChannelHandlerContext ctx) {
        ...
        this.closeSent.addListener((GenericFutureListener)new ChannelFutureListener((Future)((Object)timeoutTask)){
