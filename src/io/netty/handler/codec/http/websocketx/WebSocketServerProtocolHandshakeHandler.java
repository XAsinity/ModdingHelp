...
extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(final ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (httpObject instanceof HttpRequest) {
            ...
            try {
                final WebSocketServerHandshaker handshaker = WebSocketServerHandshakerFactory.resolveHandshaker(req, WebSocketServerProtocolHandshakeHandler.getWebSocketLocation(ctx.pipeline(), req, this.serverConfig.websocketPath()), this.serverConfig.subprotocols(), this.serverConfig.decoderConfig());
    ...
    private void applyHandshakeTimeout() {
        ...
        localHandshakePromise.addListener(new FutureListener<Void>((Future)((Object)timeoutFuture)){
