...
extends WebSocketClientExtensionHandler {
    ...
    public WebSocketClientCompressionHandler(int maxAllocation) {
        super(new PerMessageDeflateClientExtensionHandshaker(maxAllocation), new DeflateFrameClientExtensionHandshaker(false, maxAllocation), new DeflateFrameClientExtensionHandshaker(true, maxAllocation));
    }
}
