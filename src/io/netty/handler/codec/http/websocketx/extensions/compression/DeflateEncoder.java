...
extends WebSocketExtensionEncoder {
    ...
    private ByteBuf compressContent(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        if (this.encoder == null) {
            this.encoder = EmbeddedChannel.builder().handlers((ChannelHandler)ZlibCodecFactory.newZlibEncoder(ZlibWrapper.NONE, this.compressionLevel, this.windowSize, 8)).build();
        }
