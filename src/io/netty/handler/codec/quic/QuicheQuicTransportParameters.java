...
implements QuicTransportParameters {
    ...
    public String toString() {
        return StringUtil.simpleClassName(this) + "[maxIdleTimeout=" + this.maxIdleTimeout() + ", maxUdpPayloadSize=" + this.maxUdpPayloadSize() + ", initialMaxData=" + this.initialMaxData() + ", initialMaxStreamDataBidiLocal=" + this.initialMaxStreamDataBidiLocal() + ", initialMaxStreamDataBidiRemote=" + this.initialMaxStreamDataBidiRemote() + ", initialMaxStreamDataUni=" + this.initialMaxStreamDataUni() + ", initialMaxStreamsBidi=" + this.initialMaxStreamsBidi() + ", initialMaxStreamsUni=" + this.initialMaxStreamsUni() + ", ackDelayExponent=" + this.ackDelayExponent() + ", maxAckDelay=" + this.maxAckDelay() + ", disableActiveMigration=" + this.disableActiveMigration() + ", activeConnIdLimit=" + this.activeConnIdLimit() + ", maxDatagramFrameSize=" + this.maxDatagramFrameSize() + "]";
    }
}
