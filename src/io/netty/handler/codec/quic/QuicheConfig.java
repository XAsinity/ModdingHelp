        ...
        try {
            ...
            if (congestionControlAlgorithm != null) {
                switch (congestionControlAlgorithm) {
                    ...
                    default: {
                        throw new IllegalArgumentException("Unknown congestionControlAlgorithm: " + (Object)((Object)congestionControlAlgorithm));
                    }
                }
            }
