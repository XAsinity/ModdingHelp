...
implements QuicConnectionPathStats {
    ...
    public String toString() {
        return StringUtil.simpleClassName(this) + "[local=" + this.localAddress() + ", peer=" + this.peerAddress() + ", validationState=" + this.validationState() + ", active=" + this.active() + ", recv=" + this.recv() + ", sent=" + this.sent() + ", lost=" + this.lost() + ", retrans=" + this.retrans() + ", rtt=" + this.rtt() + ", cwnd=" + this.cwnd() + ", sentBytes=" + this.sentBytes() + ", recvBytes=" + this.recvBytes() + ", lostBytes=" + this.lostBytes() + ", streamRetransBytes=" + this.streamRetransBytes() + ", pmtu=" + this.pmtu() + ", deliveryRate=" + this.deliveryRate() + ']';
    }
}
