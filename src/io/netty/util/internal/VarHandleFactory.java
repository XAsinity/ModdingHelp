...
final class VarHandleFactory {
    ...
    private static MethodHandles.Lookup privateLookup(MethodHandles.Lookup lookup, Class<?> targetClass) {
        try {
            return PRIVATE_LOOKUP_IN.invokeExact(targetClass, lookup);
        }
        catch (Throwable e) {
    ...
    public static VarHandle privateFindVarHandle(MethodHandles.Lookup lookup, Class<?> declaringClass, String name, Class<?> type) {
        try {
            return FIND_VAR_HANDLE.invokeExact(VarHandleFactory.privateLookup(lookup, declaringClass), declaringClass, name, type);
        }
        catch (Throwable e) {
            throw new RuntimeException(e);
        }
    ...
    static {
        ...
        try {
            ...
            MethodHandle byteArrayViewHandle = lookup.findStatic(MethodHandles.class, "byteArrayViewVarHandle", MethodType.methodType(VarHandle.class, Class.class, ByteOrder.class));
            longLeArrayViewHandle = byteArrayViewHandle.invokeExact(long[].class, ByteOrder.LITTLE_ENDIAN);
            longBeArrayViewHandle = byteArrayViewHandle.invokeExact(long[].class, ByteOrder.BIG_ENDIAN);
            intLeArrayViewHandle = byteArrayViewHandle.invokeExact(int[].class, ByteOrder.LITTLE_ENDIAN);
            intBeArrayViewHandle = byteArrayViewHandle.invokeExact(int[].class, ByteOrder.BIG_ENDIAN);
            shortLeArrayViewHandle = byteArrayViewHandle.invokeExact(short[].class, ByteOrder.LITTLE_ENDIAN);
            shortBeArrayViewHandle = byteArrayViewHandle.invokeExact(short[].class, ByteOrder.BIG_ENDIAN);
            MethodHandle byteBufferViewHandle = lookup.findStatic(MethodHandles.class, "byteBufferViewVarHandle", MethodType.methodType(VarHandle.class, Class.class, ByteOrder.class));
            longLeByteBufferViewHandle = byteBufferViewHandle.invokeExact(long[].class, ByteOrder.LITTLE_ENDIAN);
            longBeByteBufferViewHandle = byteBufferViewHandle.invokeExact(long[].class, ByteOrder.BIG_ENDIAN);
            intLeByteBufferViewHandle = byteBufferViewHandle.invokeExact(int[].class, ByteOrder.LITTLE_ENDIAN);
            intBeByteBufferViewHandle = byteBufferViewHandle.invokeExact(int[].class, ByteOrder.BIG_ENDIAN);
            shortLeByteBufferViewHandle = byteBufferViewHandle.invokeExact(short[].class, ByteOrder.LITTLE_ENDIAN);
            shortBeByteBufferViewHandle = byteBufferViewHandle.invokeExact(short[].class, ByteOrder.BIG_ENDIAN);
            error = null;
        }
        catch (Throwable e) {
            error = e;
