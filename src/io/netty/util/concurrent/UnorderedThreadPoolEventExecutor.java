...
implements EventExecutor {
    ...
    public UnorderedThreadPoolEventExecutor(int corePoolSize, ThreadFactory threadFactory) {
        ...
        this.setThreadFactory(new AccountingThreadFactory(threadFactory, this.eventLoopThreads));
    }
    ...
    public boolean inEventLoop(Thread thread) {
        return this.eventLoopThreads.contains(thread);
    }
    ...
    private static final class AccountingThreadFactory
