...
extends AbstractEventExecutorGroup {
    ...
    public int activeExecutorCount() {
        if (this.chooser instanceof EventExecutorChooserFactory.ObservableEventExecutorChooser) {
            return ((EventExecutorChooserFactory.ObservableEventExecutorChooser)this.chooser).activeExecutorCount();
        }
    ...
    public List<AutoScalingEventExecutorChooserFactory.AutoScalingUtilizationMetric> executorUtilizations() {
        if (this.chooser instanceof EventExecutorChooserFactory.ObservableEventExecutorChooser) {
            return ((EventExecutorChooserFactory.ObservableEventExecutorChooser)this.chooser).executorUtilizations();
        }
