...
extends PooledByteBuf<ByteBuffer> {
    ...
    public long memoryAddress() {
        ...
        return this.chunk.cleanable.memoryAddress() + (long)this.offset;
    }

    @Override
    long _memoryAddress() {
        return this.hasMemoryAddress() ? this.chunk.cleanable.memoryAddress() + (long)this.offset : 0L;
    }
}
