...
extends AbstractReferenceCountedByteBuf {
    ...
    protected short _getShort(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getShortBE(this.buffer, index);
        }
    ...
    protected short _getShortLE(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getShortLE(this.buffer, index);
        }
    ...
    protected int _getInt(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getIntBE(this.buffer, index);
        }
    ...
    protected int _getIntLE(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getIntLE(this.buffer, index);
        }
    ...
    protected long _getLong(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getLongBE(this.buffer, index);
        }
    ...
    protected long _getLongLE(int index) {
        if (PlatformDependent.hasVarHandle()) {
            return VarHandleByteBufferAccess.getLongLE(this.buffer, index);
        }
    ...
    void getBytes(int index, byte[] dst, int dstIndex, int length, boolean internal) {
        ...
        ByteBuffer tmpBuf = internal ? this.internalNioBuffer(index, length) : (ByteBuffer)this.buffer.duplicate().clear().position(index).limit(index + length);
    ...
    void getBytes(int index, ByteBuffer dst, boolean internal) {
        ...
        ByteBuffer tmpBuf = internal ? this.internalNioBuffer(index, dst.remaining()) : (ByteBuffer)this.buffer.duplicate().clear().position(index).limit(index + dst.remaining());
        dst.put(tmpBuf);
    }
    ...
    protected void _setShort(int index, int value) {
        ...
        this.buffer.putShort(index, (short)(value & 0xFFFF));
    }
