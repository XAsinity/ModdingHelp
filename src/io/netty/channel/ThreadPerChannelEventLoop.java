...
extends SingleThreadEventLoop {
    ...
    public ChannelFuture register(ChannelPromise promise) {
        return super.register(promise).addListener((GenericFutureListener)new ChannelFutureListener(){
    ...
    public ChannelFuture register(Channel channel, ChannelPromise promise) {
        return super.register(channel, promise).addListener((GenericFutureListener)new ChannelFutureListener(){
