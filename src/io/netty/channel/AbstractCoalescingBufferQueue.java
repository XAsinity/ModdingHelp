...
public abstract class AbstractCoalescingBufferQueue {
    ...
    public final ByteBuf removeFirst(ChannelPromise aggregatePromise) {
        ...
        if (entry instanceof ChannelFutureListener) {
            aggregatePromise.addListener((GenericFutureListener)((ChannelFutureListener)entry));
        ...
        try {
            while ((entry = this.bufAndListenerPairs.poll()) != null) {
                ...
                if (entry instanceof DelegatingChannelPromiseNotifier) {
                    aggregatePromise.addListener((GenericFutureListener)((DelegatingChannelPromiseNotifier)entry));
                    continue;
                }
    ...
    public final void writeAndRemoveAll(ChannelHandlerContext ctx) {
        ...
        while (true) {
            ...
            try {
                ...
                this.decrementReadableBytes(previousBuf.readableBytes());
                ctx.write(previousBuf).addListener((GenericFutureListener)((ChannelFutureListener)entry));
                previousBuf = null;
            }
            catch (Throwable t) {
                if (pending == null) {
