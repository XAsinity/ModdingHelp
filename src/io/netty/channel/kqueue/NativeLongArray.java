...
final class NativeLongArray {
    ...
    NativeLongArray(int capacity) {
        ...
        this.memoryCleanable = Buffer.allocateDirectBufferWithNativeOrder(NativeLongArray.calculateBufferCapacity(capacity));
    ...
    private void reallocIfNeeded() {
        if (this.size == this.capacity) {
            ...
            int newCapacity = NativeLongArray.calculateBufferCapacity(newLength);
