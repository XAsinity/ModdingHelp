...
public final class SentryFeedbackOptions {
    ...
    public static interface IDialogHandler {
        public void showDialog(@Nullable SentryId var1, @Nullable OptionsConfigurator var2);
    }

    public static interface SentryFeedbackCallback {
        public void call(@NotNull Feedback var1);
    }

    public static interface OptionsConfigurator {
        public void configure(@NotNull SentryFeedbackOptions var1);
    }
}
